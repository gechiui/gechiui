...
function create_initial_post_types() {
	register_post_type(
		...
		array(
			'labels'                => array(
				'name_admin_bar' => _x( '文章', 'add new from admin bar' ),
			),
			'public'                => true,
			...
			'map_meta_cap'          => true,
			'menu_position'         => 5,
			'menu_icon'             => 'anticon anticon-book',
			'hierarchical'          => false,
			'rewrite'               => false,
			'query_var'             => false,
	...
	register_post_type(
		...
		array(
			'labels'                => array(
				'name_admin_bar' => _x( '页面', 'add new from admin bar' ),
			),
			'public'                => true,
			...
			'map_meta_cap'          => true,
			'menu_position'         => 20,
			'menu_icon'             => 'anticon anticon-file',
			'hierarchical'          => true,
			'rewrite'               => false,
			'query_var'             => false,
			'delete_with_user'      => true,
	...
	register_post_type(
		...
		array(
			...
			'map_meta_cap'          => true,
			'menu_icon'             => 'anticon anticon-folder',
			'hierarchical'          => false,
			'rewrite'               => false,
			'query_var'             => false,
			...
			'show_in_rest'          => true,
			'rest_base'             => 'media',
			'rest_controller_class' => 'GC_REST_Attachments_Controller',
		)
	);
	...
	register_post_type(
		...
		array(
			...
			'rest_controller_class' => 'GC_REST_Menu_Items_Controller',
		)
	);
	...
	register_post_type(
		...
		array(
			'labels'           => array(
				...
				'view_item'          => __( '查看变更集' ),
				'all_items'          => __( '所有变更集' ),
				'search_items'       => __( '搜索变更集' ),
				'not_found'          => __( '未找到变更集。' ),
				'not_found_in_trash' => __( '回收站中没有变更集。' ),
			),
			'public'           => false,
			'_builtin'         => true, /* internal use only. don't use this when registering your own post type. */
			'map_meta_cap'     => true,
	...
	register_post_type(
		...
		array(
			'labels'                => array(
				'name'                     => _x( '可重用区块', 'post type general name' ),
				'singular_name'            => _x( '可重用区块', 'post type singular name' ),
				'add_new'                  => _x( '新建', '可重用区块' ),
				'add_new_item'             => __( '添加新可重用区块' ),
				'new_item'                 => __( '新建可重用区块' ),
				'edit_item'                => __( '编辑可重用区块' ),
				'view_item'                => __( '查看可重用区块' ),
				'all_items'                => __( '所有可重用区块' ),
				'search_items'             => __( '搜索可重用区块' ),
				'not_found'                => __( '未找到可重用区块。' ),
				'not_found_in_trash'       => __( '在回收站中找不到可重用区块。' ),
				'filter_items_list'        => __( '筛选可重用区块列表' ),
				'items_list_navigation'    => __( '可重用区块列表导航' ),
				'items_list'               => __( '可重用区块列表' ),
				'item_published'           => __( '可重用区块已发布。' ),
				'item_published_privately' => __( '可重用区块已私密发布。' ),
				'item_reverted_to_draft'   => __( '可重用区块已恢复为草稿。' ),
				'item_scheduled'           => __( '可重用区块已排入计划。' ),
				'item_updated'             => __( '可重用区块已更新。' ),
			),
			'public'                => false,
			'_builtin'              => true, /* internal use only. don't use this when registering your own post type. */
			'show_ui'               => true,
			...
			'show_in_rest'          => true,
			'rest_base'             => 'blocks',
			'rest_controller_class' => 'GC_REST_Blocks_Controller',
	...
	register_post_type(
		...
		array(
			'labels'                => array(
				'name'                  => _x( '模板', 'post type general name' ),
				'singular_name'         => _x( '模板', 'post type singular name' ),
				'add_new'               => _x( '新增', 'Template' ),
				'add_new_item'          => __( '新增模板' ),
				'new_item'              => __( '新模板' ),
				'edit_item'             => __( '编辑模板' ),
				'view_item'             => __( '查看模板' ),
				'all_items'             => __( '模板' ),
				'search_items'          => __( '搜索模板' ),
				'parent_item_colon'     => __( '父模板：' ),
				'not_found'             => __( '未找到模板。' ),
				'not_found_in_trash'    => __( '在回收站内找不到模板' ),
				'archives'              => __( '模板存档' ),
				'insert_into_item'      => __( '插入模板' ),
				'uploaded_to_this_item' => __( '已上传到此模板' ),
				'filter_items_list'     => __( '筛选模板列表' ),
				'items_list_navigation' => __( '模板列表导航' ),
				'items_list'            => __( '模版列表' ),
			),
			...
			'rewrite'               => false,
			'rest_base'             => 'templates',
			'rest_controller_class' => 'GC_REST_Templates_Controller',
	...
	register_post_type(
		...
		array(
			'labels'                => array(
				'name'                  => _x( '模版组件', 'post type general name' ),
				'singular_name'         => _x( '模版组件', 'post type singular name' ),
				'add_new'               => _x( '新建', '模版组件' ),
				'add_new_item'          => __( '添加新模版组件' ),
				'new_item'              => __( '新建模版组件' ),
				'edit_item'             => __( '编辑模版组件' ),
				'view_item'             => __( '查看模版组件' ),
				'all_items'             => __( '模版组件' ),
				'search_items'          => __( '搜索模版组件' ),
				'parent_item_colon'     => __( '父模板组件：' ),
				'not_found'             => __( '找不到模版组件。' ),
				'not_found_in_trash'    => __( '在回收站内找不到模版组件。' ),
				'archives'              => __( '模板组件归档' ),
				'insert_into_item'      => __( '插入模板组件' ),
				'uploaded_to_this_item' => __( '已上传到此模板组件' ),
				'filter_items_list'     => __( '筛选模版组件列表' ),
				'items_list_navigation' => __( '模版组件列表导航' ),
				'items_list'            => __( '模版组件列表' ),
			),
	...
	register_post_type(
		'gc_global_styles',
		array(
			'label'        => _x( '全局样式', 'post type general name' ),
	...
	register_post_type(
		...
		array(
			'labels'                => array(
				'name'                  => _x( '导航菜单', 'post type general name' ),
				'singular_name'         => _x( '导航菜单', 'post type singular name' ),
				'add_new'               => _x( '新增导航菜单', '导航菜单' ),
				'add_new_item'          => __( '新增导航菜单' ),
				'new_item'              => __( '新建导航菜单' ),
				'edit_item'             => __( '编辑导航菜单' ),
				'view_item'             => __( '查看导航菜单' ),
				'all_items'             => __( '导航菜单' ),
				'search_items'          => __( '搜索导航菜单' ),
				'parent_item_colon'     => __( '父导航菜单：' ),
				'not_found'             => __( '未找到导航菜单。' ),
				'not_found_in_trash'    => __( '未在回收站中找到导航菜单。' ),
				'archives'              => __( '导航菜单归档' ),
				'insert_into_item'      => __( '插入导航菜单' ),
				'uploaded_to_this_item' => __( '上传到此导航菜单' ),
				'filter_items_list'     => __( '筛选导航菜单列表' ),
	...
	register_post_status(
		'publish',
		array(
			'label'       => _x( '已发布', 'post status' ),
			'public'      => true,
			'_builtin'    => true, /* internal use only. */
			/* translators: %s: Number of published posts. */
			'label_count' => _n_noop(
				'已发布<span class="count">（%s）</span>',
				'已发布<span class="count">（%s）</span>'
			),
		)
	);
	...
	register_post_status(
		'private',
		array(
			'label'       => _x( '私密', 'post status' ),
			'private'     => true,
			'_builtin'    => true, /* internal use only. */
			/* translators: %s: Number of private posts. */
			'label_count' => _n_noop(
				'私密<span class="count">（%s）</span>',
				'私密<span class="count">（%s）</span>'
			),
		)
	);
	...
	register_post_status(
		'request-confirmed',
		array(
			'label'               => _x( '已确认', 'request status' ),
			'internal'            => true,
			'_builtin'            => true, /* internal use only. */
			/* translators: %s: Number of confirmed requests. */
			'label_count'         => _n_noop(
				'已确认<span class="count">（%s）</span>',
				'已确认<span class="count">（%s）</span>'
			),
			'exclude_from_search' => false,
		)
	...
	register_post_status(
		'request-failed',
		array(
			'label'               => _x( '失败', 'request status' ),
			'internal'            => true,
			'_builtin'            => true, /* internal use only. */
			/* translators: %s: Number of failed requests. */
			'label_count'         => _n_noop(
				'失败<span class="count">（%s）</span>',
				'失败<span class="count">（%s）</span>'
			),
			'exclude_from_search' => false,
		)
	...
	register_post_status(
		'request-completed',
		array(
			'label'               => _x( '完成', 'request status' ),
			'internal'            => true,
			'_builtin'            => true, /* internal use only. */
			/* translators: %s: Number of completed requests. */
			'label_count'         => _n_noop(
				'已完成<span class="count">（%s）</span>',
				'已完成<span class="count">（%s）</span>'
			),
			'exclude_from_search' => false,
		)
...
function update_attached_file( $attachment_id, $file ) {
	...
	if ( $file ) {
		return update_post_meta( $attachment_id, '_gc_attached_file', $file );
	} else {
		return delete_post_meta( $attachment_id, '_gc_attached_file' );
	}
}
 ...
 */
function _gc_relative_upload_path( $path ) {
	$new_path = $path;
	 ...
	 * @param string $path     Full path to the file.
	 */
	return apply_filters( '_gc_relative_upload_path', $new_path, $path );
}
 ...
 * criteria of posts to retrieve. The 'post_type' can be anything, but GeChiUI
 ...
 * @global GC_Post $post Global post object.
 *
 * @param int|GC_Post|null $post   Optional. Post ID or post object. `null`, `false`, `0` and other PHP falsey values
 ...
 * @return GC_Post|array|null Type corresponding to $output on success or null on failure.
 *                            When $output is OBJECT, a `GC_Post` instance is returned.
 */
function get_post( $post = null, $output = OBJECT, $filter = 'raw' ) {
	...
	if ( $post instanceof GC_Post ) {
		...
		if ( empty( $post->filter ) ) {
			...
			$_post = new GC_Post( $_post );
		} elseif ( 'raw' === $post->filter ) {
			$_post = new GC_Post( $post );
		} else {
			$_post = GC_Post::get_instance( $post->ID );
		}
	} else {
		$_post = GC_Post::get_instance( $post );
	}
...
function get_post_status( $post = null ) {
	...
	if (
		 ...
		 * This is to match the logic in gc_insert_post().
		 *
...
function _gc_privacy_statuses() {
	return array(
		'request-pending'   => _x( '待审', 'request status' ),      // Pending confirmation from user.
		'request-confirmed' => _x( '已确认', 'request status' ),    // User has confirmed the action.
		'request-failed'    => _x( '失败', 'request status' ),       // User failed to confirm the action.
		'request-completed' => _x( '完成', 'request status' ),    // Admin has handled the request.
	);
}
 ...
 *                               properties of the global `$gc_post_statuses objects`. Default empty array.
 ...
 * @return GC_Post_Type|null GC_Post_Type object if it exists, null otherwise.
 */
 ...
 * @return string[]|GC_Post_Type[] An array of post type names or objects.
 */
 ...
 *     @type string       $rest_namespace        To change the namespace URL of REST API route. Default is gc/v2.
 *     @type string       $rest_controller_class REST API controller class name. Default is 'GC_REST_Posts_Controller'.
 ...
 *                                               'dashicons-chart-pie'. Pass 'none' to leave div.gc-menu-image empty
 ...
 *         @type bool   $with_front Whether the permastruct should be prepended with GC_Rewrite::$front.
 *                                  Default true.
 ...
 * }
 * @return GC_Post_Type|GC_Error The registered post type object on success,
 *                               GC_Error object on failure.
 */
function register_post_type( $post_type, $args = array() ) {
	global $gc_post_types;

	if ( ! is_array( $gc_post_types ) ) {
		$gc_post_types = array();
	}
	...
	if ( empty( $post_type ) || strlen( $post_type ) > 20 ) {
		_doing_it_wrong( __FUNCTION__, __( '文章类型名的长度必须在1至20个字符间。' ), '4.2.0' );
		return new GC_Error( 'post_type_length_invalid', __( '文章类型名的长度必须在1至20个字符间。' ) );
	}

	$post_type_object = new GC_Post_Type( $post_type, $args );
 ...
 * @return true|GC_Error True on success, GC_Error on failure or if the post type doesn't exist.
 */
function unregister_post_type( $post_type ) {
	global $gc_post_types;

	if ( ! post_type_exists( $post_type ) ) {
		return new GC_Error( 'invalid_post_type', __( '无效的文章类型。' ) );
	}
	...
	if ( $post_type_object->_builtin ) {
		return new GC_Error( 'invalid_post_type', __( '不允许反注册内建文章类型' ) );
	}
 ...
 * - `add_new` - Default is '新建' for both hierarchical and non-hierarchical types.
 *             When internationalizing this string, please use a {@link https://developer.gechiui.com/plugins/internationalization/how-to-internationalize-your-plugin/#disambiguation-by-context gettext context}
 ...
 *                       post types. Default is '父页：'.
 * - `all_items` - Label to signify all items in a submenu link. Default is '所有文章' / '所有页面'.
 * - `archives` - Label for archives in nav menus. Default is '文章归档' / '页面归档'.
 * - `attributes` - Label for the attributes meta box. Default is '文章属性' / '页面属性'.
 * - `insert_into_item` - Label for the media frame button. Default is '插入至文章' / '插入至页面'.
 * - `uploaded_to_this_item` - Label for the media frame filter. Default is '上传到本文章的' /
 *                           '上传到本页面的'.
 * - `featured_image` - Label for the featured image meta box title. Default is '特色图片'.
 * - `set_featured_image` - Label for setting the featured image. Default is '设置特色图片'.
 * - `remove_featured_image` - Label for removing the featured image. Default is '移除特色图片'.
 * - `use_featured_image` - Label in the media frame for using a featured image. Default is '用作特色图片'.
 * - `menu_name` - Label for the menu name. Default is the same as `name`.
 * - `filter_items_list` - Label for the table views hidden heading. Default is '筛选文章列表' /
 *                       '筛选页面列表'.
 * - `filter_by_date` - Label for the date filter in list tables. Default is '按日期筛选'.
 * - `items_list_navigation` - Label for the table pagination hidden heading. Default is '文章列表导航' /
 *                           '页面列表导航'.
 * - `items_list` - Label for the table hidden heading. Default is '文章列表' / '页面列表'.
 * - `item_published` - Label used when an item is published. Default is '文章已发布。' / '页面已发布。'
 ...
 * - `item_link` - Title for a navigation link block variation. Default is '文章链接' / '页面链接'.
 * - `item_link_description` - Description for a navigation link block variation. Default is '目标文章的链接。' /
 *                             '目标页面的链接。'
 *
 ...
 * @access private
 *
 * @param object|GC_Post_Type $post_type_object Post type object.
...
function remove_post_type_support( $post_type, $feature ) {
	...
	unset( $_gc_post_type_features[ $post_type ][ $feature ] );
}
...
function set_post_type( $post_id = 0, $post_type = 'post' ) {
	...
	$return    = $gcdb->update( $gcdb->posts, array( 'post_type' => $post_type ), array( 'ID' => $post_id ) );
 ...
 * GC_Query} documentation in the Developer Handbook.
 *
 ...
 *
 * @param array $args {
 *     Optional. Arguments to retrieve posts. See GC_Query::parse_query() for all available arguments.
 *
 *     @type int        $numberposts      Total number of posts to retrieve. Is an alias of `$posts_per_page`
 *                                        in GC_Query. Accepts -1 for all. Default 5.
 *     @type int|string $category         Category ID or comma-separated list of IDs (this or any children).
 *                                        Is an alias of `$cat` in GC_Query. Default 0.
 *     @type int[]      $include          An array of post IDs to retrieve, sticky posts will be included.
 *                                        Is an alias of `$post__in` in GC_Query. Default empty array.
...
function add_post_meta( $post_id, $meta_key, $meta_value, $unique = false ) {
	...
	$the_post = gc_is_post_revision( $post_id );
	if ( $the_post ) {
		$post_id = $the_post;
	}
 ...
 * @see sanitize_post_field()
 *
 * @param object|GC_Post|array $post    The post object or array
 * @param string               $context Optional. How to sanitize post fields.
 *                                      Accepts 'raw', 'edit', 'db', 'display',
 *                                      'attribute', or 'js'. Default 'display'.
 * @return object|GC_Post|array The now sanitized post object or array (will be the
 *                              same type as `$post`).
 */
...
function gc_count_posts( $type = 'post', $perm = '' ) {
	...
	if ( false !== $counts ) {
		...
		return apply_filters( 'gc_count_posts', $counts, $type, $perm );
	}

	$query = "SELECT post_status, COUNT( * ) AS num_posts FROM {$gcdb->posts} WHERE post_type = %s";
	...
	$results = (array) $gcdb->get_results( $gcdb->prepare( $query, $type ), ARRAY_A );
...
function gc_count_attachments( $mime_type = '' ) {
	 ...
	 */
	return apply_filters( 'gc_count_attachments', (object) $counts, $mime_type );
}
...
function get_post_mime_types() {
	$post_mime_types = array(   // array( adj, noun )
		...
		'audio'       => array(
			_x( '音频', 'file type group' ),
			__( '管理音频' ),
			/* translators: %s: Number of audio files. */
			_n_noop(
				'音频<span class="count">（%s）</span>',
				'音频<span class="count">（%s）</span>'
			),
		),
		'video'       => array(
			_x( '视频', 'file type group' ),
			__( '管理视频' ),
			/* translators: %s: Number of video files. */
			_n_noop(
				'视频<span class="count">（%s）</span>',
				'视频<span class="count">（%s）</span>'
			),
		),
		'document'    => array(
 ...
 */
function gc_match_mime_types( $wildcard_mime_types, $real_mime_types ) {
	$matches = array();
 ...
 */
function gc_post_mime_type_where( $post_mime_types, $table_alias = '' ) {
	$where     = '';
	$wildcards = array( '', '%', '%/%' );
 ...
 */
function gc_delete_post( $postid = 0, $force_delete = false ) {
	global $gcdb;

	$post = $gcdb->get_row( $gcdb->prepare( "SELECT * FROM $gcdb->posts WHERE ID = %d", $postid ) );
	...
	if ( ! $force_delete && ( 'post' === $post->post_type || 'page' === $post->post_type ) && 'trash' !== get_post_status( $postid ) && EMPTY_TRASH_DAYS ) {
		return gc_trash_post( $postid );
	}

	if ( 'attachment' === $post->post_type ) {
		return gc_delete_attachment( $postid, $force_delete );
	}
	...
	delete_post_meta( $postid, '_gc_trash_meta_status' );
	delete_post_meta( $postid, '_gc_trash_meta_time' );

	gc_delete_object_term_relationships( $postid, get_object_taxonomies( $post->post_type ) );
	...
	if ( is_post_type_hierarchical( $post->post_type ) ) {
		...
		$children_query = $gcdb->prepare( "SELECT * FROM $gcdb->posts WHERE post_parent = %d AND post_type = %s", $postid, $post->post_type );
		$children       = $gcdb->get_results( $children_query );
		if ( $children ) {
			$gcdb->update( $gcdb->posts, $parent_data, $parent_where + array( 'post_type' => $post->post_type ) );
		}
	}

	// Do raw query. gc_get_post_revisions() is filtered.
	$revision_ids = $gcdb->get_col( $gcdb->prepare( "SELECT ID FROM $gcdb->posts WHERE post_parent = %d AND post_type = 'revision'", $postid ) );
	// Use gc_delete_post (via gc_delete_post_revision) again. Ensures any meta/misplaced data gets cleaned up.
	foreach ( $revision_ids as $revision_id ) {
		gc_delete_post_revision( $revision_id );
	}

	// Point all attachments to this post up one level.
	$gcdb->update( $gcdb->posts, $parent_data, $parent_where + array( 'post_type' => 'attachment' ) );

	gc_defer_comment_counting( true );

	$comment_ids = $gcdb->get_col( $gcdb->prepare( "SELECT comment_ID FROM $gcdb->comments WHERE comment_post_ID = %d ORDER BY comment_ID DESC", $postid ) );
	...
	$post_meta_ids = $gcdb->get_col( $gcdb->prepare( "SELECT meta_id FROM $gcdb->postmeta WHERE post_id = %d ", $postid ) );
	...
	$result = $gcdb->delete( $gcdb->posts, array( 'ID' => $postid ) );
	if ( ! $result ) {
		return false;
	}
	...
	gc_clear_scheduled_hook( 'publish_future_post', array( $postid ) );
 ...
 * @return GC_Post|false|null Post data on success, false or null on failure.
 */
function gc_trash_post( $post_id = 0 ) {
	if ( ! EMPTY_TRASH_DAYS ) {
 ...
 * @return GC_Post|false|null Post data on success, false or null on failure.
 */
function gc_untrash_post( $post_id = 0 ) {
	$post = get_post( $post_id );
	...
	$previous_status = get_post_meta( $post_id, '_gc_trash_meta_status', true );
	 ...
	 * in order to assign the status that the post had before it was trashed. The `gc_untrash_post_set_previous_status()`
	 ...
	 * @param string $previous_status The status of the post at the point where it was trashed.
	 */
	$post_status = apply_filters( 'gc_untrash_post_status', $new_status, $post_id, $previous_status );

	delete_post_meta( $post_id, '_gc_trash_meta_status' );
	delete_post_meta( $post_id, '_gc_trash_meta_time' );
	...
	gc_untrash_post_comments( $post_id );
 ...
 */
function gc_trash_post_comments( $post = null ) {
	global $gcdb;
	...
	$comments = $gcdb->get_results( $gcdb->prepare( "SELECT comment_ID, comment_approved FROM $gcdb->comments WHERE comment_post_ID = %d", $post_id ) );
	...
	add_post_meta( $post_id, '_gc_trash_meta_comments_status', $statuses );

	// Set status for all comments to post-trashed.
	$result = $gcdb->update( $gcdb->comments, array( 'comment_approved' => 'post-trashed' ), array( 'comment_post_ID' => $post_id ) );
 ...
 * @return true|void
 */
function gc_untrash_post_comments( $post = null ) {
	global $gcdb;
	...
	$statuses = get_post_meta( $post_id, '_gc_trash_meta_comments_status', true );
	...
	foreach ( $group_by_status as $status => $comments ) {
		...
		$gcdb->query( $gcdb->prepare( "UPDATE $gcdb->comments SET comment_approved = %s WHERE comment_ID IN ($comments_in)", $status ) );
	}

	clean_comment_cache( array_keys( $statuses ) );

	delete_post_meta( $post_id, '_gc_trash_meta_comments_status' );
 ...
 *                       See GC_Term_Query::__construct() for supported arguments.
 * @return array|GC_Error List of categories. If the `$fields` argument passed via `$args` is 'all' or
 *                        'all_with_object_id', an array of GC_Term objects will be returned. If `$fields`
 *                        is 'ids', an array of category IDs. If `$fields` is 'names', an array of category names.
 *                        GC_Error object if 'category' taxonomy doesn't exist.
 */
function gc_get_post_categories( $post_id = 0, $args = array() ) {
	$post_id = (int) $post_id;

	$defaults = array( 'fields' => 'ids' );
	$args     = gc_parse_args( $args, $defaults );

	$cats = gc_get_object_terms( $post_id, 'category', $args );
	return $cats;
}
 ...
 *                       See GC_Term_Query::__construct() for supported arguments.
 * @return array|GC_Error Array of GC_Term objects on success or empty array if no tags were found.
 *                        GC_Error object if 'post_tag' taxonomy doesn't exist.
 */
function gc_get_post_tags( $post_id = 0, $args = array() ) {
	return gc_get_post_terms( $post_id, 'post_tag', $args );
}
 ...
 * @param array           $args     {
 *     Optional. Term query parameters. See GC_Term_Query::__construct() for supported arguments.
 *
 *     @type string $fields Term fields to retrieve. Default 'all'.
 * }
 * @return array|GC_Error Array of GC_Term objects on success or empty array if no terms were found.
 *                        GC_Error object if `$taxonomy` doesn't exist.
 */
function gc_get_post_terms( $post_id = 0, $taxonomy = 'post_tag', $args = array() ) {
	$post_id = (int) $post_id;

	$defaults = array( 'fields' => 'all' );
	$args     = gc_parse_args( $args, $defaults );

	$tags = gc_get_object_terms( $post_id, $taxonomy, $args );
 ...
 *                       correspond to a GC_Post object or an associative array, respectively.
 *                       Default ARRAY_A.
 * @return array|false Array of recent posts, where the type of each element is determined
 *                     by the `$output` parameter. Empty array on failure.
 */
function gc_get_recent_posts( $args = array(), $output = ARRAY_A ) {

	if ( is_numeric( $args ) ) {
		_deprecated_argument( __FUNCTION__, '3.1.0', __( '不再建议将文章数作为参数传入。请改传数组。' ) );
 ...
 * @return int|GC_Error The post ID on success. The value 0 or GC_Error on failure.
 */
function gc_insert_post( $postarr, $gc_error = false, $fire_after_hooks = true ) {
	global $gcdb;
	...
	$postarr = gc_parse_args( $postarr, $defaults );
	...
	if ( ! empty( $postarr['ID'] ) ) {
		...
		if ( is_null( $post_before ) ) {
			if ( $gc_error ) {
				return new GC_Error( 'invalid_post', __( '文章ID无效。' ) );
			}
			return 0;
		}
	 ...
	 * the new post being inserted and return 0. If $gc_error is true, a GC_Error
	 ...
	 */
	if ( apply_filters( 'gc_insert_post_empty_content', $maybe_empty, $postarr ) ) {
		if ( $gc_error ) {
			return new GC_Error( 'empty_content', __( '内容，标题和摘要为空。' ) );
		} else {
			return 0;
		}
	}
	...
	/*
	 * The 'gc_insert_post_parent' filter expects all variables to be present.
	...
	foreach ( $emoji_fields as $emoji_field ) {
		if ( isset( $data[ $emoji_field ] ) ) {
			$charset = $gcdb->get_col_charset( $gcdb->posts, $emoji_field );

			if ( 'utf8' === $charset ) {
				$data[ $emoji_field ] = gc_encode_emoji( $data[ $emoji_field ] );
			}
		}
	}
	...
	if ( 'attachment' === $post_type ) {
		 ...
		 *                                   as originally passed to gc_insert_post().
		 * @param bool  $update              Whether this is an existing attachment post being updated.
		 */
		$data = apply_filters( 'gc_insert_attachment_data', $data, $postarr, $unsanitized_postarr, $update );
	} else {
		/**
		 ...
		 *                                   originally passed to gc_insert_post().
		 * @param bool  $update              Whether this is an existing post being updated.
		 */
		$data = apply_filters( 'gc_insert_post_data', $data, $postarr, $unsanitized_postarr, $update );
	}
	...
	if ( $update ) {
		...
		if ( false === $gcdb->update( $gcdb->posts, $data, $where ) ) {
			if ( $gc_error ) {
				if ( 'attachment' === $post_type ) {
					$message = __( '无法更新数据库中的附件。' );
				} else {
					$message = __( '无法在数据库中更新文章' );
				}

				return new GC_Error( 'db_update_error', $message, $gcdb->last_error );
			} else {
				return 0;
			}
		}
		...
		if ( ! empty( $import_id ) ) {
			...
			if ( ! $gcdb->get_var( $gcdb->prepare( "SELECT ID FROM $gcdb->posts WHERE ID = %d", $import_id ) ) ) {
				$data['ID'] = $import_id;
			}
		}

		if ( false === $gcdb->insert( $gcdb->posts, $data ) ) {
			if ( $gc_error ) {
				if ( 'attachment' === $post_type ) {
					$message = __( '无法将附件插入数据库。' );
				} else {
					$message = __( '无法在数据库中插入文章' );
				}

				return new GC_Error( 'db_insert_error', $message, $gcdb->last_error );
			} else {
				return 0;
			}
		}
	...
	if ( ! empty( $postarr['tax_input'] ) ) {
		foreach ( $postarr['tax_input'] as $taxonomy => $tags ) {
			...
			if ( ! $taxonomy_obj ) {
				...
				_doing_it_wrong( __FUNCTION__, sprintf( __( '无效分类法：%s。' ), $taxonomy ), '4.4.0' );
				continue;
			}
	...
	if ( ! empty( $postarr['page_template'] ) ) {
		...
		$page_templates      = gc_get_theme()->get_page_templates( $post );
	...
	if ( 'attachment' !== $postarr['post_type'] ) {
		gc_transition_post_status( $data['post_status'], $previous_status, $post );
	} else {
		if ( $update ) {
			/**
 ...
 * @return int|GC_Error The post ID on success. The value 0 or GC_Error on failure.
 */
function gc_update_post( $postarr = array(), $gc_error = false, $fire_after_hooks = true ) {
	if ( is_object( $postarr ) ) {
		// Non-escaped post was passed.
		$postarr = get_object_vars( $postarr );
		$postarr = gc_slash( $postarr );
	}
	...
	if ( 'attachment' === $postarr['post_type'] ) {
		return gc_insert_attachment( $postarr, false, 0, $gc_error );
	}
	...
	if ( isset( $postarr['tags_input'] ) && is_object_in_taxonomy( $postarr['post_type'], 'post_tag' ) ) {
		...
		if ( $tags && ! is_gc_error( $tags ) ) {
			$tag_names = gc_list_pluck( $tags, 'name' );
		}
	...
	return gc_insert_post( $postarr, $gc_error, $fire_after_hooks );
}
...
function gc_publish_post( $post ) {
	...
	foreach ( get_object_taxonomies( $post->post_type, 'object' ) as $taxonomy => $tax_object ) {
		...
		gc_set_post_terms( $post->ID, array( $default_term_id ), $taxonomy );
	}

	$gcdb->update( $gcdb->posts, array( 'post_status' => 'publish' ), array( 'ID' => $post->ID ) );

	clean_post_cache( $post->ID );

	$old_status        = $post->post_status;
	$post->post_status = 'publish';
	gc_transition_post_status( 'publish', $old_status, $post );
...
/**
 * Uses gc_checkdate to return a valid Gregorian-calendar value for post_date.
 ...
 */
function gc_resolve_post_date( $post_date = '', $post_date_gmt = '' ) {
...
function gc_unique_post_slug( $slug, $post_ID, $post_status, $post_type, $post_parent ) {
	...
	global $gcdb, $gc_rewrite;

	$original_slug = $slug;

	$feeds = $gc_rewrite->feeds;
	if ( ! is_array( $feeds ) ) {
		$feeds = array();
	}
	...
	if ( 'attachment' === $post_type ) {
		 ...
		 */
		$is_bad_attachment_slug = apply_filters( 'gc_unique_post_slug_is_bad_attachment_slug', false, $slug );
		 ...
		 * @param int    $post_parent Post parent ID.
		 */
		$is_bad_hierarchical_slug = apply_filters( 'gc_unique_post_slug_is_bad_hierarchical_slug', false, $slug, $post_type, $post_parent );

		if ( $post_name_check
			|| in_array( $slug, $feeds, true ) || 'embed' === $slug
			|| preg_match( "@^($gc_rewrite->pagination_base)?\d+$@", $slug )
		 ...
		 * @param string $post_type Post type.
		 */
		$is_bad_flat_slug = apply_filters( 'gc_unique_post_slug_is_bad_flat_slug', false, $slug, $post_type );
 ...
 * @return array|false|GC_Error Array of affected term IDs. GC_Error or false on failure.
 */
function gc_add_post_tags( $post_id = 0, $tags = '' ) {
	return gc_set_post_tags( $post_id, $tags, true );
}
 ...
 */
function gc_set_post_tags( $post_id = 0, $tags = '', $append = false ) {
	return gc_set_post_terms( $post_id, $tags, 'post_tag', $append );
}
 ...
 */
function gc_transition_post_status( $new_status, $old_status, $post ) {
	/**
...
function gc_after_insert_post( $post, $update, $post_before ) {
	 ...
	 *                                  to the update for updated posts.
	 */
	do_action( 'gc_after_insert_post', $post_id, $post, $update, $post_before );
}
...
function trackback_url_list( $tb_list, $post_id ) {
	if ( ! empty( $tb_list ) ) {
		...
		foreach ( (array) $trackback_urls as $tb_url ) {
			$tb_url = trim( $tb_url );
			trackback( $tb_url, gc_unslash( $postdata['post_title'] ), $excerpt, $post_id );
		}
	}
}
 ...
 * @return GC_Post|array|null GC_Post or array on success, null on failure.
 */
...
function get_page_by_path( $page_path, $output = OBJECT, $post_type = 'page' ) {
	...
	$pages = $gcdb->get_results( $sql, OBJECT_K );
...
function get_pages( $args = array() ) {
	...
	if ( ! empty( $parsed_args['exclude_tree'] ) ) {
		$exclude = gc_parse_id_list( $parsed_args['exclude_tree'] );
	 ...
	 *
	 *
	 * @param GC_Post[] $pages       Array of page objects.
...
function gc_insert_attachment( $args, $file = false, $parent = 0, $gc_error = false, $fire_after_hooks = true ) {
	...
	return gc_insert_post( $data, $gc_error, $fire_after_hooks );
}
 ...
 * @return GC_Post|false|null Post data on success, false or null on failure.
 */
function gc_delete_attachment( $post_id, $force_delete = false ) {
	global $gcdb;

	$post = $gcdb->get_row( $gcdb->prepare( "SELECT * FROM $gcdb->posts WHERE ID = %d", $post_id ) );
	...
	gc_delete_object_term_relationships( $post_id, array( 'category', 'post_tag' ) );
	gc_delete_object_term_relationships( $post_id, get_object_taxonomies( $post->post_type ) );
	...
	$comment_ids = $gcdb->get_col( $gcdb->prepare( "SELECT comment_ID FROM $gcdb->comments WHERE comment_post_ID = %d ORDER BY comment_ID DESC", $post_id ) );
	foreach ( $comment_ids as $comment_id ) {
		gc_delete_comment( $comment_id, true );
	}
	...
	$post_meta_ids = $gcdb->get_col( $gcdb->prepare( "SELECT meta_id FROM $gcdb->postmeta WHERE post_id = %d ", $post_id ) );
	foreach ( $post_meta_ids as $mid ) {
		delete_metadata_by_mid( 'post', $mid );
	}
	...
	$result = $gcdb->delete( $gcdb->posts, array( 'ID' => $post_id ) );
	if ( ! $result ) {
		return false;
	}
	/** This action is documented in gc-includes/post.php */
	...
	gc_delete_attachment_files( $post_id, $meta, $backup_sizes, $file );
 ...
 * @return bool True on success, false on failure.
 */
function gc_delete_attachment_files( $post_id, $meta, $backup_sizes, $file ) {
	global $gcdb;

	$uploadpath = gc_get_upload_dir();
	$deleted    = true;

	if ( ! empty( $meta['thumb'] ) ) {
		// Don't delete the thumb if another attachment uses it.
		if ( ! $gcdb->get_row( $gcdb->prepare( "SELECT meta_id FROM $gcdb->postmeta WHERE meta_key = '_gc_attachment_metadata' AND meta_value LIKE %s AND post_id <> %d", '%' . $gcdb->esc_like( $meta['thumb'] ) . '%', $post_id ) ) ) {
			$thumbfile = str_replace( gc_basename( $file ), $meta['thumb'], $file );

			if ( ! empty( $thumbfile ) ) {
				$thumbfile = path_join( $uploadpath['basedir'], $thumbfile );
				$thumbdir  = path_join( $uploadpath['basedir'], dirname( $file ) );

				if ( ! gc_delete_file_from_directory( $thumbfile, $thumbdir ) ) {
					$deleted = false;
				}
			}
		}
	...
	if ( isset( $meta['sizes'] ) && is_array( $meta['sizes'] ) ) {
		...
		foreach ( $meta['sizes'] as $size => $sizeinfo ) {
			$intermediate_file = str_replace( gc_basename( $file ), $sizeinfo['file'], $file );

			if ( ! empty( $intermediate_file ) ) {
				$intermediate_file = path_join( $uploadpath['basedir'], $intermediate_file );

				if ( ! gc_delete_file_from_directory( $intermediate_file, $intermediate_dir ) ) {
					$deleted = false;
				}
			}
		}
	...
	if ( ! empty( $meta['original_image'] ) ) {
		...
		$original_image = str_replace( gc_basename( $file ), $meta['original_image'], $file );

		if ( ! empty( $original_image ) ) {
			$original_image = path_join( $uploadpath['basedir'], $original_image );

			if ( ! gc_delete_file_from_directory( $original_image, $intermediate_dir ) ) {
				$deleted = false;
			}
		}
	}
	...
	if ( is_array( $backup_sizes ) ) {
		...
		foreach ( $backup_sizes as $size ) {
			...
			if ( ! empty( $del_file ) ) {
				...
				if ( ! gc_delete_file_from_directory( $del_file, $del_dir ) ) {
					$deleted = false;
				}
			}
		}
	...
	if ( ! gc_delete_file_from_directory( $file, $uploadpath['basedir'] ) ) {
		$deleted = false;
	}
 ...
 *     @type string $file       The file path relative to `gc-content/uploads`.
...
function gc_get_attachment_metadata( $attachment_id = 0, $unfiltered = false ) {
	...
	$data = get_post_meta( $attachment_id, '_gc_attachment_metadata', true );
	 ...
	 */
	return apply_filters( 'gc_get_attachment_metadata', $data, $attachment_id );
}
 ...
 */
function gc_update_attachment_metadata( $attachment_id, $data ) {
	$attachment_id = (int) $attachment_id;
	 ...
	 * @param int   $attachment_id Attachment post ID.
	 */
	$data = apply_filters( 'gc_update_attachment_metadata', $data, $post->ID );
	if ( $data ) {
		return update_post_meta( $post->ID, '_gc_attachment_metadata', $data );
	} else {
		return delete_post_meta( $post->ID, '_gc_attachment_metadata' );
	}
}
 ...
 */
function gc_get_attachment_url( $attachment_id = 0 ) {
	global $pagenow;
	...
	$url = '';
	// Get attached file.
	$file = get_post_meta( $post->ID, '_gc_attached_file', true );
	if ( $file ) {
	...
	if ( is_ssl() && ! is_admin() && 'gc-login.php' !== $pagenow ) {
	 ...
	 * @param int    $attachment_id Attachment post ID.
	 */
	$url = apply_filters( 'gc_get_attachment_url', $url, $post->ID );
 ...
 */
function gc_get_attachment_caption( $post_id = 0 ) {
	$post_id = (int) $post_id;
	$post    = get_post( $post_id );
	 ...
	 * @param int    $post_id Attachment ID.
	 */
	return apply_filters( 'gc_get_attachment_caption', $caption, $post->ID );
}
 ...
 */
function gc_attachment_is( $type, $post = null ) {
	$post = get_post( $post );
	...
	switch ( $type ) {
		...
		case 'audio':
			return in_array( $ext, gc_get_audio_extensions(), true );

		case 'video':
			return in_array( $ext, gc_get_video_extensions(), true );
 ...
 */
function gc_attachment_is_image( $post = null ) {
	return gc_attachment_is( 'image', $post );
}
 ...
 */
function gc_mime_type_icon( $mime = 0 ) {
	if ( ! is_numeric( $mime ) ) {
		$icon = gc_cache_get( "mime_type_icon_$mime" );
	}
	...
	if ( empty( $icon ) ) {
		...
		$icon_files = gc_cache_get( 'icon_files' );
		...
		if ( ! is_array( $icon_files ) ) {
			...
			gc_cache_add( 'icon_files', $icon_files, 'default', 600 );
		}

		$types = array();
		// Icon gc_basename - extension = MIME wildcard.
		foreach ( $icon_files as $file => $uri ) {
			$types[ preg_replace( '/^([^.]*).*$/', '$1', gc_basename( $file ) ) ] =& $icon_files[ $file ];
		}
		...
		$matches            = gc_match_mime_types( array_keys( $types ), $post_mimes );
		...
		foreach ( $matches as $match => $wilds ) {
			foreach ( $wilds as $wild ) {
				...
				$icon = $types[ $wild ];
				if ( ! is_numeric( $mime ) ) {
					gc_cache_add( "mime_type_icon_$mime", $icon );
				}
				break 2;
			}
		}
	 ...
	 *                        the mime type.
	 */
	return apply_filters( 'gc_mime_type_icon', $icon, $mime, $post_id );
}
 ...
 * added to the post meta field ('_gc_old_slug') for storing old slugs for that
 * post.
 *
...
function gc_check_for_changed_slugs( $post_id, $post, $post_before ) {
	...
	$old_slugs = (array) get_post_meta( $post_id, '_gc_old_slug' );

	// If we haven't added this old slug before, add it now.
	if ( ! empty( $post_before->post_name ) && ! in_array( $post_before->post_name, $old_slugs, true ) ) {
		add_post_meta( $post_id, '_gc_old_slug', $post_before->post_name );
	}

	// If the new slug was used previously, delete it from the list.
	if ( in_array( $post->post_name, $old_slugs, true ) ) {
		delete_post_meta( $post_id, '_gc_old_slug', $post->post_name );
	}
}
 ...
 * added to the post meta field ('_gc_old_date') for storing old dates for that
 * post.
 *
 * The most logically usage of this function is redirecting changed post objects, so
 * that those that linked to an changed post will be redirected to the new post.
...
function gc_check_for_changed_dates( $post_id, $post, $post_before ) {
	...
	$old_dates = (array) get_post_meta( $post_id, '_gc_old_date' );

	// If we haven't added this old date before, add it now.
	if ( ! empty( $previous_date ) && ! in_array( $previous_date, $old_dates, true ) ) {
		add_post_meta( $post_id, '_gc_old_date', $previous_date );
	}

	// If the new slug was used previously, delete it from the list.
	if ( in_array( $new_date, $old_dates, true ) ) {
		delete_post_meta( $post_id, '_gc_old_date', $new_date );
	}
}
...
function get_posts_by_author_sql( $post_type, $full = true, $post_author = null, $public_only = false ) {
	...
	if ( null !== $post_author ) {
		$sql .= $gcdb->prepare( ' AND post_author = %d', $post_author );
	}
...
function _get_last_post_time( $timezone, $field, $post_type = 'any' ) {
	...
	$date = gc_cache_get( $key, 'timeinfo' );
	if ( false !== $date ) {
		return $date;
	}
	...
	if ( 'any' === $post_type ) {
		...
		array_walk( $post_types, array( $gcdb, 'escape_by_ref' ) );
	...
	switch ( $timezone ) {
		case 'gmt':
			$date = $gcdb->get_var( "SELECT post_{$field}_gmt FROM $gcdb->posts WHERE post_status = 'publish' AND post_type IN ({$post_types}) ORDER BY post_{$field}_gmt DESC LIMIT 1" );
			break;
		case 'blog':
			$date = $gcdb->get_var( "SELECT post_{$field} FROM $gcdb->posts WHERE post_status = 'publish' AND post_type IN ({$post_types}) ORDER BY post_{$field}_gmt DESC LIMIT 1" );
			break;
		case 'server':
			$add_seconds_server = gmdate( 'Z' );
			$date               = $gcdb->get_var( "SELECT DATE_ADD(post_{$field}_gmt, INTERVAL '$add_seconds_server' SECOND) FROM $gcdb->posts WHERE post_status = 'publish' AND post_type IN ({$post_types}) ORDER BY post_{$field}_gmt DESC LIMIT 1" );
			break;
	}

	if ( $date ) {
		gc_cache_set( $key, $date, 'timeinfo' );
 ...
 *
 * @param int|GC_Post $post Post ID or post object to remove from the cache.
 */
...
function _transition_post_status( $new_status, $old_status, $post ) {
	...
	if ( 'publish' !== $old_status && 'publish' === $new_status ) {
		...
		if ( '' === get_the_guid( $post->ID ) ) {
			$gcdb->update( $gcdb->posts, array( 'guid' => get_permalink( $post->ID ) ), array( 'ID' => $post->ID ) );
		}
	...
	if ( 'publish' === $new_status || 'publish' === $old_status ) {
		foreach ( array( 'server', 'gmt', 'blog' ) as $timezone ) {
			gc_cache_delete( "lastpostmodified:$timezone", 'timeinfo' );
			gc_cache_delete( "lastpostdate:$timezone", 'timeinfo' );
			gc_cache_delete( "lastpostdate:$timezone:{$post->post_type}", 'timeinfo' );
		}
	}

	if ( $new_status !== $old_status ) {
		gc_cache_delete( _count_posts_cache_key( $post->post_type ), 'counts' );
		gc_cache_delete( _count_posts_cache_key( $post->post_type, 'readable' ), 'counts' );
	}

	// Always clears the hook in case the post status bounced from future to draft.
	gc_clear_scheduled_hook( 'publish_future_post', array( $post->ID ) );
}
 ...
 *                            gc_transition_post_status() and the default filter for _future_post_hook().
 * @param GC_Post $post       Post object.
 */
function _future_post_hook( $deprecated, $post ) {
	gc_clear_scheduled_hook( 'publish_future_post', array( $post->ID ) );
	gc_schedule_single_event( strtotime( get_gmt_from_date( $post->post_date ) . ' GMT' ), 'publish_future_post', array( $post->ID ) );
}
...
function _publish_post_hook( $post_id ) {
	...
	if ( ! gc_next_scheduled( 'do_pings' ) ) {
		gc_schedule_single_event( time(), 'do_pings' );
	}
}
...
function set_post_thumbnail( $post, $thumbnail_id ) {
	...
	if ( $post && $thumbnail_id && get_post( $thumbnail_id ) ) {
		if ( gc_get_attachment_image( $thumbnail_id, 'thumbnail' ) ) {
 ...
 * @global gcdb $gcdb GeChiUI database abstraction object.
 */
function gc_delete_auto_drafts() {
	global $gcdb;

	// Cleanup old auto-drafts more than 7 days old.
	$old_posts = $gcdb->get_col( "SELECT ID FROM $gcdb->posts WHERE post_status = 'auto-draft' AND DATE_SUB( NOW(), INTERVAL 7 DAY ) > post_date" );
	foreach ( (array) $old_posts as $delete ) {
		// Force delete.
		gc_delete_post( $delete, true );
	}
}
...
function _update_term_count_on_transition_post_status( $new_status, $old_status, $post ) {
	...
	foreach ( (array) get_object_taxonomies( $post->post_type ) as $taxonomy ) {
		$tt_ids = gc_get_object_terms( $post->ID, $taxonomy, array( 'fields' => 'tt_ids' ) );
		gc_update_term_count( $tt_ids, $taxonomy );
	}
}
...
function gc_add_trashed_suffix_to_post_name_for_trashed_posts( $post_name, $post_ID = 0 ) {
	...
	if ( ! empty( $trashed_posts_with_desired_slug ) ) {
		foreach ( $trashed_posts_with_desired_slug as $_post ) {
			gc_add_trashed_suffix_to_post_name_for_post( $_post );
		}
	}
}
 ...
 */
function gc_add_trashed_suffix_to_post_name_for_post( $post ) {
	global $gcdb;
	...
	$gcdb->update( $gcdb->posts, array( 'post_name' => $post_name ), array( 'ID' => $post->ID ) );
	clean_post_cache( $post->ID );
	return $post_name;
}
 ...
 */
function gc_get_original_image_path( $attachment_id, $unfiltered = false ) {
	if ( ! gc_attachment_is_image( $attachment_id ) ) {
		return false;
	}
	 ...
	 * @param int    $attachment_id  Attachment ID.
	 */
	return apply_filters( 'gc_get_original_image_path', $original_image, $attachment_id );
}
 ...
 */
function gc_get_original_image_url( $attachment_id ) {
	if ( ! gc_attachment_is_image( $attachment_id ) ) {
		return false;
	}

	$image_url = gc_get_attachment_url( $attachment_id );
	 ...
	 * @param int    $attachment_id      Attachment ID.
	 */
	return apply_filters( 'gc_get_original_image_url', $original_image_url, $attachment_id );
}
