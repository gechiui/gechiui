<?php
/**
 * HTML API: GC_HTML_Attribute_Token class
 *
 * @package GeChiUI
 * @subpackage HTML-API
 * @since 6.2.0
 ...
 *
 * This class is for internal usage of the GC_HTML_Tag_Processor class.
 *
 * @access private
 * @since 6.2.0
 *
 * @see GC_HTML_Tag_Processor
 */
class GC_HTML_Attribute_Token {
	/**
	 * Attribute name.
	 *
	 * @since 6.2.0
