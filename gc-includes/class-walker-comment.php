...
class Walker_Comment extends Walker {
	 ...
	 *
	 * @param GC_Comment $element           Comment data object.
	 ...
	 *
	 * @param string     $output            Used to append additional content. Passed by reference.
	 * @param GC_Comment $data_object       Comment data object.
	...
	protected function ping( $comment, $depth, $args ) {
		...
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( '', $comment ); ?>>
			<div class="comment-body">
				<?php _e( 'Pingback：' ); ?> <?php comment_author_link( $comment ); ?> <?php edit_comment_link( __( '编辑' ), '<span class="edit-link">', '</span>' ); ?>
			</div>
		<?php
	}
	 ...
	 * @see gc_list_comments()
	 *
	 * @param GC_Comment $comment Comment to display.
	 * @param int        $depth   Depth of the current comment.
	 * @param array      $args    An array of arguments.
	 */
			...
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					...
					<div class="comment-metadata">
						...
						edit_comment_link( __( '编辑' ), ' <span class="edit-link">', '</span>' );
						?>
