<?php
/**
 * Dependencies API: GC_Styles class
 *
 * @package GeChiUI
 ...
 * @see GC_Dependencies
 */
class GC_Styles extends GC_Dependencies {
	/**
	 * Base URL for styles.
	 *
	...
	public function __construct() {
		...
		/**
		 * Fires when the GC_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param GC_Styles $gc_styles GC_Styles instance (passed by reference).
		 */
		do_action_ref_array( 'gc_default_styles', array( &$this ) );
	}
	...
	public function do_item( $handle, $group = false ) {
		...
		if ( 'rtl' === $this->text_direction && isset( $obj->extra['rtl'] ) && $obj->extra['rtl'] ) {
			...
			/** This filter is documented in gc-includes/class-gc-styles.php */
