<?php
/**
 * Style Engine: GC_Style_Engine_CSS_Declarations class
 *
 * @package GeChiUI
...
class GC_Style_Engine_CSS_Declarations {
	 ...
	 * @return GC_Style_Engine_CSS_Declarations Returns the object to allow chaining methods.
	 */
	...
	protected static function filter_declaration( $property, $value, $spacer = '' ) {
		$filtered_value = gc_strip_all_tags( $value, true );
		if ( '' !== $filtered_value ) {
