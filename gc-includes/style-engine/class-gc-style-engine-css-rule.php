<?php
/**
 * Style Engine: GC_Style_Engine_CSS_Rule class
 *
 * @package GeChiUI
...
class GC_Style_Engine_CSS_Rule {
	 ...
	 *
	 * Contains a GC_Style_Engine_CSS_Declarations object.
	 *
	 * @since 6.1.0
	 * @var GC_Style_Engine_CSS_Declarations
	 */
	 ...
	 * @param string[]|GC_Style_Engine_CSS_Declarations $declarations Optional. An associative array of CSS definitions,
	 *                                                                e.g. `array( "$property" => "$value", "$property" => "$value" )`,
	 *                                                                or a GC_Style_Engine_CSS_Declarations object.
	 *                                                                Default empty array.
	 */
	 ...
	 * @return GC_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @param string[]|GC_Style_Engine_CSS_Declarations $declarations An array of declarations (property => value pairs),
	 *                                                                or a GC_Style_Engine_CSS_Declarations object.
	 * @return GC_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
	 */
	public function add_declarations( $declarations ) {
		...
		if ( null === $this->declarations ) {
			...
			$this->declarations = new GC_Style_Engine_CSS_Declarations( $declarations_array );
		}
	 ...
	 * @since 6.1.0
	 *
	 * @return GC_Style_Engine_CSS_Declarations The declarations object.
	 */
