<?php
/**
 * Widget API: GC_Widget_Recent_Comments class
 *
 * @package GeChiUI
 * @subpackage Widgets
 *
 ...
 * @see GC_Widget
 */
class GC_Widget_Recent_Comments extends GC_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'recent-comments', __( '近期评论' ), $widget_ops );
		$this->alt_option_name = 'widget_recent_comments';

		if ( is_active_widget( false, false, $this->id_base ) || is_customize_preview() ) {
			add_action( 'gc_head', array( $this, 'recent_comments_style' ) );
		}
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( '显示评论数：' ); ?></label>
