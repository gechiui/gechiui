<?php
/**
 * Widget API: GC_Widget_Block class
 *
 * @package GeChiUI
 * @subpackage Widgets
 *
 ...
 * @see GC_Widget
 */
class GC_Widget_Block extends GC_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'block', __( '区块' ), $widget_ops, $control_ops );
	...
	public function widget( $args, $instance ) {
		$instance = gc_parse_args( $instance, $this->default_instance );
		 ...
		 * @param GC_Widget_Block $widget   Current Block widget instance.
		 */
		echo apply_filters(
