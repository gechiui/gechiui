...
class GC_Theme_JSON_Resolver {
	...
	public static function get_core_data() {
		...
		self::$core = new GC_Theme_JSON( $config, 'default' );
	...
	public static function get_theme_data( $deprecated = array() ) {
		...
		if ( null === self::$theme ) {
			...
			$theme_json_data = self::translate( $theme_json_data, gc_get_theme()->get( 'TextDomain' ) );
			self::$theme     = new GC_Theme_JSON( $theme_json_data );

			if ( gc_get_theme()->parent() ) {
				// Get parent theme.json.
				$parent_theme_json_data = self::read_json_file( self::get_file_path_from_theme( 'theme.json', true ) );
				$parent_theme_json_data = self::translate( $parent_theme_json_data, gc_get_theme()->parent()->get( 'TextDomain' ) );
	...
	public static function get_user_data() {
		...
		$config   = array();
		$user_cpt = self::get_user_data_from_gc_global_styles( gc_get_theme() );
		...
		self::$user = new GC_Theme_JSON( $config, 'custom' );
	...
	public static function get_user_global_styles_post_id() {
		...
		$user_cpt = self::get_user_data_from_gc_global_styles( gc_get_theme(), true );
