<?php
/**
 * REST API: GC_REST_Taxonomies_Controller class
 *
 * @package GeChiUI
 * @subpackage REST_API
 */
 ...
 */
class GC_REST_Taxonomies_Controller extends GC_REST_Controller {
	...
	public function get_item_schema() {
		...
		$schema = array(
			...
			'properties' => array(
				'capabilities'   => array(
					'description' => __( '分类法使用的所有权限。' ),
					'type'        => 'object',
					'context'     => array( 'edit' ),
					'readonly'    => true,
				),
				'description'    => array(
					'description' => __( '分类法的人类可读描述。' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				'hierarchical'   => array(
					'description' => __( '分类法是否包含子分类法。' ),
					'type'        => 'boolean',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				'labels'         => array(
					'description' => __( '分类法在不同上下文中的人类可读标签。' ),
					'type'        => 'object',
					'context'     => array( 'edit' ),
					'readonly'    => true,
				),
				'name'           => array(
					'description' => __( '分类法的标题。' ),
					'type'        => 'string',
				...
				'show_cloud'     => array(
					'description' => __( '项目云是否应该被显示。' ),
					'type'        => 'boolean',
					'context'     => array( 'edit' ),
					'readonly'    => true,
				),
				'types'          => array(
					'description' => __( '关联到此分类法的类型。' ),
					'type'        => 'array',
					'items'       => array(
						'type' => 'string',
					),
				...
				'rest_base'      => array(
					'description' => __( '分类法的REST base路由。' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit', 'embed' ),
					'readonly'    => true,
				),
				'rest_namespace' => array(
					'description' => __( '分类法的 REST 命名空间路由。' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit', 'embed' ),
					'readonly'    => true,
				),
				'visibility'     => array(
					'description' => __( '分类法的可见度设置。' ),
					'type'        => 'object',
					'context'     => array( 'edit' ),
					'readonly'    => true,
					'properties'  => array(
						'public'             => array(
							'description' => __( '此分类法是否可供公开使用，或是通过管理界面，或是由前端用户。' ),
							'type'        => 'boolean',
						),
						'publicly_queryable' => array(
							'description' => __( '此分类法是否可公开查询。' ),
							'type'        => 'boolean',
						),
						'show_ui'            => array(
							'description' => __( '是否生成管理此分类法的缺省UI。' ),
							'type'        => 'boolean',
						),
						'show_admin_column'  => array(
							'description' => __( '是否允许在关联的post-types数据表上自动创建分类法列。' ),
							'type'        => 'boolean',
						),
						'show_in_nav_menus'  => array(
							'description' => __( '是否让分类法在导航菜单中可供选择。' ),
							'type'        => 'boolean',
						),
						'show_in_quick_edit' => array(
							'description' => __( '是否在快速/批量编辑面板显示分类法。' ),
							'type'        => 'boolean',
						),
	...
	public function get_collection_params() {
		...
		$new_params['type']    = array(
			'description' => __( '限制结果为关联到特定文章类型的分类法。' ),
			'type'        => 'string',
		);
		return $new_params;
	}
