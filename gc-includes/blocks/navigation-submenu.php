...
function render_block_core_navigation_submenu( $attributes, $content, $block ) {
	...
	if ( ! $open_on_click ) {
		...
		$html .= '<a class="gc-block-navigation-item__content" href="' . $item_url . '"';
		...
		if ( $show_submenu_indicators ) {
			...
			$html .= '<button aria-label="' . $aria_label . '" class="gc-block-navigation__submenu-icon gc-block-navigation-submenu__toggle" aria-expanded="false">' . block_core_navigation_submenu_render_submenu_icon() . '</button>';
		}
	} else {
		// If menus open on click, we render the parent as a button.
		$html .= '<button aria-label="' . $aria_label . '" class="gc-block-navigation-item__content gc-block-navigation-submenu__toggle" aria-expanded="false">';
	...
	if ( $has_submenu ) {
		...
		$html .= sprintf(
			'<ul class="gc-block-navigation__submenu-container">%s</ul>',
			$inner_blocks_html
		);
	}
