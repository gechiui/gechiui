...
function block_core_navigation_link_maybe_urldecode( $url ) {
	...
	$query_params   = gc_parse_args( $query );
...
function render_block_core_navigation_link( $attributes, $content, $block ) {
	...
	$html               = '<li ' . $wrapper_attributes . '>' .
		'<a class="gc-block-navigation-item__content" ';
	...
	$html .= '>' .
		...
		'<span class="gc-block-navigation-item__label">';

	if ( isset( $attributes['label'] ) ) {
		$html .= gc_kses_post( $attributes['label'] );
	}
	...
	if ( ! empty( $attributes['description'] ) ) {
		$html .= '<span class="gc-block-navigation-item__description">';
		$html .= gc_kses_post( $attributes['description'] );
		$html .= '</span>';
	}
	...
	if ( isset( $block->context['showSubmenuIcon'] ) && $block->context['showSubmenuIcon'] && $has_submenu ) {
		...
		$html .= '<span class="gc-block-navigation__submenu-icon">' . block_core_navigation_link_render_submenu_icon() . '</span>';
	}
 ...
 *
 * @param GC_Taxonomy|GC_Post_Type $entity post type or taxonomy entity.
