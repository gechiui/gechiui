 ...
 *
 * @param GC_Comment[] $comments        The array of comments.
...
function block_core_comment_template_render_comments( $comments, $block ) {
	...
	foreach ( $comments as $comment ) {
		...
		/*
		 * We construct a new GC_Block instance from the parsed block so that
		 * it'll receive any changes made by the `render_block_data` filter.
		 */
		$block_content = ( new GC_Block( $block->parsed_block ) )->render( array( 'dynamic' => false ) );
		 ...
		 * See https://developer.gechiui.com/reference/functions/comment_class/#parameters.
		 */
