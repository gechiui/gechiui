...
;// CONCATENATED MODULE: ./node_modules/@gechiui/block-library/build-module/navigation/view-modal.js
/**
...
window.addEventListener('load', () => {
  ...
  const navigationLinks = document.querySelectorAll('.gc-block-navigation-item__content');
  navigationLinks.forEach(function (link) {
    ...
    const modal = link.closest('.gc-block-navigation__responsive-container');
