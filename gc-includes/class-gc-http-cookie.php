 ...
 * already a GC_Http_Cookie() object, then they are turned into one.
 *
...
class GC_Http_Cookie {
	...
	/**
	 * Retrieve cookie header for usage in the rest of the GeChiUI HTTP API.
	 *
	 *
	 * @return string
	 */
