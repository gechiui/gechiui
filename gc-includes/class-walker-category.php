...
class Walker_Category extends Walker {
	 ...
	 *                       value is 'list'. See gc_list_categories(). Default empty array.
	 */
	 ...
	 *
	 * @param string  $output            Used to append additional content (passed by reference).
	 * @param GC_Term $data_object       Category data object.
	 * @param int     $depth             Optional. Depth of category in reference to parents. Default 0.
	 * @param array   $args              Optional. An array of arguments. See gc_list_categories().
	 *                                   Default empty array.
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = array(), $current_object_id = 0 ) {
		 ...
		 * }
		 * @param GC_Term $category          Term data object.
		...
		if ( ! empty( $args['feed_image'] ) || ! empty( $args['feed'] ) ) {
			...
			if ( empty( $args['feed'] ) ) {
				...
				$alt = ' alt="' . sprintf( __( '%s下所有文章的feed' ), $cat_name ) . '"';
			} else {
				$alt   = ' alt="' . $args['feed'] . '"';
				$name  = $args['feed'];
		...
		if ( 'list' === $args['style'] ) {
			 ...
			 * @param GC_Term  $category    Category data object.
			 * @param int      $depth       Depth of page, used for padding.
			 * @param array    $args        An array of gc_list_categories() arguments.
			 */
	 ...
	 *                            append to output. See gc_list_categories(). Default empty array.
	 */
