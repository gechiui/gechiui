<?php
/**
 * GC_Classic_To_Block_Menu_Converter class
 *
 * @package GeChiUI
 * @since 6.3.0
 */
 ...
 * @access public
 */
class GC_Classic_To_Block_Menu_Converter {
	 ...
	 * @since 6.3.0
	 *
	 * @param GC_Term $menu The Menu term object of the menu to convert.
	 * @return string|GC_Error The serialized and normalized parsed blocks on success,
	 *                         an empty string when there are no menus to convert,
	 *                         or GC_Error on invalid menu.
	 */
