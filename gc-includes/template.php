 ...
 * The decoded form of `category-{slug}.php` was added to the top of the
 ...
 * The decoded form of `tag-{slug}.php` was added to the top of the
 ...
 * The decoded form of `taxonomy-{taxonomy_slug}-{term_slug}.php` was added to the top of the
 ...
 * The decoded form of `page-{page_name}.php` was added to the top of the
 ...
 * `single-{post_type}-{post_name}.php` was added to the top of the template hierarchy. The decoded form of `single-{post_type}-{post_name}.php` was added to the top of the
 *              template hierarchy when the post name contains multibyte characters. `{Post Type Template}.php` was added to the top of the template hierarchy.
 *
 * @see get_query_template()
 *
 ...
 *
 * Searches in the STYLESHEETPATH before TEMPLATEPATH and gc-includes/theme-compat
...
/**
 * Requires the template file with GeChiUI environment.
 *
 * The globals are set up for the template file to ensure that the GeChiUI
...
function load_template( $_template_file, $load_once = true, $args = array() ) {
	 ...
	 */
	do_action( 'gc_before_load_template', $_template_file, $load_once, $args );
	 ...
	 * @param array  $args           Additional arguments passed to the template.
	 */
	do_action( 'gc_after_load_template', $_template_file, $load_once, $args );
}
