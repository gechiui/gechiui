...
return array(
	...
	'content'    => '<!-- gc:group {"style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"}}},"layout":{"inherit":false}} -->
					...
					<div class="gc-block-column" style="flex-basis:50%"><!-- gc:query {"query":{"perPage":2,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list"}} -->
					...
					<!-- /gc:column -->
					<!-- gc:column {"width":"50%"} -->
					<div class="gc-block-column" style="flex-basis:50%"><!-- gc:query {"query":{"perPage":2,"pages":0,"offset":2,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list"}} -->
					<div class="gc-block-query"><!-- gc:post-template -->
					<!-- gc:spacer {"height":200} -->
					<div style="height:200px" aria-hidden="true" class="gc-block-spacer"></div>
					<!-- /gc:spacer -->
