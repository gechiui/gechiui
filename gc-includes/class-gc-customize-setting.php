<?php
/**
 * GeChiUI Customize Setting classes
 *
 * @package GeChiUI
...
class GC_Customize_Setting {
	...
	public function preview() {
		...
		switch ( $this->type ) {
			...
			default:
				/**
				 * Fires when the GC_Customize_Setting::preview() method is called for settings
	...
	public function validate( $value ) {
		...
		if ( is_null( $value ) ) {
			return new GC_Error( 'invalid_value', __( '无效值。' ) );
		}
