 ...
 *
 * These functions must be used within the GeChiUI Loop.
 *
 * @link https://codex.gechiui.com/Author_Templates
 *
 * @package GeChiUI
 * @subpackage Template
 */
...
function get_the_author_posts_link() {
	...
	$link = sprintf(
		...
		/* translators: %s: Author's display name. */
		esc_attr( sprintf( __( '文章作者 %s' ), get_the_author() ) ),
		get_the_author()
	);
...
function get_author_posts_url( $author_id, $author_nicename = '' ) {
	...
	$link      = $gc_rewrite->get_author_permastruct();
...
function gc_list_authors( $args = '' ) {
	...
	foreach ( $authors as $author_id ) {
		...
		$link = sprintf(
			...
			/* translators: %s: Author's display name. */
			esc_attr( sprintf( __( '文章作者 %s' ), $author->display_name ) ),
			$name
		);
 ...
 * @access private
 */
function __clear_multi_author_cache() { // phpcs:ignore GeChiUI.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
