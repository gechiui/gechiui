 ...
 * @return object|array|GC_Error|null Category data in type defined by $output parameter.
 *                                    GC_Error if $category is empty, null if it does not exist.
 */
 ...
 *                              correspond to a GC_Term object, an associative array, or a numeric array,
 *                              respectively. Default OBJECT.
 * @return GC_Term|array|GC_Error|null Type is based on $output value.
 */
 ...
 * }
 * @return GC_Term[]|int|GC_Error Array of 'post_tag' term objects, a count thereof,
 ...
 * @return GC_Term|array|GC_Error|null Tag data in type defined by $output parameter.
 *                                     GC_Error if $tag is empty, null if it does not exist.
 */
...
function _make_cat_compat( &$category ) {
	if ( is_object( $category ) && ! is_gc_error( $category ) ) {
