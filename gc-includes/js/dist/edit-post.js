...
const SettingsHeader = _ref => {
  ...
  const {
    ...
    return {
      ...
      documentLabel: postTypeLabel || Object(external_gc_i18n_["_x"])('Document', 'noun'),
...
function PostTemplateActions() {
  ...
  Object(external_gc_i18n_["_x"])('New', 'action'))), isModalOpen && Object(external_gc_element_["createElement"])(external_gc_components_["Modal"], {
