...
function useColorsPerOrigin(name) {
  ...
  return Object(external_gc_element_["useMemo"])(() => {
    ...
    if (themeColors && themeColors.length) {
      result.push({
        name: Object(external_gc_i18n_["_x"])('Theme', 'Indicates this palette comes from the theme.'),
        colors: themeColors
      });
    }
    ...
    if (shouldDisplayDefaultColors && defaultColors && defaultColors.length) {
      result.push({
        name: Object(external_gc_i18n_["_x"])('Default', 'Indicates this palette comes from GeChiUI.'),
    ...
    if (customColors && customColors.length) {
      result.push({
        name: Object(external_gc_i18n_["_x"])('Custom', 'Indicates this palette is created by the user.'),
        colors: customColors
      });
    }
