...
/******/ 	return __webpack_require__(__webpack_require__.s = "x2a/");
/******/ })
/************************************************************************/
/******/ ({
...
const FORMATTING_METHODS = {
  display: external_gc_keycodes_["displayShortcut"],
  raw: external_gc_keycodes_["rawShortcut"],
  ariaLabel: external_gc_keycodes_["shortcutAriaLabel"]
};
/**
...
function useShortcutEventMatch() {
  ...
  function isMatch(name, event) {
    return getAllShortcutKeyCombinations(name).some(_ref => {
      ...
      return external_gc_keycodes_["isKeyboardEvent"][modifier](event, character);
    });
  }
...
const context = Object(external_gc_element_["createContext"])();
...
function useShortcut(name, callback) {
  ...
  const shortcuts = Object(external_gc_element_["useContext"])(context);
  const isMatch = useShortcutEventMatch();
  const callbackRef = Object(external_gc_element_["useRef"])();
...
function ShortcutProvider(props) {
  const keyboardShortcuts = Object(external_gc_element_["useRef"])(new Set());
  ...
  }, Object(external_gc_element_["createElement"])("div", Object(esm_extends["a" /* default */])({}, props, {
    onKeyDown: onKeyDown
  })));
