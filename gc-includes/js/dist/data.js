...
/******/ 	return __webpack_require__(__webpack_require__.s = "62/A");
/******/ })
/************************************************************************/
/******/ ({
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/data/build-module/redux-store/metadata/selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/data/build-module/redux-store/metadata/actions.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/data/build-module/plugins/index.js
...
// EXTERNAL MODULE: external ["gc","reduxRoutine"]
var external_gc_reduxRoutine_ = __webpack_require__("q3tE");
var external_gc_reduxRoutine_default = /*#__PURE__*/__webpack_require__.n(external_gc_reduxRoutine_);

// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/factory.js
/**
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/controls.js
/**
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/promise-middleware.js
/**
 * External dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/store/name.js
/**
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/resolvers-cache-middleware.js
/**
 * External dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/redux-store/thunk-middleware.js
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/redux-store/metadata/utils.js
/**
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/redux-store/metadata/reducer.js
/**
 * External dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/redux-store/metadata/selectors.js
/**
 * External dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/redux-store/metadata/actions.js
/**
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/redux-store/index.js
/**
 * External dependencies
 */
...
function instantiateReduxStore(key, options, registry, thunkArgs) {
  ...
  const middlewares = [resolvers_cache_middleware(registry, key), promise_middleware, external_gc_reduxRoutine_default()(normalizedControls)];
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/store/index.js
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/utils/emitter.js
/**
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/registry.js
/**
 * External dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/default-registry.js
/**
 * Internal dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/plugins/controls/index.js
/**
 * GeChiUI dependencies
 */

/* harmony default export */ var plugins_controls = (registry => {
  external_gc_deprecated_default()('gc.data.plugins.controls', {
    since: '5.4',
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/plugins/persistence/storage/object.js
let objectStorage;
const storage = {
  getItem(key) {
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/plugins/persistence/storage/default.js
/**
 * Internal dependencies
 */
...
try {
  ...
  default_storage.setItem('__gcDataTestLocalStorage', '');
  default_storage.removeItem('__gcDataTestLocalStorage');
} catch (error) {
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/plugins/persistence/index.js
/**
 * External dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/plugins/index.js
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/registry-provider/context.js
/**
 * GeChiUI dependencies
 */
...
const Context = Object(external_gc_element_["createContext"])(default_registry);
const {
  Consumer,
  Provider
} = Context;
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/registry-provider/use-registry.js
/**
 * GeChiUI dependencies
 */
...
function useRegistry() {
  return Object(external_gc_element_["useContext"])(Context);
}

// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/async-mode-provider/context.js
/**
 * GeChiUI dependencies
 */

const context_Context = Object(external_gc_element_["createContext"])(false);
const {
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/async-mode-provider/use-async-mode.js
/**
 * GeChiUI dependencies
 */
...
function useAsyncMode() {
  return Object(external_gc_element_["useContext"])(context_Context);
}

// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/use-select/index.js
/**
 * External dependencies
 */
...
const renderQueue = Object(external_gc_priorityQueue_["createQueue"])();
/** @typedef {import('./types').GCDataStore} GCDataStore */
...
function useSelect(_mapSelect, deps) {
  ...
  const mapSelect = Object(external_gc_element_["useCallback"])(_mapSelect, deps);
  const registry = useRegistry();
  ...
  const [, forceRender] = Object(external_gc_element_["useReducer"])(s => s + 1, 0);
  const latestMapSelect = Object(external_gc_element_["useRef"])();
  const latestIsAsync = Object(external_gc_element_["useRef"])(isAsync);
  const latestMapOutput = Object(external_gc_element_["useRef"])();
  const latestMapOutputError = Object(external_gc_element_["useRef"])();
  const isMountedAndNotUnsubscribing = Object(external_gc_element_["useRef"])(); // Keep track of the stores being selected in the mapSelect function,
  // and only subscribe to those stores later.

  const listeningStores = Object(external_gc_element_["useRef"])([]);
  const trapSelect = Object(external_gc_element_["useCallback"])(callback => registry.__experimentalMarkListeningStores(callback, listeningStores), [registry]); // Generate a "flag" for used in the effect dependency array.
  // It's different than just using `mapSelect` since deps could be undefined,
  // in that case, we would still want to memoize it.

  const depsChangedFlag = Object(external_gc_element_["useMemo"])(() => ({}), deps || []);
  let mapOutput;
  ...
  Object(external_gc_compose_["useIsomorphicLayoutEffect"])(() => {
    if (isWithoutMapping) {
      return;
    }
    ...
    const onStoreChange = () => {
      if (isMountedAndNotUnsubscribing.current) {
        try {
          ...
          if (external_gc_isShallowEqual_default()(latestMapOutput.current, newMapOutput)) {
            return;
          }
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/with-select/index.js
...
const withSelect = mapSelectToProps => Object(external_gc_compose_["createHigherOrderComponent"])(WrappedComponent => Object(external_gc_compose_["pure"])(ownProps => {
  const mapSelect = (select, registry) => mapSelectToProps(select, ownProps, registry);

  const mergeProps = useSelect(mapSelect);
  return Object(external_gc_element_["createElement"])(WrappedComponent, Object(esm_extends["a" /* default */])({}, ownProps, mergeProps));
}), 'withSelect');

/* harmony default export */ var with_select = (withSelect);

// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/use-dispatch/use-dispatch-with-map.js
/**
 * External dependencies
 */
...
const useDispatchWithMap = (dispatchMap, deps) => {
  const registry = useRegistry();
  const currentDispatchMap = Object(external_gc_element_["useRef"])(dispatchMap);
  Object(external_gc_compose_["useIsomorphicLayoutEffect"])(() => {
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/with-dispatch/index.js
...
const withDispatch = mapDispatchToProps => Object(external_gc_compose_["createHigherOrderComponent"])(WrappedComponent => ownProps => {
  const mapDispatch = (dispatch, registry) => mapDispatchToProps(dispatch, ownProps, registry);

  const dispatchProps = use_dispatch_with_map(mapDispatch, []);
  return Object(external_gc_element_["createElement"])(WrappedComponent, Object(esm_extends["a" /* default */])({}, ownProps, dispatchProps));
}, 'withDispatch');

/* harmony default export */ var with_dispatch = (withDispatch);

// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/with-registry/index.js
...
const withRegistry = Object(external_gc_compose_["createHigherOrderComponent"])(OriginalComponent => props => Object(external_gc_element_["createElement"])(RegistryConsumer, null, registry => Object(external_gc_element_["createElement"])(OriginalComponent, Object(esm_extends["a" /* default */])({}, props, {
  registry: registry
}))), 'withRegistry');
/* harmony default export */ var with_registry = (withRegistry);

// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/components/use-dispatch/use-dispatch.js
/**
 * Internal dependencies
 */
...
// CONCATENATED MODULE: ./node_modules/@gechiui/data/build-module/index.js
/**
 * External dependencies
 */
