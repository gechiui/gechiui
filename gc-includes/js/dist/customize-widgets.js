...
/******/ 	return __webpack_require__(__webpack_require__.s = "kRZS");
/******/ })
/************************************************************************/
/******/ ({
...
class error_boundary_ErrorBoundary extends external_gc_element_["Component"] {
  ...
  render() {
    ...
    return Object(external_gc_element_["createElement"])(external_gc_blockEditor_["Warning"], {
      ...
      actions: [Object(external_gc_element_["createElement"])(CopyButton, {
        key: "copy-error",
        text: error.stack
...
function BlockInspectorButton(_ref) {
  ...
  const selectedBlockClientId = Object(external_gc_data_["useSelect"])(select => select(external_gc_blockEditor_["store"]).getSelectedBlockClientId(), []);
  const selectedBlock = Object(external_gc_element_["useMemo"])(() => document.getElementById(`block-${selectedBlockClientId}`), [selectedBlockClientId]);
  return Object(external_gc_element_["createElement"])(external_gc_components_["MenuItem"], Object(esm_extends["a" /* default */])({
    onClick: () => {
      // Open the inspector.
      inspector.open({
  ...
  }, props), Object(external_gc_i18n_["__"])('显示更多设置'));
}
...
function Inserter(_ref) {
  ...
  const inserterTitleId = Object(external_gc_compose_["useInstanceId"])(Inserter, 'customize-widget-layout__inserter-panel-title');
  ...
  }, Object(external_gc_i18n_["__"])('添加区块')), Object(external_gc_element_["createElement"])(external_gc_components_["Button"], {
    className: "customize-widgets-layout__inserter-panel-header-close-button",
    icon: close_small["a" /* default */],
    onClick: () => setIsOpened(false),
    "aria-label": Object(external_gc_i18n_["__"])('关闭插入器')
  })), Object(external_gc_element_["createElement"])("div", {
...
function KeyboardShortcutHelpModal(_ref4) {
  ...
  Object(external_gc_keyboardShortcuts_["useShortcut"])('core/customize-widgets/keyboard-shortcuts', toggleModal);
...
function MoreMenu() {
  ...
  Object(external_gc_keyboardShortcuts_["useShortcut"])('core/customize-widgets/keyboard-shortcuts', toggleKeyboardShortcutsModal);
  return Object(external_gc_element_["createElement"])(external_gc_element_["Fragment"], null, Object(external_gc_element_["createElement"])(build_module["f" /* MoreMenuDropdown */], {
    as: external_gc_components_["ToolbarDropdownMenu"],
    className: "customize-widgets-more-menu",
    popoverProps: POPOVER_PROPS
  }, () => Object(external_gc_element_["createElement"])(external_gc_element_["Fragment"], null, Object(external_gc_element_["createElement"])(external_gc_components_["MenuGroup"], {
...
function Header(_ref) {
  ...
  const [[hasUndo, hasRedo], setUndoRedo] = Object(external_gc_element_["useState"])([sidebar.hasUndo(), sidebar.hasRedo()]);
  Object(external_gc_element_["useEffect"])(() => {
  ...
  }, Object(external_gc_element_["createElement"])(external_gc_blockEditor_["NavigableToolbar"], {
  ...
  }), Object(external_gc_element_["createElement"])(MoreMenu, null))), Object(external_gc_element_["createPortal"])(Object(external_gc_element_["createElement"])(components_inserter, {
...
function useInserter(inserter) {
  const isInserterOpened = Object(external_gc_data_["useSelect"])(select => select(store).isInserterOpened(), []);
  const {
    setIsInserterOpened
  } = Object(external_gc_data_["useDispatch"])(store);
  Object(external_gc_element_["useEffect"])(() => {
  ...
  return [isInserterOpened, Object(external_gc_element_["useCallback"])(updater => {
    let isOpen = updater;

    if (typeof updater === 'function') {
      isOpen = updater(Object(external_gc_data_["select"])(store).isInserterOpened());
    }
...
// EXTERNAL MODULE: external ["gc","isShallowEqual"]
var external_gc_isShallowEqual_ = __webpack_require__("xgAW");
var external_gc_isShallowEqual_default = /*#__PURE__*/__webpack_require__.n(external_gc_isShallowEqual_);
...
function widgetToBlock(_ref) {
  ...
  if (idBase === 'block') {
    const parsedBlocks = Object(external_gc_blocks_["parse"])(raw.content);
    block = parsedBlocks.length ? parsedBlocks[0] : Object(external_gc_blocks_["createBlock"])('core/paragraph', {});
  } else if (number) {
    // Widget that extends GC_Widget.
    block = Object(external_gc_blocks_["createBlock"])('core/legacy-widget', {
      idBase,
      instance: {
        encoded,
        hash,
  ...
  return Object(external_gc_widgets_["addWidgetIdToBlock"])(block, id);
}
...
function useSidebarBlockEditor(sidebar) {
  const [blocks, setBlocks] = Object(external_gc_element_["useState"])(() => widgetsToBlocks(sidebar.getWidgets()));
  Object(external_gc_element_["useEffect"])(() => {
    return sidebar.subscribe((prevWidgets, nextWidgets) => {
      setBlocks(prevBlocks => {
        const prevWidgetsMap = new Map(prevWidgets.map(widget => [widget.id, widget]));
        const prevBlocksMap = new Map(prevBlocks.map(block => [Object(external_gc_widgets_["getWidgetIdFromBlock"])(block), block]));
  ...
  const onChangeBlocks = Object(external_gc_element_["useCallback"])(nextBlocks => {
    setBlocks(prevBlocks => {
      if (external_gc_isShallowEqual_default()(prevBlocks, nextBlocks)) {
        return prevBlocks;
      }
      ...
      const nextWidgets = nextBlocks.map(nextBlock => {
        const widgetId = Object(external_gc_widgets_["getWidgetIdFromBlock"])(nextBlock); // Update existing widgets.
      ...
      return nextBlocks.reduce((updatedNextBlocks, nextBlock, index) => {
        ...
        if (addedWidgetId !== null) {
          ...
          updatedNextBlocks[index] = Object(external_gc_widgets_["addWidgetIdToBlock"])(nextBlock, addedWidgetId);
        }
...
const FocusControlContext = Object(external_gc_element_["createContext"])();
function FocusControl(_ref) {
  ...
  const [focusedWidgetIdRef, setFocusedWidgetIdRef] = Object(external_gc_element_["useState"])({
    current: null
  });
  const focusWidget = Object(external_gc_element_["useCallback"])(widgetId => {
  ...
  const context = Object(external_gc_element_["useMemo"])(() => [focusedWidgetIdRef, focusWidget], [focusedWidgetIdRef, focusWidget]);
  return Object(external_gc_element_["createElement"])(FocusControlContext.Provider, {
    value: context
  }, children);
}
const useFocusControl = () => Object(external_gc_element_["useContext"])(FocusControlContext);
...
function useBlocksFocusControl(blocks) {
  ...
  const blocksRef = Object(external_gc_element_["useRef"])(blocks);
  Object(external_gc_element_["useEffect"])(() => {
    blocksRef.current = blocks;
  }, [blocks]);
  Object(external_gc_element_["useEffect"])(() => {
    if (focusedWidgetIdRef.current) {
      const focusedBlock = blocksRef.current.find(block => Object(external_gc_widgets_["getWidgetIdFromBlock"])(block) === focusedWidgetIdRef.current);
...
// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/welcome-guide/index.js
...
function WelcomeGuide(_ref) {
  ...
  }, Object(external_gc_element_["createElement"])("picture", null, Object(external_gc_element_["createElement"])("source", {
  ...
  }, Object(external_gc_i18n_["__"])('欢迎来到区块小工具')), Object(external_gc_element_["createElement"])("p", {
    className: "customize-widgets-welcome-guide__text"
  }, isEntirelyBlockWidgets ? Object(external_gc_i18n_["__"])('') : Object(external_gc_i18n_["__"])('您现可在站点的小工具区添加任意区块。不用担心，您之前添加的所有小工具仍然可完美运作。')), Object(external_gc_element_["createElement"])(external_gc_components_["Button"], {
    className: "customize-widgets-welcome-guide__button",
    variant: "primary",
    onClick: () => toggleFeature('core/customize-widgets', 'welcomeGuide')
  }, Object(external_gc_i18n_["__"])('知道了')), Object(external_gc_element_["createElement"])("hr", {
    className: "customize-widgets-welcome-guide__separator"
  }), !isEntirelyBlockWidgets && Object(external_gc_element_["createElement"])("p", {
    className: "customize-widgets-welcome-guide__more-info"
  }, Object(external_gc_i18n_["__"])('想坚持使用旧版小工具吗？'), Object(external_gc_element_["createElement"])("br", null), Object(external_gc_element_["createElement"])(external_gc_components_["ExternalLink"], {
...
function KeyboardShortcuts(_ref) {
  ...
  Object(external_gc_keyboardShortcuts_["useShortcut"])('core/customize-widgets/undo', event => {
    undo();
    event.preventDefault();
  });
  Object(external_gc_keyboardShortcuts_["useShortcut"])('core/customize-widgets/redo', event => {
    redo();
    event.preventDefault();
  });
  Object(external_gc_keyboardShortcuts_["useShortcut"])('core/customize-widgets/save', event => {
    event.preventDefault();
    save();
  });
  return null;
...
function BlockAppender(props) {
  ...
  const isBlocksListEmpty = Object(external_gc_data_["useSelect"])(select => select(external_gc_blockEditor_["store"]).getBlockCount() === 0); // Move the focus to the block appender to prevent focus from
  ...
  return Object(external_gc_element_["createElement"])(external_gc_blockEditor_["ButtonBlockAppender"], Object(esm_extends["a" /* default */])({}, props, {
    ref: ref
  }));
}
...
function SidebarBlockEditor(_ref) {
  ...
  if (isWelcomeGuideActive) {
    return Object(external_gc_element_["createElement"])(WelcomeGuide, {
      sidebar: sidebar
    });
  }

  return Object(external_gc_element_["createElement"])(external_gc_element_["Fragment"], null, Object(external_gc_element_["createElement"])(external_gc_blockEditor_["BlockEditorKeyboardShortcuts"].Register, null), Object(external_gc_element_["createElement"])(keyboard_shortcuts.Register, null), Object(external_gc_element_["createElement"])(SidebarEditorProvider, {
    sidebar: sidebar,
    settings: settings
  }, Object(external_gc_element_["createElement"])(keyboard_shortcuts, {
    undo: sidebar.undo,
    redo: sidebar.redo,
    save: sidebar.save
  }), Object(external_gc_element_["createElement"])(header, {
    sidebar: sidebar,
    inserter: inserter,
    isInserterOpened: isInserterOpened,
    setIsInserterOpened: setIsInserterOpened,
    isFixedToolbarActive: isFixedToolbarActive
  }), Object(external_gc_element_["createElement"])(external_gc_blockEditor_["CopyHandler"], null, Object(external_gc_element_["createElement"])(external_gc_blockEditor_["BlockTools"], null, Object(external_gc_element_["createElement"])(external_gc_blockEditor_["__unstableEditorStyles"], {
    styles: settings.defaultEditorStyles
  }), Object(external_gc_element_["createElement"])(external_gc_blockEditor_["BlockSelectionClearer"], null, Object(external_gc_element_["createElement"])(external_gc_blockEditor_["WritingFlow"], {
    className: "editor-styles-wrapper"
  }, Object(external_gc_element_["createElement"])(external_gc_blockEditor_["ObserveTyping"], null, Object(external_gc_element_["createElement"])(external_gc_blockEditor_["BlockList"], {
    renderAppender: BlockAppender
  })))))), Object(external_gc_element_["createPortal"])( // This is a temporary hack to prevent button component inside <BlockInspector>
  // from submitting form when type="button" is not specified.
  Object(external_gc_element_["createElement"])("form", {
    onSubmit: event => event.preventDefault()
  }, Object(external_gc_element_["createElement"])(external_gc_blockEditor_["BlockInspector"], null)), inspector.contentContainer[0])), Object(external_gc_element_["createElement"])(external_gc_blockEditor_["__unstableBlockSettingsMenuFirstItem"], null, _ref4 => {
    let {
      onClose
    } = _ref4;
...
const SidebarControlsContext = Object(external_gc_element_["createContext"])();
function SidebarControls(_ref) {
  ...
  return Object(external_gc_element_["createElement"])(SidebarControlsContext.Provider, {
    value: context
  }, children);
}
function useSidebarControls() {
  const {
    sidebarControls
  } = Object(external_gc_element_["useContext"])(SidebarControlsContext);
...
function CustomizeWidgets(_ref) {
  ...
  const [activeSidebarControl, setActiveSidebarControl] = Object(external_gc_element_["useState"])(null);
  const parentContainer = document.getElementById('customize-theme-controls');
  const popoverRef = Object(external_gc_element_["useRef"])();
  ...
  const activeSidebar = activeSidebarControl && Object(external_gc_element_["createPortal"])(Object(external_gc_element_["createElement"])(error_boundary_ErrorBoundary, null, Object(external_gc_element_["createElement"])(SidebarBlockEditor, {
  ...
  const popover = parentContainer && Object(external_gc_element_["createPortal"])(Object(external_gc_element_["createElement"])("div", {
    className: "customize-widgets-popover",
    ref: popoverRef
  }, Object(external_gc_element_["createElement"])(external_gc_components_["Popover"].Slot, null)), parentContainer);
  return Object(external_gc_element_["createElement"])(external_gc_keyboardShortcuts_["ShortcutProvider"], null, Object(external_gc_element_["createElement"])(external_gc_components_["SlotFillProvider"], null, Object(external_gc_element_["createElement"])(SidebarControls, {
    sidebarControls: sidebarControls,
    activeSidebarControl: activeSidebarControl
  }, Object(external_gc_element_["createElement"])(FocusControl, {
    api: api,
    sidebarControls: sidebarControls
  ...
  return class SidebarSection extends customize.Section {
    ready() {
      ...
      this.inspector = new InspectorSection(getInspectorSectionId(this.id), {
        title: Object(external_gc_i18n_["__"])('区块设置'),
        parentSection: this,
        customizeAction: [Object(external_gc_i18n_["__"])('正在自定义'), Object(external_gc_i18n_["__"])('小工具'), this.params.title].join(' ▸ ')
      });
  ...
  return class InserterOuterSection extends customize.OuterSection {
    constructor() {
      ...
      ownerWindow.addEventListener('keydown', event => {
        if (this.expanded() && (event.keyCode === external_gc_keycodes_["ESCAPE"] || event.code === 'Escape') && !event.defaultPrevented) {
          event.preventDefault();
          event.stopPropagation();
          Object(external_gc_data_["dispatch"])(store).setIsInserterOpened(false);
        }
      ...
      this.expanded.bind(() => {
        if (!this.isFromInternalAction) {
          ...
          Object(external_gc_data_["dispatch"])(store).setIsInserterOpened(this.expanded());
        }
      ...
      if (!this.expanded()) {
        ...
        this.expand({
          completeCallback() {
            ...
            const searchBox = external_gc_dom_["focus"].tabbable.find(contentContainer)[1];
...
const withMoveToSidebarToolbarItem = Object(external_gc_compose_["createHigherOrderComponent"])(BlockEdit => props => {
  let widgetId = Object(external_gc_widgets_["getWidgetIdFromBlock"])(props);
  ...
  const canInsertBlockInSidebar = Object(external_gc_data_["useSelect"])(select => {
    // Use an empty string to represent the root block list, which
    // in the customizer editor represents a sidebar/widget area.
    return select(external_gc_blockEditor_["store"]).canInsertBlockType(blockName, '');
  }, [blockName]);
  const block = Object(external_gc_data_["useSelect"])(select => select(external_gc_blockEditor_["store"]).getBlock(clientId), [clientId]);
  const {
    removeBlock
  } = Object(external_gc_data_["useDispatch"])(external_gc_blockEditor_["store"]);
...
Object(external_gc_hooks_["addFilter"])('editor.BlockEdit', 'core/customize-widgets/block-edit', withMoveToSidebarToolbarItem);
...
const withWideWidgetDisplay = Object(external_gc_compose_["createHigherOrderComponent"])(BlockEdit => props => {
  var _gc$customize$Widgets, _gc$customize$Widgets2;

  const {
    idBase
  } = props.attributes;
  const isWide = (_gc$customize$Widgets = (_gc$customize$Widgets2 = wide_widget_display_gc.customize.Widgets.data.availableWidgets.find(widget => widget.id_base === idBase)) === null || _gc$customize$Widgets2 === void 0 ? void 0 : _gc$customize$Widgets2.is_wide) !== null && _gc$customize$Widgets !== void 0 ? _gc$customize$Widgets : false;
  return Object(external_gc_element_["createElement"])(BlockEdit, Object(esm_extends["a" /* default */])({}, props, {
    isWide: isWide
  }));
}, 'withWideWidgetDisplay');
Object(external_gc_hooks_["addFilter"])('editor.BlockEdit', 'core/customize-widgets/wide-widget-display', withWideWidgetDisplay);
...
function initialize(editorName, blockEditorSettings) {
  Object(external_gc_data_["dispatch"])(build_module["i" /* store */]).setFeatureDefaults('core/customize-widgets', {
    fixedToolbar: false,
    welcomeGuide: true
  });
  ...
  Object(external_gc_widgets_["registerLegacyWidgetVariations"])(blockEditorSettings);
  Object(external_gc_widgets_["registerWidgetGroupBlock"])(); // As we are unregistering `core/freeform` to avoid the Classic block, we must
  ...
  build_module_gc.customize.bind('ready', () => {
    ...
    Object(external_gc_element_["render"])(Object(external_gc_element_["createElement"])(CustomizeWidgets, {
