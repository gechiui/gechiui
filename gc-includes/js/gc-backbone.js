...
(function ($) {
	/**
	 * Create the GeChiUI Backbone namespace.
	 *
	 * @namespace gc.Backbone
	 */
	gc.Backbone = {};
	 ...
	 * @class
	 *
	 * @param {gc.Backbone.View} view  The main view.
	 * @param {Array|Object}     views The subviews for the main view.
	 */
	gc.Backbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	gc.Backbone.Subviews.extend = Backbone.Model.extend;

	_.extend( gc.Backbone.Subviews.prototype, {
		/**
		...
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || gc.Backbone.Subviews,
	...
	gc.Backbone.View = Backbone.View.extend({

		// The constructor for the `Views` manager.
		Subviews: gc.Backbone.Subviews,
