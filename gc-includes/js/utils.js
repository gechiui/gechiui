...
// The following functions are from Cookie.js class in TinyMCE 3, Moxiecode, used under LGPL.
	 ...
	 *
	 * 'values_obj' is the JS object that is stored. It is encoded as URI in gcCookies.set().
	 */
...
window.setUserSetting = function( name, value, _del ) {
	...
	var uid = userSettings.uid,
		settings = gcCookies.getHash( 'gc-settings-' + uid ),
	...
	gcCookies.setHash( 'gc-settings-' + uid, settings, 31536000, path, '', secure );
	gcCookies.set( 'gc-settings-time-' + uid, userSettings.time, 31536000, path, '', secure );
...
window.getAllUserSettings = function() {
	...
	return gcCookies.getHash( 'gc-settings-' + userSettings.uid ) || {};
};
