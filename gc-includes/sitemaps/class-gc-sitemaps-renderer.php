<?php
/**
 * Sitemaps: GC_Sitemaps_Renderer class
 *
...
class GC_Sitemaps_Renderer {
	...
	public function get_sitemap_stylesheet_url() {
		...
		$sitemap_url = home_url( '/gc-sitemap.xsl' );
		 ...
		 */
		return apply_filters( 'gc_sitemaps_stylesheet_url', $sitemap_url );
	}
	...
	public function get_sitemap_index_stylesheet_url() {
		...
		$sitemap_url = home_url( '/gc-sitemap-index.xsl' );
		 ...
		 */
		return apply_filters( 'gc_sitemaps_stylesheet_index_url', $sitemap_url );
	}
	...
	public function render_index( $sitemaps ) {
		...
		if ( ! empty( $index_xml ) ) {
			...
			// phpcs:ignore GeChiUI.Security.EscapeOutput.OutputNotEscaped
			echo $index_xml;
		}
	}
