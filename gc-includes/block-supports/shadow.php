 ...
 */
function gc_register_shadow_support( $block_type ) {
 ...
 */
function gc_apply_shadow_support( $block_type, $block_attributes ) {
	$has_shadow_support = block_has_support( $block_type, array( 'shadow' ), false );
	...
	$attributes = array();
	$styles     = gc_style_engine_get_styles( $shadow_block_styles );
...
GC_Block_Supports::get_instance()->register(
	'shadow',
	array(
		'register_attribute' => 'gc_register_shadow_support',
		'apply'              => 'gc_apply_shadow_support',
	)
);
