...
final class GC_Comment {
	 ...
	 * @return GC_Comment|false Comment object, otherwise false.
	 */
	 ...
	 * }
	 * @return GC_Comment[] Array of `GC_Comment` objects.
	 */
	public function get_children( $args = array() ) {
		...
		$_args           = gc_parse_args( $args, $defaults );
