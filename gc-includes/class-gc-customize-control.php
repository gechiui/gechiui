<?php
/**
 * GeChiUI Customize Control classes
 *
 * @package GeChiUI
...
class GC_Customize_Control {
	 ...
	 *               GC_Customize_Control, and returns bool to indicate whether
	 ...
	 *                                                 to other instances.
	 *     @type GC_Customize_Manager $manager         Customizer bootstrap instance.
	 ...
	 *     @type array                $json            Deprecated. Use GC_Customize_Control::json() instead.
	...
	/**
	 * Default callback used when invoking GC_Customize_Control::active().
	 *
	...
	public function get_link( $setting_key = 'default' ) {
		if ( isset( $this->settings[ $setting_key ] ) && $this->settings[ $setting_key ] instanceof GC_Customize_Setting ) {
	 ...
	 * export custom variables by overriding GC_Customize_Control::to_json().
	 *
...
/**
 * GC_Customize_Nav_Menu_Locations_Control class.
 */
require_once ABSPATH . GCINC . '/customize/class-gc-customize-nav-menu-locations-control.php';

/**
 * GC_Customize_Nav_Menu_Auto_Add_Control class.
 */
require_once ABSPATH . GCINC . '/customize/class-gc-customize-nav-menu-auto-add-control.php';

/**
 * GC_Customize_Date_Time_Control class.
 */
require_once ABSPATH . GCINC . '/customize/class-gc-customize-date-time-control.php';

/**
 * GC_Sidebar_Block_Editor_Control class.
 */
require_once ABSPATH . GCINC . '/customize/class-gc-sidebar-block-editor-control.php';
