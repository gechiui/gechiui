<?php
/**
 * Blocks API: GC_Block_Type_Registry class
 *
 * @package GeChiUI
 * @subpackage Blocks
 * @since 5.0.0
...
final class GC_Block_Type_Registry {
	 ...
	 *                                   a complete GC_Block_Type instance. In case a GC_Block_Type
	...
	public function register( $name, $args = array() ) {
		...
		if ( ! preg_match( $name_matcher, $name ) ) {
			_doing_it_wrong(
				__METHOD__,
				__( '区块类型名必须包含命名空间前缀，例如：my-plugin/my-custom-block-type' ),
				'5.0.0'
			);
			return false;
		}
