...
use GcOrg\Requests\Auth\Basic;
use GcOrg\Requests\Capability;
use GcOrg\Requests\Cookie\Jar;
use GcOrg\Requests\Exception;
use GcOrg\Requests\Exception\InvalidArgument;
use GcOrg\Requests\Hooks;
use GcOrg\Requests\IdnaEncoder;
use GcOrg\Requests\Iri;
use GcOrg\Requests\Proxy\Http;
use GcOrg\Requests\Response;
use GcOrg\Requests\Transport\Curl;
use GcOrg\Requests\Transport\Fsockopen;
use GcOrg\Requests\Utility\InputValidator;
...
class Requests {
	 ...
	 * Option defaults.
	 *
	 * @see \GcOrg\Requests\Requests::get_default_options()
	 * @see \GcOrg\Requests\Requests::request() for values returned by this method
	 *
	 * @since 2.0.0
	 *
	 * @var array
	 ...
	 *
	 * Use {@see \GcOrg\Requests\Requests::get_transport()} instead
	 *
	 * @var array
	 */
	 ...
	 *
	 * @see \GcOrg\Requests\Requests::get_certificate_path()
	 * @see \GcOrg\Requests\Requests::set_certificate_path()
	 *
	 * @var string
	 */
	 ...
	 *
	 * @param string $transport Transport class to add, must support the \GcOrg\Requests\Transport interface
	 */
	 ...
	 *
	 * @param array<string, bool> $capabilities Optional. Associative array of capabilities to test against, i.e. `['<capability>' => true]`.
	 * @return \GcOrg\Requests\Transport
	 * @throws \GcOrg\Requests\Exception If no valid transport is found (`notransport`).
	 */
	 ...
	 *
	 * Supported capabilities can be found in the {@see \GcOrg\Requests\Capability}
	...
	/**#@+
	 * @see \GcOrg\Requests\Requests::request()
	 * @param string $url
	 * @param array $headers
	 * @param array $options
	 * @return \GcOrg\Requests\Response
	 */
	/**
	 * Send a GET request
	 */
	 ...
	 *
	 * Note: Unlike {@see \GcOrg\Requests\Requests::post()} and {@see \GcOrg\Requests\Requests::put()},
	 ...
	 *    (\GcOrg\Requests\Auth|array|boolean, default: false)
	 * - `proxy`: Proxy details to use for proxy by-passing and authentication
	 *    (\GcOrg\Requests\Proxy|array|string|boolean, default: false)
	 ...
	 *    {@see \GcOrg\Requests\Requests::getTransport()}
	 *    (string|\GcOrg\Requests\Transport, default: {@see \GcOrg\Requests\Requests::getTransport()})
	 * - `hooks`: Hooks handler.
	 *    (\GcOrg\Requests\HookManager, default: new GcOrg\Requests\Hooks())
	 ...
	 * @return \GcOrg\Requests\Response
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $url argument is not a string or Stringable.
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $type argument is not a string.
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $options argument is not an array.
	 * @throws \GcOrg\Requests\Exception On invalid URLs (`nonhttp`)
	 */
	 ...
	 *    parameter to {@see \GcOrg\Requests\Requests::request()}
	 *    (array, default: `array()`)
	 * - `data`: Associative array of data fields or a string. Same as the
	 *    `$data` parameter to {@see \GcOrg\Requests\Requests::request()}
	 *    (array|string, default: `array()`)
	 * - `type`: HTTP request type (use \GcOrg\Requests\Requests constants). Same as the `$type`
	 *    parameter to {@see \GcOrg\Requests\Requests::request()}
	 *    (string, default: `\GcOrg\Requests\Requests::GET`)
	 * - `cookies`: Associative array of cookie name to value, or cookie jar.
	 *    (array|\GcOrg\Requests\Cookie\Jar)
	 *
	 * If the `$options` parameter is specified, individual requests will
	 * inherit options from it. This can be used to use a single hooking system,
	 * or set all the types to `\GcOrg\Requests\Requests::POST`, for example.
	 *
	 * In addition, the `$options` parameter takes the following global options:
	 *
	 * - `complete`: A callback for when a request is complete. Takes two
	 *    parameters, a \GcOrg\Requests\Response/\GcOrg\Requests\Exception reference, and the
	 *    ID from the request array (Note: this can also be overridden on a
	 *    per-request basis, although that's a little silly)
	 *    (callback)
	 *
	 * @param array $requests Requests data (see description for more information)
	 * @param array $options Global and default options (see {@see \GcOrg\Requests\Requests::request()})
	 * @return array Responses (either \GcOrg\Requests\Response or a \GcOrg\Requests\Exception object)
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $requests argument is not an array or iterable object with array access.
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $options argument is not an array.
	 */
	 ...
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $url argument is not a string, Stringable or boolean.
	 */
	 ...
	 * @return void
	 *
	 * @throws \GcOrg\Requests\Exception When the $url is not an http(s) URL.
	 */
	 ...
	 * @return \GcOrg\Requests\Response
	 *
	 * @throws \GcOrg\Requests\Exception On missing head/body separator (`requests.no_crlf_separator`)
	 * @throws \GcOrg\Requests\Exception On missing head/body separator (`noversion`)
	 * @throws \GcOrg\Requests\Exception On missing head/body separator (`toomanyredirects`)
	 */
	 ...
	 *
	 * Internal use only. Converts a raw HTTP response to a \GcOrg\Requests\Response
	 * while still executing a multiple request.
	 *
	 * `$response` is either set to a \GcOrg\Requests\Response instance, or a \GcOrg\Requests\Exception object
	 *
	 * @param string $response Full response text including headers and body (will be overwritten with Response instance)
	 * @param array $request Request data as passed into {@see \GcOrg\Requests\Requests::request_multiple()}
	 * @return void
	 */
	 ...
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed argument is not iterable.
	 */
	 ...
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed argument is not a string.
	 */
