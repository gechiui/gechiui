...
namespace GcOrg\Requests\Proxy;

use GcOrg\Requests\Exception\ArgumentCount;
use GcOrg\Requests\Exception\InvalidArgument;
use GcOrg\Requests\Hooks;
use GcOrg\Requests\Proxy;
...
final class Http implements Proxy {
	 ...
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed argument is not an array, a string or null.
	 * @throws \GcOrg\Requests\Exception\ArgumentCount On incorrect number of arguments (`proxyhttpbadargs`)
	 */
	 ...
	 *
	 * @since 1.6
	 * @see \GcOrg\Requests\Proxy\Http::curl_before_send()
	 * @see \GcOrg\Requests\Proxy\Http::fsockopen_remote_socket()
	 * @see \GcOrg\Requests\Proxy\Http::fsockopen_remote_host_path()
	 * @see \GcOrg\Requests\Proxy\Http::fsockopen_header()
