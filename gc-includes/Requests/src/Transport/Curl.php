...
use GcOrg\Requests\Exception\Transport\Curl as CurlException;
...
final class Curl implements Transport {
	 ...
	 * @throws \GcOrg\Requests\Exception       On a cURL error (`curlerror`)
	 */
	public function request($url, $headers = [], $data = [], $options = []) {
		...
		// Otherwise \GcOrg\Requests\Transport\Curl won't be garbage collected and the curl_close() will never be called.
	 ...
	 * @throws \GcOrg\Requests\Exception If the request resulted in a cURL error.
	 */
