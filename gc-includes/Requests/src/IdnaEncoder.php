...
class IdnaEncoder {
	 ...
	 *
	 * @see \GcOrg\Requests\IdnaEncoder::to_ascii()
	 *
	 * @since 2.0.0
	 *
	 * @var int
	 ...
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed argument is not a string or a stringable object.
	 */
	 ...
	 *
	 * @throws \GcOrg\Requests\Exception Provided string longer than 64 ASCII characters (`idna.provided_too_long`)
	 * @throws \GcOrg\Requests\Exception Prepared string longer than 64 ASCII characters (`idna.prepared_too_long`)
	 * @throws \GcOrg\Requests\Exception Provided string already begins with xn-- (`idna.provided_is_prefixed`)
	 * @throws \GcOrg\Requests\Exception Encoded string longer than 64 ASCII characters (`idna.encoded_too_long`)
	 */
	 ...
	 *
	 * Based on \GcOrg\Requests\Iri::replace_invalid_with_pct_encoding()
	 *
	 * @param string $input Text to convert.
	 * @return array Unicode code points
	 *
	 * @throws \GcOrg\Requests\Exception Invalid UTF-8 codepoint (`idna.invalidcodepoint`)
	 */
	 ...
	 *
	 * @throws \GcOrg\Requests\Exception On character outside of the domain (never happens with Punycode) (`idna.character_outside_domain`)
	 */
	 ...
	 *
	 * @throws \GcOrg\Requests\Exception On invalid digit (`idna.invalid_digit`)
	 */
