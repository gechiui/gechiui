...
use GcOrg\Requests\Response\Headers;
...
class Cookie {
	 ...
	 * `'httponly'`.
	 *
	 * @var \GcOrg\Requests\Utility\CaseInsensitiveDictionary|array Array-like object
	 */
	public $attributes = [];
	 ...
	 * @param array|\GcOrg\Requests\Utility\CaseInsensitiveDictionary $attributes Associative array of attribute data
	 ...
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $name argument is not a string.
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $value argument is not a string.
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $attributes argument is not an array or iterable object with array access.
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $flags argument is not an array.
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $reference_time argument is not an integer or null.
	 */
	 ...
	 *
	 * @param \GcOrg\Requests\Iri $uri URI to check
	 ...
	 * @return \GcOrg\Requests\Cookie Parsed cookie object
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $cookie_header argument is not a string.
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When the passed $name argument is not a string.
	 */
	 ...
	 *
	 * @param \GcOrg\Requests\Response\Headers $headers Headers to parse from
	 * @param \GcOrg\Requests\Iri|null $origin URI for comparing cookie origins
