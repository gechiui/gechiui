...
final class Port {
	 ...
	 * @return int
	 *
	 * @throws \GcOrg\Requests\Exception\InvalidArgument When a non-string input has been passed.
	 * @throws \GcOrg\Requests\Exception                 When a non-supported port is requested ('portnotsupported').
	 */
