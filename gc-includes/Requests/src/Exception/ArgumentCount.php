...
namespace GcOrg\Requests\Exception;
...
final class ArgumentCount extends Exception {
	 ...
	 *
	 * @return \GcOrg\Requests\Exception\ArgumentCount
	 */
	public static function create($expected, $received, $type) {
		// phpcs:ignore GeChiUI.PHP.DevelopmentFunctions.error_log_debug_backtrace
