 ...
 */
function gc_set_unique_slug_on_create_template_part( $post_id ) {
...
function gc_filter_gc_template_unique_post_slug( $override_slug, $slug, $post_ID, $post_status, $post_type ) {
	 ...
	 * Unfortunately using `get_the_terms()` for the 'gc-theme' term does not work
	...
	$check_query      = new GC_Query( $check_query_args );
...
function the_block_template_skip_link() {
	...
	( function() {
		...
		if ( ! skipLinkTargetID ) {
			skipLinkTargetID = 'gc--skip-link--target';
