<?php
/**
 * GeChiUI implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 * @package PHP
 * @access private
 */
 ...
 */
function _gc_can_use_pcre_u( $set = null ) {
	...
	if ( 'reset' === $utf8_pcre ) {
		// phpcs:ignore GeChiUI.PHP.NoSilencedErrors.Discouraged -- intentional error generated to detect PCRE/u support.
...
if ( ! function_exists( 'random_int' ) ) {
	require ABSPATH . GCINC . '/random_compat/random.php';
}
// sodium_crypto_box() was introduced in PHP 7.2.
if ( ! function_exists( 'sodium_crypto_box' ) ) {
	require ABSPATH . GCINC . '/sodium_compat/autoload.php';
}
