...
class GC_Theme_JSON_Data {
	 ...
	 * @since 6.1.0
	 *
	 * @link https://developer.gechiui.com/block-editor/reference-guides/theme-json-reference/
	 *
	...
	public function __construct( $data = array(), $origin = 'theme' ) {
		$this->origin     = $origin;
		$this->theme_json = new GC_Theme_JSON( $data, $this->origin );
	}
	 ...
	 *
	 * @return GC_Theme_JSON_Data The own instance with access to the modified data.
	 */
	public function update_with( $new_data ) {
		$this->theme_json->merge( new GC_Theme_JSON( $new_data, $this->origin ) );
		return $this;
	}
