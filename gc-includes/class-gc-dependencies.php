<?php
/**
 * Dependencies API: GC_Dependencies base class
 *
 * @package GeChiUI
...
class GC_Dependencies {
	 ...
	 *
	 * @since 2.6.0 Moved from `GC_Scripts`. Added the `$group` parameter.
	 *
	 ...
	 *
	 * @since 2.6.0 Moved from `GC_Scripts`.
	 *
	 * @param string           $handle Name of the item. Should be unique.
	 * @param string|false     $src    Full URL of the item, or path of the item relative
	 *                                 to the GeChiUI root directory. If source is set to false,
	 ...
	 *                                 equal to current installed GeChiUI version.
	 ...
	 * @since 4.0.0
	 *
	 * @param string[] $queue  An array of queued _GC_Dependency handles.
	 * @param string   $handle Name of the item. Should be unique.
	 ...
	 * @return bool|_GC_Dependency Found, or object Item data.
	 */
