...
class GC_Metadata_Lazyloader {
	 ...
	 *
	 * @since 4.5.0
	 * @deprecated 6.3.0 Use GC_Metadata_Lazyloader::lazyload_meta_callback() instead.
	 *
	...
	public function lazyload_term_meta( $check ) {
		_deprecated_function( __METHOD__, '6.3.0', 'GC_Metadata_Lazyloader::lazyload_meta_callback' );
