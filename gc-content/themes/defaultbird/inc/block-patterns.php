 ...
 * @return void
 */
function defaultbird_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( '特色', 'defaultbird' ) ),
		'footer'   => array( 'label' => __( '页脚', 'defaultbird' ) ),
		'header'   => array( 'label' => __( '页眉', 'defaultbird' ) ),
		'query'    => array( 'label' => __( '查询', 'defaultbird' ) ),
		'pages'    => array( 'label' => __( '页面', 'defaultbird' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'defaultbird_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'defaultbird_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'defaultbird/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'defaultbird_register_block_patterns', 9 );
