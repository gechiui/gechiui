...
class GC_Filesystem_Base {
	 ...
	 *
	 * @deprecated 2.7.0 use GC_Filesystem_Base::abspath() or GC_Filesystem_Base::gc_*_dir() instead.
	 * @see GC_Filesystem_Base::abspath()
	 * @see GC_Filesystem_Base::gc_content_dir()
	 * @see GC_Filesystem_Base::gc_plugins_dir()
	 ...
	 * Locates a folder on the remote filesystem.
	 *
	 * @deprecated 2.7.0 use GC_Filesystem_Base::abspath() or GC_Filesystem_Base::gc_*_dir() methods instead.
	 * @see GC_Filesystem_Base::abspath()
	 * @see GC_Filesystem_Base::gc_content_dir()
	 * @see GC_Filesystem_Base::gc_plugins_dir()
	 * @see GC_Filesystem_Base::gc_themes_dir()
	...
	public function find_folder( $folder ) {
		...
		if ( stripos( $this->method, 'ftp' ) !== false ) {
			$constant_overrides = array(
				'FTP_BASE'        => ABSPATH,
				'FTP_CONTENT_DIR' => GC_CONTENT_DIR,
				'FTP_PLUGIN_DIR'  => GC_PLUGIN_DIR,
				'FTP_LANG_DIR'    => GC_LANG_DIR,
			);
	...
	public function search_for_folder( $folder, $base = '.', $loop = false ) {
		...
		foreach ( $folder_parts as $index => $key ) {
			...
			/*
			 * Working from /home/ to /user/ to /gechiui/ see if that file exists within
			 * the current folder, If it's found, change into it and follow through looking
			 * for it. If it can't find GeChiUI down that route, it'll continue onto the next
	 ...
	 * @abstract
	 *
	 * @return bool True on success, false on failure (always true for GC_Filesystem_Direct).
	 */
