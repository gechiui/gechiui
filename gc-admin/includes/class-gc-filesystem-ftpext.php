...
/**
 * GeChiUI Filesystem Class for implementing FTP.
 *
 * @see GC_Filesystem_Base
 */
class GC_Filesystem_FTPext extends GC_Filesystem_Base {
	...
	public function __construct( $opt = '' ) {
		...
		if ( ! extension_loaded( 'ftp' ) ) {
			$this->errors->add( 'no_ftp_ext', __( 'PHP 扩展 ftp 不可用' ) );
			return;
		}
