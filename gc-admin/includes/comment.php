...
function edit_comment() {
	...
	return gc_update_comment( $_POST, true );
}
...
function get_pending_comments_num( $post_id ) {
	...
	$pending = $gcdb->get_results( "SELECT comment_post_ID, COUNT(comment_ID) as num_comments FROM $gcdb->comments WHERE comment_post_ID IN ( $post_id_in ) AND comment_approved = '0' GROUP BY comment_post_ID", ARRAY_A );
