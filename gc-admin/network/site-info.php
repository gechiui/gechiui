...
<form method="post" action="site-info.php?action=update-site">
	...
	<table class="form-table" role="presentation">
		...
		if ( $is_main_site ) :
			?>
		<tr class="form-field">
			<th scope="row"><?php _e( '站点地址（URL）' ); ?></th>
		...
		<tr>
			...
			<td>
			<fieldset>
			<legend class="screen-reader-text"><?php _e( '设置站点属性' ); ?></legend>
