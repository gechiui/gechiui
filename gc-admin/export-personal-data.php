...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
					...
					'<p>' . __( '世界各地许多地区的隐私法要求企业或网站提供其所收集的有关个人的所有数据，这项规定有时也被称为“数据携带权”。' ) . '</p>' .
...
<div class="wrap nosubsub">
	<h1><?php esc_html_e( '导出个人数据' ); ?></h1>
	<p><?php _e( '此工具可以导出给定用户的已知数据并打包为.zip文件，有助于网站所有者遵守当地法律法规。' ); ?></p>
