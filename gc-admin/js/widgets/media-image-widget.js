/**
 * @output gc-admin/js/widgets/media-image-widget.js
 */
...
(function( component, $ ) {
	 ...
	 * Image widget model.
	 *
	 * See GC_Widget_Media_Image::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	 * @class    gc.mediaWidgets.modelConstructors.media_image
	 ...
	 */
	ImageWidgetControl = component.MediaWidgetControl.extend(/** @lends gc.mediaWidgets.controlConstructors.media_image.prototype */{
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = gc.template( 'gc-media-widget-image-preview' );
			...
			if ( ! linkInput.is( document.activeElement ) ) {
				...
				fieldsTemplate = gc.template( 'gc-media-widget-image-fields' );
		...
		editMedia: function editMedia() {
			...
			// Disable syncing of attachment changes back to server. See <https://core.trac.gechiui.com/ticket/40403>.
			defaultSync = gc.media.model.Attachment.prototype.sync;
			gc.media.model.Attachment.prototype.sync = function rejectedSync() {
