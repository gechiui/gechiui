<?php
		...
		<form class="admin-email-confirm-form" name="admin-email-confirm-form" action="<?php echo esc_url( site_url( 'gc-login.php?action=confirm_admin_email', 'login_post' ) ); ?>" method="post">
			...
			<p class="admin-email__details">
				<?php _e( '请确认此站点的<strong>管理员电子邮箱</strong>仍然正确。' ); ?>
				<?php
			...
			<div class="admin-email__actions">
				<div class="admin-email__actions-primary">
					...
					?>
					<a class="button button-large" href="<?php echo esc_url( $change_link ); ?>"><?php _e( '更新' ); ?></a>
					<input type="submit" name="correct-admin-email" id="correct-admin-email" class="button button-primary button-large" value="<?php esc_attr_e( '此电子邮箱正确' ); ?>" />
				</div>
