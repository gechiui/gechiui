 ...
 * The setting name is `gctextpattern` and the value is an object containing override arrays for each
 * patterns group. There are three groups: "space", "enter", and "inline". Example (PHP):
 *
 * add_filter( 'tiny_mce_before_init', 'my_mce_init_gctextpattern' );
 * function my_mce_init_gctextpattern( $init ) {
 *   $init['gctextpattern'] = gc_json_encode( array(
 *      'inline' => array(
...
( function( tinymce, setTimeout ) {
	...
	tinymce.PluginManager.add( 'gctextpattern', function( editor ) {
		var VK = tinymce.util.VK;
		var settings = editor.settings.gctextpattern || {};
