...
( function() {
	...
	tinyMCE.addI18n( lang + ".gechiui", {
		gc_adv_desc: "Show/Hide Kitchen Sink (Alt + Shift + Z)",
		gc_more_desc: "Insert More Tag (Alt + Shift + T)",
		gc_page_desc: "Insert Page break (Alt + Shift + P)",
