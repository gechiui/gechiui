 ...
 * @param {Object} gc  Current GeChiUI environment instance.
 * @param {Object} api Information from the API.
 *
 * @return {Object} Widget-related variables.
 */
gc.customize.widgetsPreview = gc.customize.WidgetCustomizerPreview = (function( $, _, gc, api ) {
	...
	self.WidgetPartial = api.selectiveRefresh.Partial.extend(/** @lends gc.customize.widgetsPreview.WidgetPartial.prototype */{
		 ...
		 *
		 * @alias gc.customize.widgetsPreview.WidgetPartial
		 * @memberOf gc.customize.widgetsPreview
		 *
		 ...
		 *
		 * @inheritDoc
		 * @param {gc.customize.selectiveRefresh.Placement} placement The placement
		 *                                                            function.
		 *
		 * @return {void}
		 */
	...
	self.SidebarPartial = api.selectiveRefresh.Partial.extend(/** @lends gc.customize.widgetsPreview.SidebarPartial.prototype */{
		 ...
		 *
		 * @memberOf gc.customize.widgetsPreview
		 * @alias gc.customize.widgetsPreview.SidebarPartial
		 *
		 * @param {string} id             The partial's ID.
		 ...
		 *
		 * @return {gc.customize.selectiveRefresh.Partial} The widget instance partial.
		 */
	...
	api.bind( 'preview-ready', function() {
		$.extend( self, _gcWidgetCustomizerPreviewSettings );
		self.init();
	});
