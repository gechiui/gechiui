...
(function( exports, $ ){
	 ...
	 * @alias gc.customize.Value
	 *
	 * @constructor
	 */
	api.Value = api.Class.extend(/** @lends gc.customize.Value.prototype */{
		/**
	 ...
	 *
	 * @memberOf gc.customize
	 * @alias gc.customize.Values
	 *
	 * @constructor
	 * @augments gc.customize.Class
	 * @mixes gc.customize.Events
	 */
	api.Values = api.Class.extend(/** @lends gc.customize.Values.prototype */{
	 ...
	 *
	 * @memberOf gc.customize
	 * @alias gc.customize.Element
	 *
	 * @constructor
	 * @augments gc.customize.Value
	 * @augments gc.customize.Class
	 */
	api.Element = api.Value.extend(/** @lends gc.customize.Element */{
	 ...
	 *
	 * @memberOf gc.customize
	 * @alias gc.customize.Messenger
	 *
	 * @constructor
	 * @augments gc.customize.Class
	 * @mixes gc.customize.Events
	 */
	api.Messenger = api.Class.extend(/** @lends gc.customize.Messenger.prototype */{
		/**
		 * Create a new Value.
		 *
	 ...
	 */
	api.Notification = api.Class.extend(/** @lends gc.customize.Notification.prototype */{
		...
		render: function() {
			...
			if ( ! notification.template ) {
				notification.template = gc.template( notification.templateId );
			}
	...
	/**
	 * Expose the API publicly on window.gc.customize
	 *
	 * @namespace gc.customize
	 */
