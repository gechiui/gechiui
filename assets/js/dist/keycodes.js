...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keycodes/build-module/platform.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keycodes/build-module/index.js
/**
...
/** @typedef {(event: import('react').KeyboardEvent<HTMLElement> | KeyboardEvent, character: string, isApple?: () => boolean) => boolean} GCEventKeyHandler */

/** @typedef {( isApple: () => boolean ) => GCModifierPart[]} GCModifier */
  ...
  return (
    ...
    (character, _isApple = isAppleOS) => {
      ...
      const replacementKeyMap = {
        ...
        ',': (0,external_gc_i18n_namespaceObject.__)('逗号'),

        /* translators: period as in the character '.' */
        '.': (0,external_gc_i18n_namespaceObject.__)('句号'),

        /* translators: backtick as in the character '`' */
        '`': (0,external_gc_i18n_namespaceObject.__)('反引号'),

        /* translators: tilde as in the character '~' */
        '~': (0,external_gc_i18n_namespaceObject.__)('波浪号')
      };
...
(window.gc = window.gc || {}).keycodes = __webpack_exports__;
/******/ })()
;