 ...
 * @property {GCPriorityQueueFlush} cancel Clear queue for context.
...
const createQueue = () => {
  /** @type {Map<GCPriorityQueueContext, GCPriorityQueueCallback>} */
...
(window.gc = window.gc || {}).priorityQueue = __webpack_exports__;
/******/ })()
;