...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/defaultSettings.js
 ...
 * @property {RegExp}              adaptivelRegExp                      Regular expression that matches adaptivel UTF-16 code points
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/stripTags.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/transposeAdaptivelsToCountableChar.js
/**
 ...
 * @return {string} The manipulated text.
 */
function transposeAdaptivelsToCountableChar(settings, text) {
  return text.replace(settings.adaptivelRegExp, 'a');
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/stripHTMLEntities.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/stripConnectors.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/stripRemovables.js
/**
 * Removes items matched in the regex.
 *
 * @param {import('./index').GCWordCountSettings} settings The main settings object containing regular expressions
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/stripHTMLComments.js
/**
 * Removes items matched in the regex.
 *
 * @param {import('./index').GCWordCountSettings} settings The main settings object containing regular expressions
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/stripShortcodes.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/stripSpaces.js
/**
 * Replaces items matched in the regex with spaces.
 *
 * @param {import('./index').GCWordCountSettings} settings The main settings object containing regular expressions
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/transposeHTMLEntitiesToCountableChars.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/wordcount/build-module/index.js
/**
...
function countCharacters(text, regex, settings) {
  ...
  text = [stripTags.bind(null, settings), stripHTMLComments.bind(null, settings), stripShortcodes.bind(null, settings), transposeAdaptivelsToCountableChar.bind(null, settings), stripSpaces.bind(null, settings), transposeHTMLEntitiesToCountableChars.bind(null, settings)].reduce((result, fn) => fn(result), text);
  text = text + '\n';
...
(window.gc = window.gc || {}).wordcount = __webpack_exports__;
/******/ })()
;