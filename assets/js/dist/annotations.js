...
/******/ 	return __webpack_require__(__webpack_require__.s = "iStz");
/******/ })
/************************************************************************/
/******/ ({
...
function applyAnnotations(record) {
  ...
  annotations.forEach(annotation => {
    ...
    record = Object(external_gc_richText_["applyFormat"])(record, {
      type: FORMAT_NAME,
      attributes: {
        className,
        id
...
function removeAnnotations(record) {
  return Object(external_gc_richText_["removeFormat"])(record, 'core/annotation', 0, record.text.length);
}
/**
...
const annotation_annotation = {
  name: FORMAT_NAME,
  title: Object(external_gc_i18n_["__"])('批注'),
  tagName: 'mark',
...
Object(external_gc_richText_["registerFormatType"])(format_name, settings);
...
const addAnnotationClassName = OriginalComponent => {
  return Object(external_gc_data_["withSelect"])((select, _ref) => {
    let {
      clientId,
      className
    } = _ref;
...
Object(external_gc_hooks_["addFilter"])('editor.BlockListBlock', 'core/annotations', addAnnotationClassName);
