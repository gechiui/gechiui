...
// NAMESPACE OBJECT: ./node_modules/@gechiui/keyboard-shortcuts/build-module/store/actions.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/keyboard-shortcuts/build-module/store/selectors.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/store/reducer.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/store/actions.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/store/selectors.js
/**
...
const FORMATTING_METHODS = {
  display: external_gc_keycodes_namespaceObject.displayShortcut,
  raw: external_gc_keycodes_namespaceObject.rawShortcut,
  ariaLabel: external_gc_keycodes_namespaceObject.shortcutAriaLabel
};
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/store/index.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/hooks/use-shortcut-event-match.js
/**
 * GeChiUI dependencies
 */
...
function useShortcutEventMatch() {
  ...
  function isMatch(name, event) {
    return getAllShortcutKeyCombinations(name).some(({
      ...
      return external_gc_keycodes_namespaceObject.isKeyboardEvent[modifier](event, character);
    });
  }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/context.js
/**
 * GeChiUI dependencies
 */

const context = (0,external_gc_element_namespaceObject.createContext)();

;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/hooks/use-shortcut.js
/**
 * GeChiUI dependencies
 */
...
function useShortcut(name, callback, {
  ...
  const shortcuts = (0,external_gc_element_namespaceObject.useContext)(context);
  const isMatch = useShortcutEventMatch();
  const callbackRef = (0,external_gc_element_namespaceObject.useRef)();
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/components/shortcut-provider.js
...
function ShortcutProvider(props) {
  const keyboardShortcuts = (0,external_gc_element_namespaceObject.useRef)(new Set());
  ...
  }, (0,external_gc_element_namespaceObject.createElement)("div", { ...props,
    onKeyDown: onKeyDown
  }));
  /* eslint-enable jsx-a11y/no-static-element-interactions */
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/keyboard-shortcuts/build-module/index.js





(window.gc = window.gc || {}).keyboardShortcuts = __webpack_exports__;
/******/ })()
;