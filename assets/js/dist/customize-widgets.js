...
// NAMESPACE OBJECT: ./node_modules/@gechiui/customize-widgets/build-module/store/selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/customize-widgets/build-module/store/actions.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/error-boundary/index.js
...
class ErrorBoundary extends external_gc_element_namespaceObject.Component {
  ...
  render() {
    ...
    return (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.Warning, {
      ...
      actions: [(0,external_gc_element_namespaceObject.createElement)(CopyButton, {
        key: "copy-error",
        text: error.stack
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/block-inspector-button/index.js
...
function BlockInspectorButton({
  ...
  const selectedBlockClientId = (0,external_gc_data_namespaceObject.useSelect)(select => select(external_gc_blockEditor_namespaceObject.store).getSelectedBlockClientId(), []);
  const selectedBlock = (0,external_gc_element_namespaceObject.useMemo)(() => document.getElementById(`block-${selectedBlockClientId}`), [selectedBlockClientId]);
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.MenuItem, {
    ...
    ...props
  }, (0,external_gc_i18n_namespaceObject.__)('显示更多设置'));
}
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/store/reducer.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/store/selectors.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/store/actions.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/store/constants.js
/**
 * Module Constants
 */
const STORE_NAME = 'core/customize-widgets';

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/store/index.js
/**
 * GeChiUI dependencies
 */
 ...
 *
 * @see https://github.com/GeChiUI/gutenberg/blob/HEAD/packages/data/README.md#registering-a-store
 *
 * @type {Object}
 */
...
const store = (0,external_gc_data_namespaceObject.createReduxStore)(STORE_NAME, storeConfig);
(0,external_gc_data_namespaceObject.register)(store);

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/inserter/index.js
...
function Inserter({
  ...
  const inserterTitleId = (0,external_gc_compose_namespaceObject.useInstanceId)(Inserter, 'customize-widget-layout__inserter-panel-title');
  const insertionPoint = (0,external_gc_data_namespaceObject.useSelect)(select => select(store).__experimentalGetInsertionPoint(), []);
  ...
  }, (0,external_gc_i18n_namespaceObject.__)('添加区块')), (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Button, {
    className: "customize-widgets-layout__inserter-panel-header-close-button",
    icon: close_small,
    onClick: () => setIsOpened(false),
    "aria-label": (0,external_gc_i18n_namespaceObject.__)('关闭插入器')
  })), (0,external_gc_element_namespaceObject.createElement)("div", {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/keyboard-shortcut-help-modal/config.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/keyboard-shortcut-help-modal/shortcut.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/keyboard-shortcut-help-modal/dynamic-shortcut.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/keyboard-shortcut-help-modal/index.js
...
function KeyboardShortcutHelpModal({
  ...
  (0,external_gc_keyboardShortcuts_namespaceObject.useShortcut)('core/customize-widgets/keyboard-shortcuts', toggleModal);
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/more-menu/index.js
...
function MoreMenu() {
  ...
  (0,external_gc_keyboardShortcuts_namespaceObject.useShortcut)('core/customize-widgets/keyboard-shortcuts', toggleKeyboardShortcutsModal);
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_element_namespaceObject.Fragment, null, (0,external_gc_element_namespaceObject.createElement)(MoreMenuDropdown, {
    as: external_gc_components_namespaceObject.ToolbarDropdownMenu
  ...
  (0,external_gc_i18n_namespaceObject.__)('（在新窗口中打开）')))), (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.MenuGroup, {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/header/index.js
...
function Header({
  ...
  const [[hasUndo, hasRedo], setUndoRedo] = (0,external_gc_element_namespaceObject.useState)([sidebar.hasUndo(), sidebar.hasRedo()]);
  ...
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_element_namespaceObject.Fragment, null, (0,external_gc_element_namespaceObject.createElement)("div", {
  ...
  }, (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.NavigableToolbar, {
    ...
    variant: "primary",
    icon: library_plus,
    label: (0,external_gc_i18n_namespaceObject._x)('添加区块', 'Generic label for block inserter button'),
    onClick: () => {
      setIsInserterOpened(isOpen => !isOpen);
    }
  }), (0,external_gc_element_namespaceObject.createElement)(MoreMenu, null))), (0,external_gc_element_namespaceObject.createPortal)((0,external_gc_element_namespaceObject.createElement)(components_inserter, {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/inserter/use-inserter.js
/**
 * GeChiUI dependencies
 */
...
function useInserter(inserter) {
  const isInserterOpened = (0,external_gc_data_namespaceObject.useSelect)(select => select(store).isInserterOpened(), []);
  const {
    setIsInserterOpened
  ...
  return [isInserterOpened, (0,external_gc_element_namespaceObject.useCallback)(updater => {
    let isOpen = updater;

    if (typeof updater === 'function') {
      isOpen = updater((0,external_gc_data_namespaceObject.select)(store).isInserterOpened());
    }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/utils.js
// @ts-check
...
function widgetToBlock({
  ...
  if (idBase === 'block') {
    ...
    const parsedBlocks = (0,external_gc_blocks_namespaceObject.parse)((_raw$content = raw.content) !== null && _raw$content !== void 0 ? _raw$content : '', {
      __unstableSkipAutop: true
    });
    block = parsedBlocks.length ? parsedBlocks[0] : (0,external_gc_blocks_namespaceObject.createBlock)('core/paragraph', {});
  } else if (number) {
    // Widget that extends GC_Widget.
    block = (0,external_gc_blocks_namespaceObject.createBlock)('core/legacy-widget', {
      idBase,
      instance: {
        encoded,
        hash,
  ...
  return (0,external_gc_widgets_namespaceObject.addWidgetIdToBlock)(block, id);
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/sidebar-block-editor/use-sidebar-block-editor.js
/**
 * External dependencies
 */
...
function useSidebarBlockEditor(sidebar) {
  const [blocks, setBlocks] = (0,external_gc_element_namespaceObject.useState)(() => widgetsToBlocks(sidebar.getWidgets()));
  (0,external_gc_element_namespaceObject.useEffect)(() => {
    return sidebar.subscribe((prevWidgets, nextWidgets) => {
      setBlocks(prevBlocks => {
        const prevWidgetsMap = new Map(prevWidgets.map(widget => [widget.id, widget]));
        const prevBlocksMap = new Map(prevBlocks.map(block => [(0,external_gc_widgets_namespaceObject.getWidgetIdFromBlock)(block), block]));
        ...
        if (external_gc_isShallowEqual_default()(prevBlocks, nextBlocks)) {
          return prevBlocks;
        }
  ...
  const onChangeBlocks = (0,external_gc_element_namespaceObject.useCallback)(nextBlocks => {
    setBlocks(prevBlocks => {
      if (external_gc_isShallowEqual_default()(prevBlocks, nextBlocks)) {
        return prevBlocks;
      }
      ...
      const nextWidgets = nextBlocks.map(nextBlock => {
        const widgetId = (0,external_gc_widgets_namespaceObject.getWidgetIdFromBlock)(nextBlock); // Update existing widgets.
      ...
      if (external_gc_isShallowEqual_default()(sidebar.getWidgets(), nextWidgets)) {
        return prevBlocks;
      }
      ...
      return nextBlocks.reduce((updatedNextBlocks, nextBlock, index) => {
        ...
        if (addedWidgetId !== null) {
          ...
          updatedNextBlocks[index] = (0,external_gc_widgets_namespaceObject.addWidgetIdToBlock)(nextBlock, addedWidgetId);
        }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/focus-control/index.js
...
const FocusControlContext = (0,external_gc_element_namespaceObject.createContext)();
function FocusControl({
  api,
  sidebarControls,
  children
}) {
  const [focusedWidgetIdRef, setFocusedWidgetIdRef] = (0,external_gc_element_namespaceObject.useState)({
    current: null
  });
  const focusWidget = (0,external_gc_element_namespaceObject.useCallback)(widgetId => {
  ...
  const context = (0,external_gc_element_namespaceObject.useMemo)(() => [focusedWidgetIdRef, focusWidget], [focusedWidgetIdRef, focusWidget]);
  return (0,external_gc_element_namespaceObject.createElement)(FocusControlContext.Provider, {
    value: context
  }, children);
}
const useFocusControl = () => (0,external_gc_element_namespaceObject.useContext)(FocusControlContext);

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/focus-control/use-blocks-focus-control.js
/**
 * GeChiUI dependencies
 */
...
function useBlocksFocusControl(blocks) {
  ...
  const blocksRef = (0,external_gc_element_namespaceObject.useRef)(blocks);
  (0,external_gc_element_namespaceObject.useEffect)(() => {
    blocksRef.current = blocks;
  }, [blocks]);
  (0,external_gc_element_namespaceObject.useEffect)(() => {
    if (focusedWidgetIdRef.current) {
      const focusedBlock = blocksRef.current.find(block => (0,external_gc_widgets_namespaceObject.getWidgetIdFromBlock)(block) === focusedWidgetIdRef.current);
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/lock-unlock.js
/**
 * GeChiUI dependencies
 */
...
const {
  lock,
  unlock
} = (0,external_gc_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next GeChiUI release.', '@gechiui/customize-widgets');

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/sidebar-block-editor/sidebar-editor-provider.js
...
function SidebarEditorProvider({
  ...
  return (0,external_gc_element_namespaceObject.createElement)(ExperimentalBlockEditorProvider, {
    value: blocks,
    onInput: onInput,
    onChange: onChange,
    settings: settings,
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/keyboard-shortcuts/index.js
/**
 * GeChiUI dependencies
 */
...
function KeyboardShortcuts({
  ...
  (0,external_gc_keyboardShortcuts_namespaceObject.useShortcut)('core/customize-widgets/undo', event => {
    undo();
    event.preventDefault();
  });
  (0,external_gc_keyboardShortcuts_namespaceObject.useShortcut)('core/customize-widgets/redo', event => {
    redo();
    event.preventDefault();
  });
  (0,external_gc_keyboardShortcuts_namespaceObject.useShortcut)('core/customize-widgets/save', event => {
    event.preventDefault();
    save();
  });
  (0,external_gc_keyboardShortcuts_namespaceObject.useShortcut)('core/customize-widgets/transform-heading-to-paragraph', event => handleTextLevelShortcut(event, 0));
  [1, 2, 3, 4, 5, 6].forEach(level => {
    //the loop is based off on a constant therefore
    //the hook will execute the same way every time
    //eslint-disable-next-line react-hooks/rules-of-hooks
    (0,external_gc_keyboardShortcuts_namespaceObject.useShortcut)(`core/customize-widgets/transform-paragraph-to-heading-${level}`, event => handleTextLevelShortcut(event, level));
  });
  return null;
}
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/block-appender/index.js
...
function BlockAppender(props) {
  ...
  const isBlocksListEmpty = (0,external_gc_data_namespaceObject.useSelect)(select => select(external_gc_blockEditor_namespaceObject.store).getBlockCount() === 0); // Move the focus to the block appender to prevent focus from
  ...
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.ButtonBlockAppender, { ...props,
    ref: ref
  });
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/sidebar-block-editor/index.js
...
function SidebarBlockEditor({
  ...
  const {
    ...
    const {
      get
    } = select(external_gc_preferences_namespaceObject.store);
    return {
      hasUploadPermissions: (_select$canUser = select(external_gc_coreData_namespaceObject.store).canUser('create', 'media')) !== null && _select$canUser !== void 0 ? _select$canUser : true,
  ...
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_element_namespaceObject.Fragment, null, (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.BlockEditorKeyboardShortcuts.Register, null), (0,external_gc_element_namespaceObject.createElement)(keyboard_shortcuts.Register, null), (0,external_gc_element_namespaceObject.createElement)(SidebarEditorProvider, {
    sidebar: sidebar,
    settings: settings
  }, (0,external_gc_element_namespaceObject.createElement)(keyboard_shortcuts, {
    undo: sidebar.undo,
    redo: sidebar.redo,
    save: sidebar.save
  }), (0,external_gc_element_namespaceObject.createElement)(header, {
    sidebar: sidebar,
    inserter: inserter,
    isInserterOpened: isInserterOpened,
    setIsInserterOpened: setIsInserterOpened,
    isFixedToolbarActive: isFixedToolbarActive
  }), (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.CopyHandler, null, (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.BlockTools, null, (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.__unstableEditorStyles, {
    styles: settings.defaultEditorStyles
  }), (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.BlockSelectionClearer, null, (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.WritingFlow, {
    className: "editor-styles-wrapper"
  }, (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.ObserveTyping, null, (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.BlockList, {
    renderAppender: BlockAppender
  })))))), (0,external_gc_element_namespaceObject.createPortal)( // This is a temporary hack to prevent button component inside <BlockInspector>
  // from submitting form when type="button" is not specified.
  (0,external_gc_element_namespaceObject.createElement)("form", {
    onSubmit: event => event.preventDefault()
  }, (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.BlockInspector, null)), inspector.contentContainer[0])), (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.__unstableBlockSettingsMenuFirstItem, null, ({
    onClose
  }) => (0,external_gc_element_namespaceObject.createElement)(block_inspector_button, {
    inspector: inspector,
    closeMenu: onClose
  })));
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/sidebar-controls/index.js
...
const SidebarControlsContext = (0,external_gc_element_namespaceObject.createContext)();
function SidebarControls({
  ...
  return (0,external_gc_element_namespaceObject.createElement)(SidebarControlsContext.Provider, {
    value: context
  }, children);
}
function useSidebarControls() {
  const {
    sidebarControls
  } = (0,external_gc_element_namespaceObject.useContext)(SidebarControlsContext);
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/customize-widgets/use-clear-selected-block.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/customize-widgets/index.js
...
function CustomizeWidgets({
  ...
  const [activeSidebarControl, setActiveSidebarControl] = (0,external_gc_element_namespaceObject.useState)(null);
  const parentContainer = document.getElementById('customize-theme-controls');
  const popoverRef = (0,external_gc_element_namespaceObject.useRef)();
  ...
  const activeSidebar = activeSidebarControl && (0,external_gc_element_namespaceObject.createPortal)((0,external_gc_element_namespaceObject.createElement)(ErrorBoundary, null, (0,external_gc_element_namespaceObject.createElement)(SidebarBlockEditor, {
  ...
  const popover = parentContainer && (0,external_gc_element_namespaceObject.createPortal)((0,external_gc_element_namespaceObject.createElement)("div", {
    className: "customize-widgets-popover",
    ref: popoverRef
  }, (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Popover.Slot, null)), parentContainer);
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_keyboardShortcuts_namespaceObject.ShortcutProvider, null, (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.SlotFillProvider, null, (0,external_gc_element_namespaceObject.createElement)(SidebarControls, {
    sidebarControls: sidebarControls,
    activeSidebarControl: activeSidebarControl
  }, (0,external_gc_element_namespaceObject.createElement)(FocusControl, {
    api: api,
    sidebarControls: sidebarControls
  }, activeSidebar, popover))));
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/controls/inspector-section.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/controls/sidebar-section.js
/**
 * GeChiUI dependencies
 */
  ...
  return class SidebarSection extends customize.Section {
    ready() {
      ...
      this.inspector = new InspectorSection(getInspectorSectionId(this.id), {
        title: (0,external_gc_i18n_namespaceObject.__)('区块设置'),
        parentSection: this,
        customizeAction: [(0,external_gc_i18n_namespaceObject.__)('正在自定义'), (0,external_gc_i18n_namespaceObject.__)('小工具'), this.params.title].join(' ▸ ')
      });
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/components/sidebar-block-editor/sidebar-adapter.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/controls/inserter-outer-section.js
/**
 * GeChiUI dependencies
 */
  ...
  return class InserterOuterSection extends customize.OuterSection {
    constructor(...args) {
      ...
      ownerWindow.addEventListener('keydown', event => {
        if (this.expanded() && (event.keyCode === external_gc_keycodes_namespaceObject.ESCAPE || event.code === 'Escape') && !event.defaultPrevented) {
          event.preventDefault();
          event.stopPropagation();
          (0,external_gc_data_namespaceObject.dispatch)(store).setIsInserterOpened(false);
        }
      ...
      this.expanded.bind(() => {
        if (!this.isFromInternalAction) {
          ...
          (0,external_gc_data_namespaceObject.dispatch)(store).setIsInserterOpened(this.expanded());
        }
      ...
      if (!this.expanded()) {
        ...
        this.expand({
          completeCallback() {
            ...
            const searchBox = external_gc_dom_namespaceObject.focus.tabbable.find(contentContainer)[1];
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/controls/sidebar-control.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/filters/move-to-sidebar.js
...
const withMoveToSidebarToolbarItem = (0,external_gc_compose_namespaceObject.createHigherOrderComponent)(BlockEdit => props => {
  let widgetId = (0,external_gc_widgets_namespaceObject.getWidgetIdFromBlock)(props);
  const sidebarControls = useSidebarControls();
  const activeSidebarControl = useActiveSidebarControl();
  const hasMultipleSidebars = sidebarControls?.length > 1;
  const blockName = props.name;
  const clientId = props.clientId;
  const canInsertBlockInSidebar = (0,external_gc_data_namespaceObject.useSelect)(select => {
    // Use an empty string to represent the root block list, which
    // in the customizer editor represents a sidebar/widget area.
    return select(external_gc_blockEditor_namespaceObject.store).canInsertBlockType(blockName, '');
  }, [blockName]);
  const block = (0,external_gc_data_namespaceObject.useSelect)(select => select(external_gc_blockEditor_namespaceObject.store).getBlock(clientId), [clientId]);
  const {
    removeBlock
  } = (0,external_gc_data_namespaceObject.useDispatch)(external_gc_blockEditor_namespaceObject.store);
  ...
  }), hasMultipleSidebars && canInsertBlockInSidebar && (0,external_gc_element_namespaceObject.createElement)(external_gc_blockEditor_namespaceObject.BlockControls, null, (0,external_gc_element_namespaceObject.createElement)(external_gc_widgets_namespaceObject.MoveToWidgetArea, {
...
(0,external_gc_hooks_namespaceObject.addFilter)('editor.BlockEdit', 'core/customize-widgets/block-edit', withMoveToSidebarToolbarItem);

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/filters/replace-media-upload.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/filters/wide-widget-display.js
...
const {
  gc: wide_widget_display_gc
} = window;
const withWideWidgetDisplay = (0,external_gc_compose_namespaceObject.createHigherOrderComponent)(BlockEdit => props => {
  var _gc$customize$Widgets;

  const {
    idBase
  } = props.attributes;
  const isWide = (_gc$customize$Widgets = wide_widget_display_gc.customize.Widgets.data.availableWidgets.find(widget => widget.id_base === idBase)?.is_wide) !== null && _gc$customize$Widgets !== void 0 ? _gc$customize$Widgets : false;
  return (0,external_gc_element_namespaceObject.createElement)(BlockEdit, { ...props,
    isWide: isWide
  });
}, 'withWideWidgetDisplay');
(0,external_gc_hooks_namespaceObject.addFilter)('editor.BlockEdit', 'core/customize-widgets/wide-widget-display', withWideWidgetDisplay);

;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/filters/index.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/customize-widgets/build-module/index.js
...
function initialize(editorName, blockEditorSettings) {
  (0,external_gc_data_namespaceObject.dispatch)(external_gc_preferences_namespaceObject.store).setDefaults('core/customize-widgets', {
    fixedToolbar: false
  });
  ...
  (0,external_gc_widgets_namespaceObject.registerLegacyWidgetVariations)(blockEditorSettings);
  (0,external_gc_widgets_namespaceObject.registerWidgetGroupBlock)(); // As we are unregistering `core/freeform` to avoid the Classic block, we must
  ...
  build_module_gc.customize.sectionConstructor.sidebar = getSidebarSection();
  build_module_gc.customize.controlConstructor.sidebar_block_editor = SidebarControl;
  const container = document.createElement('div');
  document.body.appendChild(container);
  build_module_gc.customize.bind('ready', () => {
    const sidebarControls = [];
    build_module_gc.customize.control.each(control => {
      if (control instanceof SidebarControl) {
        sidebarControls.push(control);
      }
    });
    (0,external_gc_element_namespaceObject.createRoot)(container).render((0,external_gc_element_namespaceObject.createElement)(CustomizeWidgets, {
      api: build_module_gc.customize,
      sidebarControls: sidebarControls,
      blockEditorSettings: blockEditorSettings
    }));
  });
...
(window.gc = window.gc || {}).customizeWidgets = __webpack_exports__;
/******/ })()
;