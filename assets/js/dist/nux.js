...
const preferences = (0,external_gc_data_namespaceObject.combineReducers)({
  areTipsEnabled,
  dismissedTips
});
...
(0,external_gc_data_namespaceObject.registerStore)(STORE_NAME, {
  reducer: reducer,
  actions: actions_namespaceObject,
  selectors: selectors_namespaceObject,
  persist: ['preferences']
...
function DotTip({
  ...
  const anchorParent = (0,external_gc_element_namespaceObject.useRef)(null);
  const onFocusOutsideCallback = (0,external_gc_element_namespaceObject.useCallback)(event => {
  ...
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Popover, {
    ...
    focusOnMount: true,
    role: "dialog",
    "aria-label": (0,external_gc_i18n_namespaceObject.__)('编辑器贴士'),
    onClick: onClick,
    onFocusOutside: onFocusOutsideCallback
  }, (0,external_gc_element_namespaceObject.createElement)("p", null, children), (0,external_gc_element_namespaceObject.createElement)("p", null, (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Button, {
    variant: "link",
    onClick: onDismiss
  }, hasNextTip ? (0,external_gc_i18n_namespaceObject.__)('查看下一个贴士') : (0,external_gc_i18n_namespaceObject.__)('知道了'))), (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Button, {
    className: "nux-dot-tip__disable",
    icon: library_close,
    label: (0,external_gc_i18n_namespaceObject.__)('禁用贴士'),
    onClick: onDisable
  }));
}
/* harmony default export */ var dot_tip = ((0,external_gc_compose_namespaceObject.compose)((0,external_gc_data_namespaceObject.withSelect)((select, {
  tipId
}) => {
  const {
    isTipVisible,
...
(window.gc = window.gc || {}).nux = __webpack_exports__;
/******/ })()
;