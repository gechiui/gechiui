...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-commands/build-module/admin-navigation-commands.js
/**
 * GeChiUI dependencies
 */
...
function useAdminNavigationCommands() {
  (0,external_gc_commands_namespaceObject.useCommand)({
    ...
    label: (0,external_gc_i18n_namespaceObject.__)('添加新文章'),
    icon: library_plus,
    callback: () => {
  ...
  (0,external_gc_commands_namespaceObject.useCommand)({
    ...
    label: (0,external_gc_i18n_namespaceObject.__)('添加新标签'),
    icon: library_plus,
    callback: () => {
  ...
  (0,external_gc_commands_namespaceObject.useCommand)({
    ...
    label: (0,external_gc_i18n_namespaceObject.__)('管理我的所有样板'),
    callback: () => {
      document.location.href = 'edit.php?post_type=gc_block';
    },
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-commands/build-module/lock-unlock.js
/**
 * GeChiUI dependencies
 */
...
const {
  lock,
  unlock
} = (0,external_gc_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next GeChiUI release.', '@gechiui/core-commands');

;// CONCATENATED MODULE: ./node_modules/@gechiui/core-commands/build-module/site-editor-navigation-commands.js
/**
 * GeChiUI dependencies
 */
...
const icons = {
  post: library_post,
  page: library_page,
  gc_template: library_layout,
  gc_template_part: symbol_filled
};
...
const getNavigationCommandLoaderPerPostType = postType => function useNavigationCommandLoader({
  ...
  const supportsSearch = !['gc_template', 'gc_template_part'].includes(postType);
  const {
    records,
    isLoading
    ...
    return {
      ...
      isLoading: !select(external_gc_coreData_namespaceObject.store).hasFinishedResolution('getEntityRecords', ['postType', postType, query])
    };
  ...
  const commands = (0,external_gc_element_namespaceObject.useMemo)(() => {
    return (records !== null && records !== void 0 ? records : []).slice(0, 10).map(record => {
      const isSiteEditor = (0,external_gc_url_namespaceObject.getPath)(window.location.href)?.includes('site-editor.php');
      const extraArgs = isSiteEditor ? {
        canvas: (0,external_gc_url_namespaceObject.getQueryArg)(window.location.href, 'canvas')
      } : {};
      return {
        name: postType + '-' + record.id,
        searchLabel: record.title?.rendered + ' ' + record.id,
        label: record.title?.rendered ? record.title?.rendered : (0,external_gc_i18n_namespaceObject.__)('（无标题）'),
        icon: icons[postType],
        callback: ({
          close
        }) => {
          ...
          const targetUrl = (0,external_gc_url_namespaceObject.addQueryArgs)('site-editor.php', args);
...
const useTemplateNavigationCommandLoader = getNavigationCommandLoaderPerPostType('gc_template');
const useTemplatePartNavigationCommandLoader = getNavigationCommandLoaderPerPostType('gc_template_part');
...
function useSiteEditorBasicNavigationCommands() {
  ...
  const commands = (0,external_gc_element_namespaceObject.useMemo)(() => {
    ...
    result.push({
      ...
      label: (0,external_gc_i18n_namespaceObject.__)('打开页面'),
      icon: library_page,
      callback: ({
        close
      }) => {
    ...
    result.push({
      ...
      label: (0,external_gc_i18n_namespaceObject.__)('打开样式变体'),
      icon: library_styles,
      callback: ({
        close
      }) => {
    ...
    result.push({
      ...
      label: (0,external_gc_i18n_namespaceObject.__)('打开模板'),
      icon: library_layout,
      callback: ({
        close
      }) => {
    ...
    result.push({
      ...
      label: (0,external_gc_i18n_namespaceObject.__)('打开样板'),
      icon: symbol_filled,
      callback: ({
        close
      }) => {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-commands/build-module/private-apis.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-commands/build-module/index.js


(window.gc = window.gc || {}).coreCommands = __webpack_exports__;
/******/ })()
;