...
// NAMESPACE OBJECT: ./node_modules/@gechiui/blocks/build-module/store/selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/blocks/build-module/store/private-selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/blocks/build-module/store/actions.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/constants.js
...
const __EXPERIMENTAL_STYLE_PROPERTY = {
  ...
  '--gc--style--root--padding': {
    value: ['spacing', 'padding'],
    support: ['spacing', 'padding'],
    properties: {
      '--gc--style--root--padding-top': 'top',
      '--gc--style--root--padding-right': 'right',
      '--gc--style--root--padding-bottom': 'bottom',
      '--gc--style--root--padding-left': 'left'
    },
    rootOnly: true
  }
};
const __EXPERIMENTAL_ELEMENTS = {
  ...
  h5: 'h5',
  h6: 'h6',
  button: '.gc-element-button, .gc-block-button__link',
  caption: '.gc-element-caption, .gc-block-audio figcaption, .gc-block-embed figcaption, .gc-block-gallery figcaption, .gc-block-image figcaption, .gc-block-table figcaption, .gc-block-video figcaption',
  cite: 'cite'
};
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/registration.js
...
function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    if (serverSideBlockDefinitions[blockName]) {
      ...
      // @see https://github.com/GeChiUI/gutenberg/pull/39894
      ...
      // minimum supported GeChiUI is >= 6.3.
 ...
 * [Create a block tutorial](https://developer.gechiui.com/block-editor/getting-started/create-block/).
 *
 ...
 * import { registerBlockType } from '@gechiui/blocks'
 *
...
function registerBlockType(blockNameOrMetadata, settings) {
  ...
  if ((0,external_gc_data_namespaceObject.select)(store).getBlockType(name)) {
  ...
  (0,external_gc_data_namespaceObject.dispatch)(store).__experimentalRegisterBlockType(blockType);

  return (0,external_gc_data_namespaceObject.select)(store).getBlockType(name);
}
/**
...
function translateBlockSettingUsingI18nSchema(i18nSchema, settingValue, textdomain) {
  if (typeof i18nSchema === 'string' && typeof settingValue === 'string') {
    ...
    return (0,external_gc_i18n_namespaceObject._x)(settingValue, i18nSchema, textdomain);
  }
 ...
 * ```js
 * import { __ } from '@gechiui/i18n';
 * import { registerBlockCollection, registerBlockType } from '@gechiui/blocks';
 *
...
function registerBlockCollection(namespace, {
  ...
  (0,external_gc_data_namespaceObject.dispatch)(store).addBlockCollection(namespace, title, icon);
}
/**
 ...
 * @example
 * ```js
 * import { unregisterBlockCollection } from '@gechiui/blocks';
 *
 ...
 * ```js
 * import { __ } from '@gechiui/i18n';
 * import { unregisterBlockType } from '@gechiui/blocks';
 *
 ...
 * ```
 *
 * @return {GCBlockType | undefined} The previous block value, if it has been successfully
 *                    unregistered; otherwise `undefined`.
 */

function unregisterBlockType(name) {
  const oldBlock = (0,external_gc_data_namespaceObject.select)(store).getBlockType(name);
  ...
  (0,external_gc_data_namespaceObject.dispatch)(store).removeBlockTypes(name);
  return oldBlock;
}
/**
...
function setFreeformContentHandlerName(blockName) {
  (0,external_gc_data_namespaceObject.dispatch)(store).setFreeformFallbackBlockName(blockName);
}
/**
...
function getFreeformContentHandlerName() {
  return (0,external_gc_data_namespaceObject.select)(store).getFreeformFallbackBlockName();
}
/**
...
function getGroupingBlockName() {
  return (0,external_gc_data_namespaceObject.select)(store).getGroupingBlockName();
}
/**
...
function setUnregisteredTypeHandlerName(blockName) {
  (0,external_gc_data_namespaceObject.dispatch)(store).setUnregisteredFallbackBlockName(blockName);
}
/**
...
function getUnregisteredTypeHandlerName() {
  return (0,external_gc_data_namespaceObject.select)(store).getUnregisteredFallbackBlockName();
}
/**
 ...
 * @example
 * ```js
 * import { setDefaultBlockName } from '@gechiui/blocks';
 *
 * const ExampleComponent = () => {
 *
 *     return (
...
function setDefaultBlockName(name) {
  (0,external_gc_data_namespaceObject.dispatch)(store).setDefaultBlockName(name);
}
/**
 ...
 * loaded. See https://developer.gechiui.com/block-editor/reference-guides/packages/packages-dom-ready/
 *
 * @param {string} name Block name.
 *
 * @example
 * ```js
 * import { setGroupingBlockName } from '@gechiui/blocks';
 *
 * const ExampleComponent = () => {
 *
 *     return (
...
function setGroupingBlockName(name) {
  (0,external_gc_data_namespaceObject.dispatch)(store).setGroupingBlockName(name);
}
/**
...
function getDefaultBlockName() {
  return (0,external_gc_data_namespaceObject.select)(store).getDefaultBlockName();
}
/**
...
function getBlockTypes() {
  return (0,external_gc_data_namespaceObject.select)(store).getBlockTypes();
}
/**
...
function getBlockSupport(nameOrType, feature, defaultSupports) {
  return (0,external_gc_data_namespaceObject.select)(store).getBlockSupport(nameOrType, feature, defaultSupports);
}
/**
...
function hasBlockSupport(nameOrType, feature, defaultSupports) {
  return (0,external_gc_data_namespaceObject.select)(store).hasBlockSupport(nameOrType, feature, defaultSupports);
}
/**
...
const getChildBlockNames = blockName => {
  return (0,external_gc_data_namespaceObject.select)(store).getChildBlockNames(blockName);
};
/**
...
const hasChildBlocks = blockName => {
  return (0,external_gc_data_namespaceObject.select)(store).hasChildBlocks(blockName);
};
/**
...
const hasChildBlocksWithInserterSupport = blockName => {
  return (0,external_gc_data_namespaceObject.select)(store).hasChildBlocksWithInserterSupport(blockName);
};
/**
 * Registers a new block style for the given block.
 *
 * For more information on connecting the styles with CSS
 * [the official documentation](https://developer.gechiui.com/block-editor/reference-guides/block-api/block-styles/#styles).
 *
 ...
 * ```js
 * import { __ } from '@gechiui/i18n';
 * import { registerBlockStyle } from '@gechiui/blocks';
...
const registerBlockStyle = (blockName, styleVariation) => {
  (0,external_gc_data_namespaceObject.dispatch)(store).addBlockStyles(blockName, styleVariation);
};
/**
 ...
 * ```js
 * import { __ } from '@gechiui/i18n';
 * import { unregisterBlockStyle } from '@gechiui/blocks';
 * import { Button } from '@gechiui/components';
 *
 * const ExampleComponent = () => {
 *     return (
...
const unregisterBlockStyle = (blockName, styleVariationName) => {
  (0,external_gc_data_namespaceObject.dispatch)(store).removeBlockStyles(blockName, styleVariationName);
};
/**
 * Returns an array with the variations of a given block type.
 * Ignored from documentation as the recommended usage is via useSelect from @gechiui/data.
 *
 * @ignore
 *
...
const getBlockVariations = (blockName, scope) => {
  return (0,external_gc_data_namespaceObject.select)(store).getBlockVariations(blockName, scope);
};
/**
 * Registers a new block variation for the given block type.
 *
 * For more information on block variations see
 * [the official documentation ](https://developer.gechiui.com/block-editor/reference-guides/block-api/block-variations/).
 *
 ...
 * ```js
 * import { __ } from '@gechiui/i18n';
 * import { registerBlockVariation } from '@gechiui/blocks';
 * import { Button } from '@gechiui/components';
 *
 * const ExampleComponent = () => {
 *     return (
...
const registerBlockVariation = (blockName, variation) => {
  (0,external_gc_data_namespaceObject.dispatch)(store).addBlockVariations(blockName, variation);
};
/**
 ...
 * ```js
 * import { __ } from '@gechiui/i18n';
 * import { unregisterBlockVariation } from '@gechiui/blocks';
 * import { Button } from '@gechiui/components';
 *
 * const ExampleComponent = () => {
 *     return (
 *         <Button
 *             onClick={ () => {
 *                 unregisterBlockVariation( 'core/embed', 'youku' );
 *             } }
 *         >
 *             { __( 'Remove the YouKu variation from core/embed' ) }
 *         </Button>
 *     );
 * };
 * ```
...
const unregisterBlockVariation = (blockName, variationName) => {
  (0,external_gc_data_namespaceObject.dispatch)(store).removeBlockVariations(blockName, variationName);
};

;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/node_modules/uuid/dist/esm-browser/rng.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/node_modules/uuid/dist/esm-browser/regex.js
/* harmony default export */ var regex = (/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i);
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/node_modules/uuid/dist/esm-browser/validate.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/node_modules/uuid/dist/esm-browser/stringify.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/node_modules/uuid/dist/esm-browser/v4.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/factory.js
/**
 * External dependencies
 */
...
function findTransform(transforms, predicate) {
  ...
  const hooks = (0,external_gc_hooks_namespaceObject.createHooks)();
...
function switchToBlockType(blocks, name) {
  ...
  const ret = transformationResults.map((result, index, results) => {
     ...
     */
    return (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.switchToBlockType.transformedBlock', result, blocks, index, results);
  });
  return ret;
}
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/utils.js
/**
 * External dependencies
 */
...
function isValidIcon(icon) {
  return !!icon && (typeof icon === 'string' || (0,external_gc_element_namespaceObject.isValidElement)(icon) || typeof icon === 'function' || icon instanceof external_gc_element_namespaceObject.Component);
}
/**
...
function getBlockLabel(blockType, attributes, context = 'visual') {
  ...
  return (0,external_gc_dom_namespaceObject.__unstableStripHTML)(label);
}
/**
...
function getAccessibleBlockLabel(blockType, attributes, position, direction = 'vertical') {
  ...
  if (hasPosition && direction === 'vertical') {
    if (hasLabel) {
      ...
      (0,external_gc_i18n_namespaceObject.__)('%1$s区块，第%2$d行。%3$s'), title, position, label);
    }

    return (0,external_gc_i18n_namespaceObject.sprintf)(
    /* translators: accessibility text. 1: The block title. 2: The block row number. */
    (0,external_gc_i18n_namespaceObject.__)('%1$s 区块。 行 %2$d'), title, position);
  } else if (hasPosition && direction === 'horizontal') {
    if (hasLabel) {
      return (0,external_gc_i18n_namespaceObject.sprintf)(
      /* translators: accessibility text. 1: The block title. 2: The block column number. 3: The block label.. */
      (0,external_gc_i18n_namespaceObject.__)('%1$s区块，第%2$d栏。%3$s'), title, position, label);
    }

    return (0,external_gc_i18n_namespaceObject.sprintf)(
    /* translators: accessibility text. 1: The block title. 2: The block column number. */
    (0,external_gc_i18n_namespaceObject.__)('%1$s区块。第%2$d栏'), title, position);
  }

  if (hasLabel) {
    return (0,external_gc_i18n_namespaceObject.sprintf)(
    /* translators: accessibility text. %1: The block title. %2: The block label. */
    (0,external_gc_i18n_namespaceObject.__)('%1$s区块。%2$s'), title, label);
  }

  return (0,external_gc_i18n_namespaceObject.sprintf)(
  /* translators: accessibility text. %s: The block title. */
  (0,external_gc_i18n_namespaceObject.__)('%s区块'), title);
}
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/store/reducer.js
/**
 * GeChiUI dependencies
 */
...
const DEFAULT_CATEGORIES = [{
  ...
  slug: 'widgets',
  title: (0,external_gc_i18n_namespaceObject.__)('小工具')
}, {
  slug: 'theme',
  title: (0,external_gc_i18n_namespaceObject.__)('主题')
}, {
  slug: 'embed',
  title: (0,external_gc_i18n_namespaceObject.__)('嵌入')
}, {
  slug: 'reusable',
  title: (0,external_gc_i18n_namespaceObject.__)('可重用区块')
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/store/utils.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/store/selectors.js
/**
 * External dependencies
 */
 ...
 * import { __ } from '@gechiui/i18n';
 * import { store as blocksStore } from '@gechiui/blocks';
 * import { store as blockEditorStore } from '@gechiui/block-editor';
 * import { useSelect } from '@gechiui/data';
 *
 * const ExampleComponent = () => {
 ...
 *         defaultBlockName && (
 *             <p>
 *                 { sprintf( __( '默认块名称：%s' ), defaultBlockName ) }
 *             </p>
 *         )
 *     );
 * };
...
function isMatchingSearchTerm(state, nameOrType, searchTerm) {
  const blockType = getNormalizedBlockType(state, nameOrType);
  const getNormalizedSearchTerm = (0,external_gc_compose_namespaceObject.pipe)([// Disregard diacritics.
  //  Input: "média"
  ...
  const isSearchMatch = (0,external_gc_compose_namespaceObject.pipe)([getNormalizedSearchTerm, normalizedCandidate => normalizedCandidate.includes(normalizedSearchTerm)]);
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/store/private-selectors.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/store/actions.js
/**
 * External dependencies
 */
...
/** @typedef {import('../api/registration').GCBlockType} GCBlockType */
 ...
 *
 * @return {GCBlockType | undefined} The block, if it has been successfully registered; otherwise `undefined`.
 */
...
const processBlockType = (blockType, {
  ...
  const settings = (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.registerBlockType', { ...blockType
  }, name, null);

  if (settings.description && typeof settings.description !== 'string') {
    external_gc_deprecated_default()('Declaring non-string block descriptions', {
      since: '6.2'
    });
  }
  ...
  if (settings.deprecated) {
    ...
    (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.registerBlockType', // Merge deprecation keys with pre-filter settings
 ...
 * Ignored from documentation as the recommended usage for this action through registerBlockType from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {GCBlockType|GCBlockType[]} blockTypes Object or array of objects representing blocks to added.
 *
 *
 ...
 * Ignored from documentation as the recommended usage for this action through unregisterBlockType from @gechiui/blocks.
 *
 * @ignore
 *
 ...
 * Ignored from documentation as the recommended usage for this action through registerBlockStyle from @gechiui/blocks.
 *
 * @param {string}       blockName Block name.
 ...
 * Ignored from documentation as the recommended usage for this action through unregisterBlockStyle from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {string}       blockName  Block name.
 ...
 * Ignored from documentation as the recommended usage for this action through registerBlockVariation from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {string}                              blockName  Block name.
 ...
 * Ignored from documentation as the recommended usage for this action through unregisterBlockVariation from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {string}          blockName      Block name.
 ...
 * Ignored from documentation as the recommended usage for this action through setDefaultBlockName from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {string} name Block name.
 ...
 * Ignored from documentation as the recommended usage for this action through setFreeformContentHandlerName from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {string} name Block name.
 ...
 * Ignored from documentation as the recommended usage for this action through setUnregisteredTypeHandlerName from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {string} name Block name.
 ...
 * Ignored from documentation as the recommended usage for this action through setGroupingBlockName from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {string} name Block name.
 ...
 * Ignored from documentation as the recommended usage for this action through setCategories from @gechiui/blocks.
 *
 * @ignore
 *
 ...
 * Ignored from documentation as the recommended usage for this action through updateCategory from @gechiui/blocks.
 *
 * @ignore
 *
 ...
 * Ignored from documentation as the recommended usage for this action through registerBlockCollection from @gechiui/blocks.
 *
 * @ignore
 *
 ...
 * Ignored from documentation as the recommended usage for this action through unregisterBlockCollection from @gechiui/blocks.
 *
 * @ignore
 *
 * @param {string} namespace The namespace of the blocks to put in the collection
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/store/constants.js
const STORE_NAME = 'core/blocks';

;// CONCATENATED MODULE: external ["gc","privateApis"]
var external_gc_privateApis_namespaceObject = window["gc"]["privateApis"];
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/lock-unlock.js
/**
 * GeChiUI dependencies
 */
...
const {
  lock,
  unlock
} = (0,external_gc_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next GeChiUI release.', '@gechiui/blocks');

;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/store/index.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: external ["gc","blockSerializationDefaultParser"]
var external_gc_blockSerializationDefaultParser_namespaceObject = window["gc"]["blockSerializationDefaultParser"];
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/parser/serialize-raw-block.js
/**
 * Internal dependencies
 */
...
/** @typedef {import("./").GCRawBlock} GCRawBlock */
 ...
 *
 * @param {GCRawBlock} rawBlock     A block node as returned by a valid parser.
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/serializer.js
...
/** @typedef {import('./parser').GCBlock} GCBlock */
...
function getBlockDefaultClassName(blockName) {
  ...
  return (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.getBlockDefaultClassName', className, blockName);
}
/**
...
function getBlockMenuDefaultClassName(blockName) {
  ...
  return (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.getBlockMenuDefaultClassName', className, blockName);
}
...
function getBlockProps(props = {}) {
  ...
  return getBlockProps.skipFilters ? props : (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.getSaveContent.extraProps', { ...props
...
function getInnerBlocksProps(props = {}) {
  ...
  const children = (0,external_gc_element_namespaceObject.createElement)(external_gc_element_namespaceObject.RawHTML, null, html);
  return { ...props,
    children
  };
}
...
function getSaveElement(blockTypeOrName, attributes, innerBlocks = []) {
  ...
  if (save.prototype instanceof external_gc_element_namespaceObject.Component) {
  ...
  if (element !== null && typeof element === 'object' && (0,external_gc_hooks_namespaceObject.hasFilter)('blocks.getSaveContent.extraProps') && !(blockType.apiVersion > 1)) {
    /**
     ...
     * @param {Object}  attributes Block attributes.
     */
    const props = (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.getSaveContent.extraProps', { ...element.props
    }, blockType, attributes);

    if (!external_gc_isShallowEqual_default()(props, element.props)) {
      element = (0,external_gc_element_namespaceObject.cloneElement)(element, props);
    }
  }
  /**
  ...
  return (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.getSaveElement', element, blockType, attributes);
}
/**
 * Given a block type containing a save render implementation and attributes, returns the
...
function getSaveContent(blockTypeOrName, attributes, innerBlocks) {
  const blockType = normalizeBlockType(blockTypeOrName);
  return (0,external_gc_element_namespaceObject.renderToString)(getSaveElement(blockType, attributes, innerBlocks));
}
/**
...
function getCommentDelimitedContent(rawBlockName, attributes, content) {
  ...
  const blockName = rawBlockName?.startsWith('core/') ? rawBlockName.slice(5) : rawBlockName; // @todo make the `gc:` prefix potentially configurable.
 ...
 *
 * @param {GCBlock}                     block   Block instance.
...
function __unstableSerializeAndClean(blocks) {
  ...
  if (blocks.length === 1 && blocks[0].name === getFreeformContentHandlerName() && blocks[0].name === 'core/freeform') {
    content = (0,external_gc_autop_namespaceObject.removep)(content);
  }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/validation/logger.js
/**
 * @typedef LoggerItem
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/validation/index.js
/**
 * External dependencies
 */
...
/** @typedef {import('../registration').GCBlockType} GCBlockType */
...
class DecodeEntityParser {
  ...
  parse(entity) {
    if (isValidCharacterReference(entity)) {
      return (0,external_gc_htmlEntities_namespaceObject.decodeEntities)('&' + entity + ';');
    }
  }
 ...
 *
 * @param {GCBlock}            block                          block object.
 * @param {GCBlockType|string} [blockTypeOrName = block.name] Block type or name, inferred from block if not given.
 *
...
function isValidBlockContent(blockTypeOrName, attributes, originalBlockContent) {
  external_gc_deprecated_default()('isValidBlockContent introduces opportunity for data loss', {
    since: '12.6',
    plugin: 'Gutenberg',
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/parser/convert-legacy-block.js
/**
...
function convertLegacyBlockNameAndAttributes(name, attributes) {
  ...
  if (name === 'core/comments-query-loop') {
    ...
    if (!className.includes('gc-block-comments-query-loop')) {
      newAttributes.className = ['gc-block-comments-query-loop', className].join(' ');
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/matchers.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/node.js
/**
 * GeChiUI dependencies
 */
...
function isNodeOfType(node, type) {
  external_gc_deprecated_default()('gc.blocks.node.isNodeOfType', {
    since: '6.1',
    version: '6.3',
    link: 'https://developer.gechiui.com/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/'
  });
...
function fromDOM(domNode) {
  external_gc_deprecated_default()('gc.blocks.node.fromDOM', {
    since: '6.1',
    version: '6.3',
    alternative: 'gc.richText.create',
    link: 'https://developer.gechiui.com/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/'
  });
...
function toHTML(node) {
  external_gc_deprecated_default()('gc.blocks.node.toHTML', {
    since: '6.1',
    version: '6.3',
    alternative: 'gc.richText.toHTMLString',
    link: 'https://developer.gechiui.com/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/'
  });
...
function node_matcher(selector) {
  external_gc_deprecated_default()('gc.blocks.node.matcher', {
    since: '6.1',
    version: '6.3',
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/children.js
/**
 * GeChiUI dependencies
 */
...
function getChildrenArray(children) {
  external_gc_deprecated_default()('gc.blocks.children.getChildrenArray', {
    since: '6.1',
    version: '6.3',
    link: 'https://developer.gechiui.com/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/'
...
function concat(...blockNodes) {
  external_gc_deprecated_default()('gc.blocks.children.concat', {
    since: '6.1',
    version: '6.3',
    alternative: 'gc.richText.concat',
    link: 'https://developer.gechiui.com/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/'
  });
  const result = [];
...
function children_fromDOM(domNodes) {
  external_gc_deprecated_default()('gc.blocks.children.fromDOM', {
    since: '6.1',
    version: '6.3',
    alternative: 'gc.richText.create',
    link: 'https://developer.gechiui.com/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/'
...
function children_toHTML(children) {
  external_gc_deprecated_default()('gc.blocks.children.toHTML', {
    since: '6.1',
    version: '6.3',
    alternative: 'gc.richText.toHTMLString',
    link: 'https://developer.gechiui.com/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/'
  ...
  return (0,external_gc_element_namespaceObject.renderToString)(element);
}
/**
...
function children_matcher(selector) {
  external_gc_deprecated_default()('gc.blocks.children.matcher', {
    since: '6.1',
    version: '6.3',
    alternative: 'html source',
    link: 'https://developer.gechiui.com/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/'
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/parser/get-block-attributes.js
/**
 * External dependencies
 */
...
const toBooleanAttributeMatcher = matcher => (0,external_gc_compose_namespaceObject.pipe)([matcher, // Expected values from `attr( 'disabled' )`:
//
// <input>
// - Value:       `undefined`
// - Transformed: `false`
...
const matcherFromSource = memize(sourceConfig => {
  switch (sourceConfig.source) {
    ...
    case 'tag':
      return (0,external_gc_compose_namespaceObject.pipe)([prop(sourceConfig.selector, 'nodeName'), nodeName => nodeName ? nodeName.toLowerCase() : undefined]);
...
function getBlockAttributes(blockTypeOrName, innerHTML, attributes = {}) {
  ...
  return (0,external_gc_hooks_namespaceObject.applyFilters)('blocks.getBlockAttributes', blockAttributes, blockType, innerHTML, attributes);
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/parser/fix-custom-classname.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/parser/apply-built-in-validation-fixes.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/parser/apply-block-deprecated-versions.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/parser/index.js
/**
 * GeChiUI dependencies
 */
 ...
 * @property {GCRawBlock} [__unstableBlockSource] Un-processed original copy of block if created through parser.
 */
...
function normalizeRawBlock(rawBlock, options) {
  ...
  if (rawBlockName === fallbackBlockName && rawBlockName === 'core/freeform' && !options?.__unstableSkipAutop) {
    rawInnerHTML = (0,external_gc_autop_namespaceObject.autop)(rawInnerHTML).trim();
  }
 ...
 *
 * @param {GCBlock}                               unvalidatedBlock
 * @param {import('../registration').GCBlockType} blockType
 * @return {GCBlock}                              validated block, with auto-fixes if initially invalid
 */
 ...
 * @param {ParseOptions} options  Extra options for handling block parsing.
 *
 * @return {GCBlock | undefined} Fully parsed block.
 */
...
function parseRawBlock(rawBlock, options) {
  ...
  const parsedInnerBlocks = normalizedBlock.innerBlocks.map(innerBlock => parseRawBlock(innerBlock, options)) // See https://github.com/GeChiUI/gutenberg/pull/17164.
...
function parser_parse(content, options) {
  return (0,external_gc_blockSerializationDefaultParser_namespaceObject.parse)(content).reduce((accumulator, rawBlock) => {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/get-raw-transforms.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/html-to-blocks.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/normalise-blocks.js
/**
 * GeChiUI dependencies
 */
...
function normaliseBlocks(HTML) {
  ...
  while (decu.firstChild) {
    ...
    if (node.nodeType === node.TEXT_NODE) {
      if ((0,external_gc_dom_namespaceObject.isEmpty)(node)) {
      ...
      } else if ((0,external_gc_dom_namespaceObject.isPhrasingContent)(node)) {
        if (!accu.lastChild || accu.lastChild.nodeName !== 'P') {
          accu.appendChild(accuDoc.createElement('P'));
        }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/special-comment-converter.js
/**
 * GeChiUI dependencies
 */
...
function specialCommentConverter(node, doc) {
  ...
  if (node.nodeValue === 'nextpage') {
    (0,external_gc_dom_namespaceObject.replace)(node, createNextpage(doc));
    return;
  }
...
function moreCommentConverter(node, doc) {
  ...
  while (sibling = sibling.nextSibling) {
    if (sibling.nodeType === sibling.COMMENT_NODE && sibling.nodeValue === 'noteaser') {
      noTeaser = true;
      (0,external_gc_dom_namespaceObject.remove)(sibling);
      break;
    }
  }
  ...
  if (!node.parentNode || node.parentNode.nodeName !== 'P' || node.parentNode.childNodes.length === 1) {
    (0,external_gc_dom_namespaceObject.replace)(node, moreBlock);
  } else {
    ...
    (0,external_gc_dom_namespaceObject.remove)(node.parentNode);
  }
}
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/list-reducer.js
/**
 * GeChiUI dependencies
 */
...
function listReducer(node) {
  ...
  if (parentElement && isList(parentElement)) {
    ...
    if (prevListItem) {
      ...
      (0,external_gc_dom_namespaceObject.unwrap)(node);
    }
  }
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/blockquote-normaliser.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/figure-content-reducer.js
/**
 * GeChiUI dependencies
 */
...
function isFigureContent(node, schema) {
  ...
  if (tag === 'figcaption' || (0,external_gc_dom_namespaceObject.isTextContent)(node)) {
    return false;
  }
...
;// CONCATENATED MODULE: external ["gc","shortcode"]
var external_gc_shortcode_namespaceObject = window["gc"]["shortcode"];
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/shortcode-converter.js
/**
 * GeChiUI dependencies
 */
...
function segmentHTMLToShortcodeBlock(HTML, lastIndex = 0, excludedBlockNames = []) {
  ...
  const transformation = findTransform(transformsFrom, transform => excludedBlockNames.indexOf(transform.blockName) === -1 && transform.type === 'shortcode' && castArray(transform.tag).some(tag => (0,external_gc_shortcode_namespaceObject.regexp)(tag).test(HTML)));
  ...
  const transformTag = transformTags.find(tag => (0,external_gc_shortcode_namespaceObject.regexp)(tag).test(HTML));
  let match;
  const previousIndex = lastIndex;

  if (match = (0,external_gc_shortcode_namespaceObject.next)(transformTag, HTML, lastIndex)) {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/utils.js
/**
 * External dependencies
 */
...
function getBlockContentSchemaFromTransforms(transforms, context) {
  const phrasingContentSchema = (0,external_gc_dom_namespaceObject.getPhrasingContentSchema)(context);
  const schemaArgs = {
...
function getSibling(node, which) {
  ...
  if (sibling && (0,external_gc_dom_namespaceObject.isPhrasingContent)(sibling)) {
    return sibling;
  }
  ...
  if (!parentNode || !(0,external_gc_dom_namespaceObject.isPhrasingContent)(parentNode)) {
    return;
  }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/index.js
/**
 * GeChiUI dependencies
 */
...
function deprecatedGetPhrasingContentSchema(context) {
  external_gc_deprecated_default()('gc.blocks.getPhrasingContentSchema', {
    since: '5.6',
    alternative: 'gc.dom.getPhrasingContentSchema'
  });
  return (0,external_gc_dom_namespaceObject.getPhrasingContentSchema)(context);
}
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/comment-remover.js
/**
 * GeChiUI dependencies
 */
...
function commentRemover(node) {
  if (node.nodeType === node.COMMENT_NODE) {
    (0,external_gc_dom_namespaceObject.remove)(node);
  }
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/is-inline-content.js
/**
 * GeChiUI dependencies
 */
...
function isInline(node, contextTag) {
  if ((0,external_gc_dom_namespaceObject.isTextContent)(node)) {
    return true;
  }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/phrasing-content-reducer.js
/**
 * GeChiUI dependencies
 */
...
function phrasingContentReducer(node, doc) {
  ...
  if (node.nodeName === 'SPAN' && node.style) {
    ...
    if (fontWeight === 'bold' || fontWeight === '700') {
      (0,external_gc_dom_namespaceObject.wrap)(doc.createElement('strong'), node);
    }

    if (fontStyle === 'italic') {
      (0,external_gc_dom_namespaceObject.wrap)(doc.createElement('em'), node);
    ...
    if (textDecorationLine === 'line-through' || textDecoration.includes('line-through')) {
      (0,external_gc_dom_namespaceObject.wrap)(doc.createElement('s'), node);
    }

    if (verticalAlign === 'super') {
      (0,external_gc_dom_namespaceObject.wrap)(doc.createElement('sup'), node);
    } else if (verticalAlign === 'sub') {
      (0,external_gc_dom_namespaceObject.wrap)(doc.createElement('sub'), node);
    }
  } else if (node.nodeName === 'B') {
    node = (0,external_gc_dom_namespaceObject.replaceTag)(node, 'strong');
  } else if (node.nodeName === 'I') {
    node = (0,external_gc_dom_namespaceObject.replaceTag)(node, 'em');
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/head-remover.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/ms-list-converter.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/image-corrector.js
/**
 * GeChiUI dependencies
 */
...
function imageCorrector(node) {
  ...
  if (node.src.indexOf('data:') === 0) {
    ...
    node.src = (0,external_gc_blob_namespaceObject.createBlobURL)(file);
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/div-normaliser.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/markdown-converter.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/iframe-remover.js
/**
 * Removes iframes.
 *
 * @param {Node} node The node to check.
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/google-docs-uid-remover.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/html-formatting-remover.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/br-remover.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/empty-paragraph-remover.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/slack-paragraph-corrector.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/raw-handling/paste-handler.js
/**
 * GeChiUI dependencies
 */
...
function filterInlineHTML(HTML, preserveWhiteSpace) {
  ...
  HTML = (0,external_gc_dom_namespaceObject.removeInvalidHTML)(HTML, (0,external_gc_dom_namespaceObject.getPhrasingContentSchema)('paste'), {
    inline: true
  });
...
function pasteHandler({
  ...
  const phrasingContentSchema = (0,external_gc_dom_namespaceObject.getPhrasingContentSchema)('paste');
  ...
  const blocks = pieces.map(piece => {
    ...
    piece = deepFilterHTML(piece, filters, blockContentSchema);
    piece = (0,external_gc_dom_namespaceObject.removeInvalidHTML)(piece, schema);
    piece = normaliseBlocks(piece);
  ...
  if (mode === 'AUTO' && blocks.length === 1 && hasBlockSupport(blocks[0].name, '__unstablePasteTextInline', false)) {
    ...
    if (trimmedPlainText !== '' && trimmedPlainText.indexOf('\n') === -1) {
      return (0,external_gc_dom_namespaceObject.removeInvalidHTML)(getBlockInnerHTML(blocks[0]), phrasingContentSchema).replace(trimRegex, '');
    }
  }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/categories.js
/**
 * GeChiUI dependencies
 */
...
function categories_getCategories() {
  return (0,external_gc_data_namespaceObject.select)(store).getCategories();
}
/**
 ...
 * ```js
 * import { __ } from '@gechiui/i18n';
 * import { store as blocksStore, setCategories } from '@gechiui/blocks';
 * import { useSelect } from '@gechiui/data';
 * import { Button } from '@gechiui/components';
 *
 * const ExampleComponent = () => {
...
function categories_setCategories(categories) {
  (0,external_gc_data_namespaceObject.dispatch)(store).setCategories(categories);
}
/**
 * Updates a category.
 *
 ...
 * ```js
 * import { __ } from '@gechiui/i18n';
 * import { updateCategory } from '@gechiui/blocks';
 * import { Button } from '@gechiui/components';
 *
 * const ExampleComponent = () => {
 *     return (
 *         <Button
 *             onClick={ () => {
 *                 updateCategory( 'text', { title: __( '书面语言' ) } );
 *             } }
 *         >
...
function categories_updateCategory(slug, category) {
  (0,external_gc_data_namespaceObject.dispatch)(store).updateCategory(slug, category);
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/templates.js
/**
 * GeChiUI dependencies
 */
  ...
  return template.map(([name, attributes, innerBlocksTemplate], index) => {
    ...
    const normalizeAttribute = (definition, value) => {
      if (isHTMLAttribute(definition) && Array.isArray(value)) {
        ...
        return (0,external_gc_element_namespaceObject.renderToString)(value);
      }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/api/index.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/deprecated.js
/**
 * GeChiUI dependencies
 */
 ...
 * @deprecated
 *
 * @param {GCComponent} OriginalComponent The component to enhance.
 * @return {GCComponent} The same component.
 */

function withBlockContentContext(OriginalComponent) {
  external_gc_deprecated_default()('gc.blocks.withBlockContentContext', {
    since: '6.1'
  });
  return OriginalComponent;
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/index.js
...
(window.gc = window.gc || {}).blocks = __webpack_exports__;
/******/ })()
;