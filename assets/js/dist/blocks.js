...
/******/ 	return __webpack_require__(__webpack_require__.s = "5odb");
/******/ })
/************************************************************************/
/******/ ({
...
const DEFAULT_CATEGORIES = [{
  ...
  slug: 'media',
  title: Object(external_gc_i18n_["__"])('媒体')
}, {
  slug: 'design',
  title: Object(external_gc_i18n_["__"])('设计')
}, {
  slug: 'widgets',
  title: Object(external_gc_i18n_["__"])('小工具')
}, {
  slug: 'theme',
  title: Object(external_gc_i18n_["__"])('主题')
}, {
  slug: 'embed',
  title: Object(external_gc_i18n_["__"])('嵌入')
}, {
  slug: 'reusable',
  title: Object(external_gc_i18n_["__"])('可重用区块')
}];
/**
...
function registerBlockType(blockNameOrMetadata, settings) {
  ...
  if (!/^[a-z][a-z0-9-]*\/[a-z][a-z0-9-]*$/.test(name)) {
    console.error('区块名称必须包含命名空间前缀，仅包括小写字母数字字符或破折号，并以字母开头。示例：my-plugin/my-custom-block');
    return;
  }

  if (Object(external_gc_data_["select"])(store).getBlockType(name)) {
  ...
  Object(external_gc_data_["dispatch"])(store).__experimentalRegisterBlockType(blockType);

  return Object(external_gc_data_["select"])(store).getBlockType(name);
}
/**
...
function translateBlockSettingUsingI18nSchema(i18nSchema, settingValue, textdomain) {
  if (Object(external_lodash_["isString"])(i18nSchema) && Object(external_lodash_["isString"])(settingValue)) {
    ...
    return Object(external_gc_i18n_["_x"])(settingValue, i18nSchema, textdomain);
  }
...
function registerBlockCollection(namespace, _ref2) {
  ...
  Object(external_gc_data_["dispatch"])(store).addBlockCollection(namespace, title, icon);
}
/**
...
function unregisterBlockCollection(namespace) {
  Object(external_gc_data_["dispatch"])(store).removeBlockCollection(namespace);
}
/**
 * Unregisters a block.
 *
...
function unregisterBlockType(name) {
  const oldBlock = Object(external_gc_data_["select"])(store).getBlockType(name);
  ...
  Object(external_gc_data_["dispatch"])(store).removeBlockTypes(name);
  return oldBlock;
}
/**
...
function setFreeformContentHandlerName(blockName) {
  Object(external_gc_data_["dispatch"])(store).setFreeformFallbackBlockName(blockName);
}
/**
...
function getFreeformContentHandlerName() {
  return Object(external_gc_data_["select"])(store).getFreeformFallbackBlockName();
}
/**
...
function registration_getGroupingBlockName() {
  return Object(external_gc_data_["select"])(store).getGroupingBlockName();
}
/**
...
function setUnregisteredTypeHandlerName(blockName) {
  Object(external_gc_data_["dispatch"])(store).setUnregisteredFallbackBlockName(blockName);
}
/**
...
function getUnregisteredTypeHandlerName() {
  return Object(external_gc_data_["select"])(store).getUnregisteredFallbackBlockName();
}
/**
...
function setDefaultBlockName(name) {
  Object(external_gc_data_["dispatch"])(store).setDefaultBlockName(name);
}
/**
...
function setGroupingBlockName(name) {
  Object(external_gc_data_["dispatch"])(store).setGroupingBlockName(name);
}
/**
...
function registration_getDefaultBlockName() {
  return Object(external_gc_data_["select"])(store).getDefaultBlockName();
}
/**
...
function registration_getBlockType(name) {
  ...
  return (_select = Object(external_gc_data_["select"])(store)) === null || _select === void 0 ? void 0 : _select.getBlockType(name);
}
/**
...
function registration_getBlockTypes() {
  return Object(external_gc_data_["select"])(store).getBlockTypes();
}
/**
 * Returns the block support value for a feature, if defined.
 *
...
function registration_getBlockSupport(nameOrType, feature, defaultSupports) {
  return Object(external_gc_data_["select"])(store).getBlockSupport(nameOrType, feature, defaultSupports);
}
/**
 * Returns true if the block defines support for a feature, or false otherwise.
 *
...
function registration_hasBlockSupport(nameOrType, feature, defaultSupports) {
  return Object(external_gc_data_["select"])(store).hasBlockSupport(nameOrType, feature, defaultSupports);
}
/**
...
const registration_getChildBlockNames = blockName => {
  return Object(external_gc_data_["select"])(store).getChildBlockNames(blockName);
};
/**
 * Returns a boolean indicating if a block has child blocks or not.
 *
...
const registration_hasChildBlocks = blockName => {
  return Object(external_gc_data_["select"])(store).hasChildBlocks(blockName);
};
/**
 * Returns a boolean indicating if a block has at least one child block with inserter support.
 *
...
const registration_hasChildBlocksWithInserterSupport = blockName => {
  return Object(external_gc_data_["select"])(store).hasChildBlocksWithInserterSupport(blockName);
};
/**
...
const registerBlockStyle = (blockName, styleVariation) => {
  Object(external_gc_data_["dispatch"])(store).addBlockStyles(blockName, styleVariation);
};
/**
...
const unregisterBlockStyle = (blockName, styleVariationName) => {
  Object(external_gc_data_["dispatch"])(store).removeBlockStyles(blockName, styleVariationName);
};
/**
...
const registration_getBlockVariations = (blockName, scope) => {
  return Object(external_gc_data_["select"])(store).getBlockVariations(blockName, scope);
};
/**
...
const registerBlockVariation = (blockName, variation) => {
  Object(external_gc_data_["dispatch"])(store).addBlockVariations(blockName, variation);
};
/**
...
const unregisterBlockVariation = (blockName, variationName) => {
  Object(external_gc_data_["dispatch"])(store).removeBlockVariations(blockName, variationName);
};
...
function findTransform(transforms, predicate) {
  ...
  const hooks = Object(external_gc_hooks_["createHooks"])();
...
function switchToBlockType(blocks, name) {
  ...
  const ret = transformationResults.map((result, index, results) => {
     ...
     */
    return Object(external_gc_hooks_["applyFilters"])('blocks.switchToBlockType.transformedBlock', result, blocks, index, results);
  });
  return ret;
}
/**
...
function isValidIcon(icon) {
  return !!icon && (Object(external_lodash_["isString"])(icon) || Object(external_gc_element_["isValidElement"])(icon) || Object(external_lodash_["isFunction"])(icon) || icon instanceof external_gc_element_["Component"]);
}
/**
...
function getBlockLabel(blockType, attributes) {
  ...
  return Object(external_gc_dom_["__unstableStripHTML"])(label);
}
/**
...
function getAccessibleBlockLabel(blockType, attributes, position) {
  ...
  if (hasPosition && direction === 'vertical') {
    if (hasLabel) {
      ...
      Object(external_gc_i18n_["__"])('%1$s区块，第%2$d行。%3$s'), title, position, label);
    }

    return Object(external_gc_i18n_["sprintf"])(
    /* translators: accessibility text. 1: The block title. 2: The block row number. */
    Object(external_gc_i18n_["__"])('%1$s 区块。 行 %2$d'), title, position);
  } else if (hasPosition && direction === 'horizontal') {
    if (hasLabel) {
      return Object(external_gc_i18n_["sprintf"])(
      /* translators: accessibility text. 1: The block title. 2: The block column number. 3: The block label.. */
      Object(external_gc_i18n_["__"])('%1$s区块，第%2$d栏。%3$s'), title, position, label);
    }

    return Object(external_gc_i18n_["sprintf"])(
    /* translators: accessibility text. 1: The block title. 2: The block column number. */
    Object(external_gc_i18n_["__"])('%1$s区块。第%2$d栏'), title, position);
  }

  if (hasLabel) {
    return Object(external_gc_i18n_["sprintf"])(
    /* translators: accessibility text. %1: The block title. %2: The block label. */
    Object(external_gc_i18n_["__"])('%1$s区块。%2$s'), title, label);
  }

  return Object(external_gc_i18n_["sprintf"])(
  /* translators: accessibility text. %s: The block title. */
  Object(external_gc_i18n_["__"])('%s区块'), title);
}
/**
...
const processBlockType = (blockType, _ref) => {
  ...
  const settings = Object(external_gc_hooks_["applyFilters"])('blocks.registerBlockType', { ...blockType
  }, name);
  ...
  if (settings.deprecated) {
    ...
    Object(external_gc_hooks_["applyFilters"])('blocks.registerBlockType', // Merge deprecation keys with pre-filter settings
  ...
  if ('category' in settings && !Object(external_lodash_["some"])(select.getCategories(), {
  ...
  if (!isValidIcon(settings.icon.src)) {
    error('传递的icon无效。' + 'icon应为字符串、元素、函数或符合中所述规范的对象 https://developer.gechiui.com/block-editor/developers/block-api/block-registration/#icon-optional');
    return;
  }
...
// EXTERNAL MODULE: external ["gc","blockSerializationDefaultParser"]
var external_gc_blockSerializationDefaultParser_ = __webpack_require__("QVNP");
...
function getBlockDefaultClassName(blockName) {
  ...
  return Object(external_gc_hooks_["applyFilters"])('blocks.getBlockDefaultClassName', className, blockName);
}
/**
...
function getBlockMenuDefaultClassName(blockName) {
  ...
  return Object(external_gc_hooks_["applyFilters"])('blocks.getBlockMenuDefaultClassName', className, blockName);
}
...
function getBlockProps() {
  ...
  return Object(external_gc_hooks_["applyFilters"])('blocks.getSaveContent.extraProps', { ...props
...
function getInnerBlocksProps() {
  ...
  const children = Object(external_gc_element_["createElement"])(external_gc_element_["RawHTML"], null, html);
  return { ...props,
    children
  };
}
...
function getSaveElement(blockTypeOrName, attributes) {
  ...
  if (save.prototype instanceof external_gc_element_["Component"]) {
  ...
  if (Object(external_lodash_["isObject"])(element) && Object(external_gc_hooks_["hasFilter"])('blocks.getSaveContent.extraProps') && !(blockType.apiVersion > 1)) {
    /**
     ...
     * @param {Object}  attributes Block attributes.
     */
    const props = Object(external_gc_hooks_["applyFilters"])('blocks.getSaveContent.extraProps', { ...element.props
    }, blockType, attributes);

    if (!external_gc_isShallowEqual_default()(props, element.props)) {
      element = Object(external_gc_element_["cloneElement"])(element, props);
    }
  }
  /**
  ...
  return Object(external_gc_hooks_["applyFilters"])('blocks.getSaveElement', element, blockType, attributes);
}
/**
 * Given a block type containing a save render implementation and attributes, returns the
...
function getSaveContent(blockTypeOrName, attributes, innerBlocks) {
  const blockType = normalizeBlockType(blockTypeOrName);
  return Object(external_gc_element_["renderToString"])(getSaveElement(blockType, attributes, innerBlocks));
}
/**
...
function getCommentDelimitedContent(rawBlockName, attributes, content) {
  ...
  const blockName = Object(external_lodash_["startsWith"])(rawBlockName, 'core/') ? rawBlockName.slice(5) : rawBlockName; // @todo make the `gc:` prefix potentially configurable.
...
function __unstableSerializeAndClean(blocks) {
  ...
  if (blocks.length === 1 && blocks[0].name === getFreeformContentHandlerName()) {
    content = Object(external_gc_autop_["removep"])(content);
  }
...
class validation_DecodeEntityParser {
  ...
  parse(entity) {
    if (isValidCharacterReference(entity)) {
      return Object(external_gc_htmlEntities_["decodeEntities"])('&' + entity + ';');
    }
  }
...
function children_toHTML(children) {
  ...
  return Object(external_gc_element_["renderToString"])(element);
}
/**
...
function getBlockAttributes(blockTypeOrName, innerHTML) {
  ...
  return Object(external_gc_hooks_["applyFilters"])('blocks.getBlockAttributes', blockAttributes, blockType, innerHTML, attributes);
}
...
function normalizeRawBlock(rawBlock) {
  ...
  if (rawBlockName === fallbackBlockName) {
    rawInnerHTML = Object(external_gc_autop_["autop"])(rawInnerHTML).trim();
  }
...
function parser_parse(content) {
  return Object(external_gc_blockSerializationDefaultParser_["parse"])(content).reduce((accumulator, rawBlock) => {
...
function normaliseBlocks(HTML) {
  ...
  while (decu.firstChild) {
    ...
    if (node.nodeType === node.TEXT_NODE) {
      if (Object(external_gc_dom_["isEmpty"])(node)) {
      ...
      } else if (Object(external_gc_dom_["isPhrasingContent"])(node)) {
        if (!accu.lastChild || accu.lastChild.nodeName !== 'P') {
          accu.appendChild(accuDoc.createElement('P'));
        }
...
function specialCommentConverter(node, doc) {
  ...
  if (node.nodeValue === 'nextpage') {
    Object(external_gc_dom_["replace"])(node, createNextpage(doc));
    return;
  }
  ...
  if (node.nodeValue.indexOf('more') === 0) {
    ...
    while (sibling = sibling.nextSibling) {
      if (sibling.nodeType === sibling.COMMENT_NODE && sibling.nodeValue === 'noteaser') {
        noTeaser = true;
        Object(external_gc_dom_["remove"])(sibling);
        break;
      }
    }

    Object(external_gc_dom_["replace"])(node, createMore(customText, noTeaser, doc));
  }
}
...
function commentRemover(node) {
  if (node.nodeType === node.COMMENT_NODE) {
    Object(external_gc_dom_["remove"])(node);
  }
}
...
function isInline(node, contextTag) {
  if (Object(external_gc_dom_["isTextContent"])(node)) {
    return true;
  }
...
function phrasingContentReducer(node, doc) {
  ...
  if (node.nodeName === 'SPAN' && node.style) {
    ...
    if (fontWeight === 'bold' || fontWeight === '700') {
      Object(external_gc_dom_["wrap"])(doc.createElement('strong'), node);
    }

    if (fontStyle === 'italic') {
      Object(external_gc_dom_["wrap"])(doc.createElement('em'), node);
    ...
    if (textDecorationLine === 'line-through' || Object(external_lodash_["includes"])(textDecoration, 'line-through')) {
      Object(external_gc_dom_["wrap"])(doc.createElement('s'), node);
    }

    if (verticalAlign === 'super') {
      Object(external_gc_dom_["wrap"])(doc.createElement('sup'), node);
    } else if (verticalAlign === 'sub') {
      Object(external_gc_dom_["wrap"])(doc.createElement('sub'), node);
    }
  } else if (node.nodeName === 'B') {
    node = Object(external_gc_dom_["replaceTag"])(node, 'strong');
  } else if (node.nodeName === 'I') {
    node = Object(external_gc_dom_["replaceTag"])(node, 'em');
...
function listReducer(node) {
  ...
  if (parentElement && list_reducer_isList(parentElement)) {
    ...
    if (prevListItem) {
      ...
      Object(external_gc_dom_["unwrap"])(node);
    }
  }
}
...
function imageCorrector(node) {
  ...
  if (node.src.indexOf('data:') === 0) {
    ...
    node.src = Object(external_gc_blob_["createBlobURL"])(file);
...
function isFigureContent(node, schema) {
  ...
  if (tag === 'figcaption' || Object(external_gc_dom_["isTextContent"])(node)) {
    return false;
  }
...
// EXTERNAL MODULE: external ["gc","shortcode"]
var external_gc_shortcode_ = __webpack_require__("MZR4");
...
function segmentHTMLToShortcodeBlock(HTML) {
  ...
  const transformation = findTransform(transformsFrom, transform => excludedBlockNames.indexOf(transform.blockName) === -1 && transform.type === 'shortcode' && Object(external_lodash_["some"])(Object(external_lodash_["castArray"])(transform.tag), tag => Object(external_gc_shortcode_["regexp"])(tag).test(HTML)));
  ...
  const transformTag = Object(external_lodash_["find"])(transformTags, tag => Object(external_gc_shortcode_["regexp"])(tag).test(HTML));
  let match;
  const previousIndex = lastIndex;

  if (match = Object(external_gc_shortcode_["next"])(transformTag, HTML, lastIndex)) {
...
function getBlockContentSchemaFromTransforms(transforms, context) {
  const phrasingContentSchema = Object(external_gc_dom_["getPhrasingContentSchema"])(context);
  const schemaArgs = {
...
function getSibling(node, which) {
  ...
  if (sibling && Object(external_gc_dom_["isPhrasingContent"])(sibling)) {
    return sibling;
  }
  ...
  if (!parentNode || !Object(external_gc_dom_["isPhrasingContent"])(parentNode)) {
    return;
  }
...
function filterInlineHTML(HTML, preserveWhiteSpace) {
  ...
  HTML = Object(external_gc_dom_["removeInvalidHTML"])(HTML, Object(external_gc_dom_["getPhrasingContentSchema"])('paste'), {
    inline: true
  });
...
function pasteHandler(_ref) {
  ...
  const phrasingContentSchema = Object(external_gc_dom_["getPhrasingContentSchema"])('paste');
  ...
  const blocks = Object(external_lodash_["compact"])(Object(external_lodash_["flatMap"])(pieces, piece => {
    ...
    piece = Object(external_gc_dom_["removeInvalidHTML"])(piece, schema);
  ...
  if (mode === 'AUTO' && blocks.length === 1 && registration_hasBlockSupport(blocks[0].name, '__unstablePasteTextInline', false)) {
    ...
    if (trimmedPlainText !== '' && trimmedPlainText.indexOf('\n') === -1) {
      return Object(external_gc_dom_["removeInvalidHTML"])(getBlockInnerHTML(blocks[0]), phrasingContentSchema);
    }
  }
...
function deprecatedGetPhrasingContentSchema(context) {
  ...
  return Object(external_gc_dom_["getPhrasingContentSchema"])(context);
}
/**
...
function categories_getCategories() {
  return Object(external_gc_data_["select"])(store).getCategories();
}
/**
...
function categories_setCategories(categories) {
  Object(external_gc_data_["dispatch"])(store).setCategories(categories);
}
/**
 * Updates a category.
 *
...
function categories_updateCategory(slug, category) {
  Object(external_gc_data_["dispatch"])(store).updateCategory(slug, category);
}
  ...
  return Object(external_lodash_["map"])(template, (_ref2, index) => {
    ...
    const normalizeAttribute = (definition, value) => {
      if (isHTMLAttribute(definition) && Object(external_lodash_["isArray"])(value)) {
        ...
        return Object(external_gc_element_["renderToString"])(value);
      }
...
// CONCATENATED MODULE: ./node_modules/@gechiui/blocks/build-module/block-content-provider/index.js
...
const BlockContentProvider = _ref => {
  ...
  const BlockContent = () => {
    ...
    return Object(external_gc_element_["createElement"])(external_gc_element_["RawHTML"], null, html);
  };
...
const withBlockContentContext = Object(external_gc_compose_["createHigherOrderComponent"])(OriginalComponent => {
  return props => Object(external_gc_element_["createElement"])(Consumer, null, context => Object(external_gc_element_["createElement"])(OriginalComponent, Object(esm_extends["a" /* default */])({}, props, {
