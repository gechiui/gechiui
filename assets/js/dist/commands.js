...
// NAMESPACE OBJECT: ./node_modules/@gechiui/commands/build-module/store/actions.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/commands/build-module/store/selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/commands/build-module/store/private-actions.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/store/reducer.js
/**
 * GeChiUI dependencies
 */
...
const reducer = (0,external_gc_data_namespaceObject.combineReducers)({
  commands,
  commandLoaders,
  isOpen,
  context
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/store/actions.js
/** @typedef {import('@gechiui/keycodes').GCKeycodeModifier} GCKeycodeModifier */

/**
 * Configuration of a registered keyboard shortcut.
 *
 * @typedef {Object} GCCommandConfig
 *
...
/**
 * @typedef {(search: string) => GCCommandConfig[]} GCCommandLoaderHook hoo
 */

/**
 * Command loader config.
 *
 * @typedef {Object} GCCommandLoaderConfig
 *
 * @property {string}              name    Command loader name.
 * @property {string=}             context Command loader context.
 * @property {GCCommandLoaderHook} hook    Command loader hook.
 */

/**
 * Returns an action object used to register a new command.
 *
 * @param {GCCommandConfig} config Command config.
 *
 ...
 *
 * @param {GCCommandLoaderConfig} config Command loader config.
 *
 * @return {Object} action.
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/store/selectors.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/store/private-actions.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/lock-unlock.js
/**
 * GeChiUI dependencies
 */
...
const {
  lock,
  unlock
} = (0,external_gc_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next GeChiUI release.', '@gechiui/commands');

;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/store/index.js
/**
 * GeChiUI dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/components/command-menu.js
...
function CommandMenuLoader({
  ...
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_element_namespaceObject.Fragment, null, (0,external_gc_element_namespaceObject.createElement)(Le.List, null, commands.map(command => {
    var _command$searchLabel;

    return (0,external_gc_element_namespaceObject.createElement)(Le.Item, {
      key: command.name,
      ...
      icon: command.icon
    }), (0,external_gc_element_namespaceObject.createElement)("span", null, (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.TextHighlight, {
      text: command.label,
      highlight: search
    }))));
  })));
...
function CommandMenuLoaderWrapper({
  ...
  const currentLoader = (0,external_gc_element_namespaceObject.useRef)(hook);
  const [key, setKey] = (0,external_gc_element_namespaceObject.useState)(0);
  (0,external_gc_element_namespaceObject.useEffect)(() => {
  ...
  return (0,external_gc_element_namespaceObject.createElement)(CommandMenuLoader, {
    key: key,
...
function CommandMenuGroup({
  ...
  return (0,external_gc_element_namespaceObject.createElement)(Le.Group, null, commands.map(command => {
  ...
  }), loaders.map(loader => (0,external_gc_element_namespaceObject.createElement)(CommandMenuLoaderWrapper, {
    key: loader.name,
    hook: loader.hook,
    search: search,
    setLoader: setLoader,
...
function CommandMenu() {
  ...
  const isOpen = (0,external_gc_data_namespaceObject.useSelect)(select => select(store).isOpen(), []);
  const {
    open,
    close
  } = (0,external_gc_data_namespaceObject.useDispatch)(store);
  const [loaders, setLoaders] = (0,external_gc_element_namespaceObject.useState)({});
  const commandMenuInput = (0,external_gc_element_namespaceObject.useRef)();
  (0,external_gc_element_namespaceObject.useEffect)(() => {
    registerShortcut({
      name: 'core/commands',
      category: 'global',
      description: (0,external_gc_i18n_namespaceObject.__)('打开命令面板'),
      keyCombination: {
        modifier: 'primary',
        character: 'k'
      }
  ...
  (0,external_gc_keyboardShortcuts_namespaceObject.useShortcut)('core/commands',
  ...
  const setLoader = (0,external_gc_element_namespaceObject.useCallback)((name, value) => setLoaders(current => ({ ...current,
    [name]: value
  })), []);
  ...
  }, (0,external_gc_element_namespaceObject.createElement)(Le, {
    label: (0,external_gc_i18n_namespaceObject.__)('Command palette'),
    onKeyDown: onKeyDown
  }, (0,external_gc_element_namespaceObject.createElement)("div", {
    className: "commands-command-menu__header"
  }, (0,external_gc_element_namespaceObject.createElement)(Le.Input, {
    ref: commandMenuInput,
    value: search,
    onValueChange: setSearch,
    placeholder: (0,external_gc_i18n_namespaceObject.__)('键入命令或搜索')
  })), (0,external_gc_element_namespaceObject.createElement)(Le.List, null, search && !isLoading && (0,external_gc_element_namespaceObject.createElement)(Le.Empty, null, (0,external_gc_i18n_namespaceObject.__)('未找到结果。')), (0,external_gc_element_namespaceObject.createElement)(CommandMenuGroup, {
    search: search,
    setLoader: setLoader,
    close: closeAndReset,
    isContextual: true
  }), search && (0,external_gc_element_namespaceObject.createElement)(CommandMenuGroup, {
    search: search,
    setLoader: setLoader,
    close: closeAndReset
  })))));
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/hooks/use-command-context.js
/**
 * GeChiUI dependencies
 */
...
function useCommandContext(context) {
  const {
    getContext
  } = (0,external_gc_data_namespaceObject.useSelect)(store);
  const initialContext = (0,external_gc_element_namespaceObject.useRef)(getContext());
  const {
    setContext
  } = unlock((0,external_gc_data_namespaceObject.useDispatch)(store));
  (0,external_gc_element_namespaceObject.useEffect)(() => {
    setContext(context);
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/private-apis.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/hooks/use-command.js
/**
 * GeChiUI dependencies
 */
 ...
 *
 * @param {import('../store/actions').GCCommandConfig} command command config.
 */
...
function useCommand(command) {
  ...
  const currentCallback = (0,external_gc_element_namespaceObject.useRef)(command.callback);
  (0,external_gc_element_namespaceObject.useEffect)(() => {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/hooks/use-command-loader.js
/**
 * GeChiUI dependencies
 */
 ...
 *
 * @param {import('../store/actions').GCCommandLoaderConfig} loader command loader config.
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/commands/build-module/index.js
...
(window.gc = window.gc || {}).commands = __webpack_exports__;
/******/ })()
;