...
async function exportReusableBlock(id) {
  ...
  const syncStatus = post.gc_pattern_sync_status;
...
async function importReusableBlock(file) {
  ...
  if (parsedContent.__file !== 'gc_block' || !parsedContent.title || !parsedContent.content || typeof parsedContent.title !== 'string' || typeof parsedContent.content !== 'string' || parsedContent.syncStatus && typeof parsedContent.syncStatus !== 'string') {
    throw new Error('无效的区块样板 JSON 文件');
  }
  ...
  const reusableBlock = await external_gc_apiFetch_default()({
    ...
    data: {
      ...
      meta: parsedContent.syncStatus === 'unsynced' ? {
        gc_pattern_sync_status: parsedContent.syncStatus
      } : undefined
    },
    method: 'POST'
  });
...
function ImportForm({
  ...
  const formRef = (0,external_gc_element_namespaceObject.useRef)();
  ...
  const [file, setFile] = (0,external_gc_element_namespaceObject.useState)(null);
  ...
  const onSubmit = event => {
    ...
    utils_import(file).then(reusableBlock => {
      ...
      switch (errors.message) {
        case '无效的JSON文件':
          uiMessage = (0,external_gc_i18n_namespaceObject.__)('无效的JSON文件');
          break;

        case '无效的区块样板 JSON 文件':
          uiMessage = (0,external_gc_i18n_namespaceObject.__)('无效的区块样板 JSON 文件');
          break;

        default:
          uiMessage = (0,external_gc_i18n_namespaceObject.__)('未知错误');
      }
  ...
  return (0,external_gc_element_namespaceObject.createElement)("form", {
    ...
    onSubmit: onSubmit,
    ref: formRef
  }, error && (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Notice, {
    status: "error",
    onRemove: () => onDismissError()
  }, error), (0,external_gc_element_namespaceObject.createElement)("label", {
    htmlFor: inputId,
    className: "list-reusable-blocks-import-form__label"
  }, (0,external_gc_i18n_namespaceObject.__)('文件')), (0,external_gc_element_namespaceObject.createElement)("input", {
    id: inputId,
    type: "file",
...
/* harmony default export */ var import_form = ((0,external_gc_compose_namespaceObject.withInstanceId)(ImportForm));
...
function ImportDropdown({
  ...
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Dropdown, {
    ...
    renderToggle: ({
      ...
      onClick: onToggle,
      variant: "primary"
    }, (0,external_gc_i18n_namespaceObject.__)('从JSON导入')),
    renderContent: ({
      onClose
    }) => (0,external_gc_element_namespaceObject.createElement)(import_form, {
      onUpload: (0,external_gc_compose_namespaceObject.pipe)(onClose, onUpload)
    })
  });
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const showNotice = () => {
    ...
    notice.innerHTML = `<p>${(0,external_gc_i18n_namespaceObject.__)('区块样板导入成功！')}</p>`;
  ...
  (0,external_gc_element_namespaceObject.createRoot)(container).render((0,external_gc_element_namespaceObject.createElement)(import_dropdown, {
    onUpload: showNotice
  }));
});

(window.gc = window.gc || {}).listReusableBlocks = __webpack_exports__;
/******/ })()
;