...
// NAMESPACE OBJECT: ./node_modules/@gechiui/core-data/build-module/actions.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/core-data/build-module/selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@gechiui/core-data/build-module/resolvers.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/if-matching-action.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/replace-action.js
/** @typedef {import('../types').AnyFunction} AnyFunction */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/conservative-map-item.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/on-sub-key.js
/** @typedef {import('../types').AnyFunction} AnyFunction */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/node_modules/uuid/dist/esm-browser/rng.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/node_modules/uuid/dist/esm-browser/regex.js
/* harmony default export */ var regex = (/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i);
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/node_modules/uuid/dist/esm-browser/validate.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/node_modules/uuid/dist/esm-browser/stringify.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/node_modules/uuid/dist/esm-browser/v4.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/queried-data/actions.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/batch/default-processor.js
/**
...
async function defaultProcessor(requests) {
  if (maxItems === null) {
    const preflightResponse = await external_gc_apiFetch_default()({
      path: '/batch/v1',
      method: 'OPTIONS'
    });
  ...
  for (const batchRequests of chunk(requests, maxItems)) {
    const batchResponse = await external_gc_apiFetch_default()({
      path: '/batch/v1',
      method: 'POST',
      data: {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/batch/create-batch.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/name.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/private-selectors.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/actions.js
/**
 * External dependencies
 */
...
function receiveThemeSupports() {
  external_gc_deprecated_default()("gc.data.dispatch( 'core' ).receiveThemeSupports", {
    since: '5.9'
  });
  return {
    type: 'DO_NOTHING'
...
const deleteEntityRecord = (kind, name, recordId, query, {
  __unstableFetch = (external_gc_apiFetch_default()),
  throwOnError = false
} = {}) => async ({
  dispatch
}) => {
  ...
  try {
    ...
    try {
      ...
      if (query) {
        path = (0,external_gc_url_namespaceObject.addQueryArgs)(path, query);
      }
 ...
 *
 * @deprecated since GC 5.9, use receiveUserPermission instead.
 *
...
function receiveUploadPermissions(hasUploadPermissions) {
  external_gc_deprecated_default()("gc.data.dispatch( 'core' ).receiveUploadPermissions", {
    since: '5.9',
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/entities.js
/**
 * External dependencies
 */
...
const rootEntitiesConfig = [{
  label: (0,external_gc_i18n_namespaceObject.__)('根目录（Base）'),
  kind: 'root',
  name: '__unstableBase',
  baseURL: '/',
  baseURLParams: {
  ...
  label: (0,external_gc_i18n_namespaceObject.__)('系统'),
  name: 'site',
  kind: 'root',
  ...
  getTitle: record => {
    ...
    return (_record$title = record?.title) !== null && _record$title !== void 0 ? _record$title : (0,external_gc_i18n_namespaceObject.__)('系统标题');
  }
}, {
  ...
  plural: 'mediaItems',
  label: (0,external_gc_i18n_namespaceObject.__)('媒体'),
  ...
  label: (0,external_gc_i18n_namespaceObject.__)('小工具区域')
}, {
  name: 'widget',
  kind: 'root',
  ...
  label: (0,external_gc_i18n_namespaceObject.__)('小工具')
}, {
  name: 'widgetType',
  kind: 'root',
  ...
  plural: 'widgetTypes',
  label: (0,external_gc_i18n_namespaceObject.__)('小工具类型')
}, {
  ...
  plural: 'comments',
  label: (0,external_gc_i18n_namespaceObject.__)('评论')
}, {
  name: 'menu',
  kind: 'root',
  baseURL: '/gc/v2/menus',
  ...
  plural: 'menuItems',
  label: (0,external_gc_i18n_namespaceObject.__)('菜单项'),
  rawAttributes: ['title']
}, {
  name: 'menuLocation',
  kind: 'root',
  ...
  label: (0,external_gc_i18n_namespaceObject.__)('菜单位置'),
  key: 'name'
}, {
  label: (0,external_gc_i18n_namespaceObject.__)('全局样式'),
  name: 'globalStyles',
  kind: 'root',
  ...
  label: (0,external_gc_i18n_namespaceObject.__)('主题'),
  name: 'theme',
  kind: 'root',
...
async function loadPostTypeEntities() {
  const postTypes = await external_gc_apiFetch_default()({
    path: '/gc/v2/types?context=view'
  });
  return Object.entries(postTypes !== null && postTypes !== void 0 ? postTypes : {}).map(([name, postType]) => {
    ...
    const namespace = (_postType$rest_namesp = postType?.rest_namespace) !== null && _postType$rest_namesp !== void 0 ? _postType$rest_namesp : 'gc/v2';
    return {
      kind: 'postType',
...
async function loadTaxonomyEntities() {
  const taxonomies = await external_gc_apiFetch_default()({
    path: '/gc/v2/taxonomies?context=view'
  });
  return Object.entries(taxonomies !== null && taxonomies !== void 0 ? taxonomies : {}).map(([name, taxonomy]) => {
    var _taxonomy$rest_namesp;

    const namespace = (_taxonomy$rest_namesp = taxonomy?.rest_namespace) !== null && _taxonomy$rest_namesp !== void 0 ? _taxonomy$rest_namesp : 'gc/v2';
    return {
      kind: 'taxonomy',
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/get-normalized-comma-separable.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/with-weak-map-cache.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/queried-data/get-query-parts.js
/**
 * GeChiUI dependencies
 */
  ...
  for (let i = 0; i < keys.length; i++) {
    ...
    switch (key) {
      ...
      default:
        ...
        parts.stableKey += (parts.stableKey ? '&' : '') + (0,external_gc_url_namespaceObject.addQueryArgs)('', {
          [key]: value
        }).slice(1);
    }
  }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/queried-data/reducer.js
/**
 * GeChiUI dependencies
 */
...
const receiveQueries = (0,external_gc_compose_namespaceObject.compose)([// Limit to matching action type so we don't attempt to replace action on
// an unhandled action.
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/reducer.js
/**
 * External dependencies
 */
...
function entity(entityConfig) {
  return (0,external_gc_compose_namespaceObject.compose)([withMultiEntityRecordEdits, // Limit to matching action type so we don't attempt to replace action on
  // an unhandled action.
  ...
  })])((0,external_gc_data_namespaceObject.combineReducers)({
    queriedData: reducer,
    edits: (state = {}, action) => {
...
const entities = (state = {}, action) => {
  ...
  if (!entitiesDataReducer || newConfig !== state.config) {
    ...
    entitiesDataReducer = (0,external_gc_data_namespaceObject.combineReducers)(Object.entries(entitiesByKind).reduce((memo, [kind, subEntities]) => {
      const kindReducer = (0,external_gc_data_namespaceObject.combineReducers)(subEntities.reduce((kindMemo, entityConfig) => ({ ...kindMemo,
    ...
    case 'EDIT_ENTITY_RECORD':
      {
        ...
        if (!external_gc_isShallowEqual_default()(comparisonUndoEdits, comparisonEdits)) {
...
/* harmony default export */ var build_module_reducer = ((0,external_gc_data_namespaceObject.combineReducers)({
  terms,
  users,
  currentTheme,
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/set-nested-value.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/queried-data/selectors.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/is-raw-attribute.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/selectors.js
/**
 * External dependencies
 */
...
// See https://github.com/GeChiUI/gutenberg/pull/40025#discussion_r865410589 for more context.
...
const isRequestingEmbedPreview = (0,external_gc_data_namespaceObject.createRegistrySelector)(select => (state, url) => {
 ...
 *                   include with request. For valid query parameters see the [Users page](https://developer.gechiui.com/rest-api/reference/users/) in the REST API Handbook and see the arguments for [List Users](https://developer.gechiui.com/rest-api/reference/users/#list-users) and [Retrieve a User](https://developer.gechiui.com/rest-api/reference/users/#retrieve-a-user).
 * @return Authors list.
 */

function getAuthors(state, query) {
  external_gc_deprecated_default()("select( 'core' ).getAuthors()", {
    since: '5.9',
    alternative: "select( 'core' ).getUsers({ who: 'authors' })"
  });
  const path = (0,external_gc_url_namespaceObject.addQueryArgs)('/gc/v2/users/?who=authors&per_page=100', query);
 ...
 *
 * @deprecated since GeChiUI 6.0. Use getEntitiesConfig instead
 * @param      state Data state.
...
function getEntitiesByKind(state, kind) {
  external_gc_deprecated_default()("gc.data.select( 'core' ).getEntitiesByKind()", {
    since: '6.0',
    alternative: "gc.data.select( 'core' ).getEntitiesConfig()"
  });
 ...
 *
 * @deprecated since GeChiUI 6.0. Use getEntityConfig instead
 * @param      state Data state.
 * @param      kind  Entity kind.
...
function getEntity(state, kind, name) {
  external_gc_deprecated_default()("gc.data.select( 'core' ).getEntity()", {
    since: '6.0',
    alternative: "gc.data.select( 'core' ).getEntityConfig()"
  });
 ...
 *
 * See https://github.com/GeChiUI/gutenberg/pull/41578 for more details.
 */
 ...
 *              fields, fields must always include the ID. For valid query parameters see the [Reference](https://developer.gechiui.com/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available "Retrieve a [Entity kind]".
 *
 * @return Record.
 */
 ...
 * @param kind  Entity kind.
 * @param name  Entity name.
 * @param query Optional terms query. For valid query parameters see the [Reference](https://developer.gechiui.com/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available for "List [Entity kind]s".
 *
 ...
 *
 * @see GetEntityRecord
 * @see https://github.com/GeChiUI/gutenberg/pull/41578
 */
 ...
 *              fields, fields must always include the ID. For valid query parameters see the [Reference](https://developer.gechiui.com/rest-api/reference/) in the REST API Handbook and select the entity kind. Then see the arguments available for "List [Entity kind]s".
 *
 * @return Records.
 */
...
function getUndoEdit(state) {
  external_gc_deprecated_default()("select( 'core' ).getUndoEdit()", {
    since: '6.3'
  });
...
function getRedoEdit(state) {
  external_gc_deprecated_default()("select( 'core' ).getRedoEdit()", {
    since: '6.3'
  });
...
const hasFetchedAutosaves = (0,external_gc_data_namespaceObject.createRegistrySelector)(select => (state, postType, postId) => {
...
function __experimentalGetTemplateForLink(state, link) {
  ...
  if (records?.length) {
    return getEditedEntityRecord(state, 'postType', 'gc_template', records[0].id);
  }
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/utils/forward-resolver.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/resolvers.js
/**
 * External dependencies
 */
...
const resolvers_getAuthors = query => async ({
  ...
  const path = (0,external_gc_url_namespaceObject.addQueryArgs)('/gc/v2/users/?who=authors&per_page=100', query);
  const users = await external_gc_apiFetch_default()({
    path
  });
...
const resolvers_getCurrentUser = () => async ({
  ...
  const currentUser = await external_gc_apiFetch_default()({
    path: '/gc/v2/users/me'
  });
...
const resolvers_getEntityRecord = (kind, name, key = '', query) => async ({
  ...
  try {
    ...
    const path = (0,external_gc_url_namespaceObject.addQueryArgs)(entityConfig.baseURL + (key ? '/' + key : ''), { ...entityConfig.baseURLParams,
      ...query
    });
    ...
    const record = await external_gc_apiFetch_default()({
      path
    });
...
const resolvers_getEntityRecords = (kind, name, query = {}) => async ({
  ...
  try {
    ...
    const path = (0,external_gc_url_namespaceObject.addQueryArgs)(entityConfig.baseURL, { ...entityConfig.baseURLParams,
      ...query
    });
    let records = Object.values(await external_gc_apiFetch_default()({
      path
...
const resolvers_getEmbedPreview = url => async ({
  ...
  try {
    const embedProxyResponse = await external_gc_apiFetch_default()({
      path: (0,external_gc_url_namespaceObject.addQueryArgs)('/oembed/1.0/proxy', {
        url
      })
    });
...
const resolvers_canUser = (requestedAction, resource, id) => async ({
  ...
  try {
    response = await external_gc_apiFetch_default()({
      path: `/gc/v2/${resourcePath}`,
      method: 'OPTIONS',
      parse: false
    });
  } catch (error) {
...
const resolvers_getAutosaves = (postType, postId) => async ({
  ...
  const autosaves = await external_gc_apiFetch_default()({
...
const resolvers_experimentalGetTemplateForLink = link => async ({
  ...
  try {
    ...
    // an Ajax function which has a different shape from a GC_REST_Response.
    template = await external_gc_apiFetch_default()({
      url: (0,external_gc_url_namespaceObject.addQueryArgs)(link, {
...
const resolvers_experimentalGetCurrentGlobalStylesId = () => async ({
  ...
  const globalStylesURL = activeThemes?.[0]?._links?.['gc:user-global-styles']?.[0]?.href;

  if (globalStylesURL) {
    const globalStylesObject = await external_gc_apiFetch_default()({
      url: globalStylesURL
    });
...
const resolvers_experimentalGetCurrentThemeBaseGlobalStyles = () => async ({
  ...
  const themeGlobalStyles = await external_gc_apiFetch_default()({
...
const resolvers_experimentalGetCurrentThemeGlobalStylesVariations = () => async ({
  ...
  const currentTheme = await resolveSelect.getCurrentTheme();
  const variations = await external_gc_apiFetch_default()({
    path: `/gc/v2/global-styles/themes/${currentTheme.stylesheet}/variations`
  });
...
const resolvers_getCurrentThemeGlobalStylesRevisions = () => async ({
  ...
  if (revisionsURL) {
    const resetRevisions = await external_gc_apiFetch_default()({
      url: revisionsURL
    });
...
const resolvers_getBlockPatterns = () => async ({
  ...
  const restPatterns = await external_gc_apiFetch_default()({
    path: '/gc/v2/block-patterns/patterns'
  });
...
const resolvers_getBlockPatternCategories = () => async ({
  ...
  const categories = await external_gc_apiFetch_default()({
    path: '/gc/v2/block-patterns/categories'
  });
  dispatch({
...
const resolvers_getNavigationFallbackId = () => async ({
  ...
  const fallback = await external_gc_apiFetch_default()({
    path: (0,external_gc_url_namespaceObject.addQueryArgs)('/gc-block-editor/v1/navigation-fallback', {
      _embed: true
    })
  });
  ...
  if (record) {
    ...
    const existingFallbackEntityRecord = select.getEntityRecord('postType', 'gc_navigation', fallback?.id);
    const invalidateNavigationQueries = !existingFallbackEntityRecord;
    dispatch.receiveEntityRecords('postType', 'gc_navigation', record, undefined, invalidateNavigationQueries); // Resolve to avoid further network requests.

    dispatch.finishResolution('getEntityRecord', ['postType', 'gc_navigation', fallback?.id]);
  }
};

;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/locks/utils.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/locks/reducer.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/locks/selectors.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/locks/engine.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/locks/actions.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/private-apis.js
/**
 * GeChiUI dependencies
 */
...
const {
  lock,
  unlock
} = (0,external_gc_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my plugin or theme will inevitably break on the next GeChiUI release.', '@gechiui/core-data');
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/entity-provider.js
...
/** @typedef {import('@gechiui/blocks').GCBlock} GCBlock */
...
const entityContexts = { ...rootEntitiesConfig.reduce((acc, loader) => {
    ...
    acc[loader.kind][loader.name] = {
      context: (0,external_gc_element_namespaceObject.createContext)(undefined)
    };
    return acc;
  }, {}),
...
function EntityProvider({
  ...
  return (0,external_gc_element_namespaceObject.createElement)(Provider, {
    value: id
  }, children);
}
/**
...
function useEntityId(kind, name) {
  return (0,external_gc_element_namespaceObject.useContext)(getEntityContext(kind, name));
}
/**
...
function useEntityProp(kind, name, prop, _id) {
  ...
  const {
    editEntityRecord
  } = (0,external_gc_data_namespaceObject.useDispatch)(STORE_NAME);
  const setValue = (0,external_gc_element_namespaceObject.useCallback)(newValue => {
...
function useEntityBlockEditor(kind, name, {
  ...
  (0,external_gc_element_namespaceObject.useEffect)(() => {
    ...
    if (content && typeof content !== 'function' && !blocks) {
      const parsedContent = (0,external_gc_blocks_namespaceObject.parse)(content);
      editEntityRecord(kind, name, id, {
  ...
  const updateFootnotes = (0,external_gc_element_namespaceObject.useCallback)(_blocks => {
    const output = {
      blocks: _blocks
    };
    ...
    // https://github.com/GeChiUI/gutenberg/pull/43204 lands. We can then
  ...
  const onChange = (0,external_gc_element_namespaceObject.useCallback)((newBlocks, options) => {
  ...
  const onInput = (0,external_gc_element_namespaceObject.useCallback)((newBlocks, options) => {
    const {
      selection
    } = options;
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/fetch/__experimental-fetch-link-suggestions.js
/**
 * GeChiUI dependencies
 */
 ...
 *
 * @typedef { 'attachment' | 'post' | 'term' | 'post-format' } GCLinkSearchType
 */
...
/**
 * @typedef GCLinkSearchResultAugments
 *
 * @property {{kind: GCKind}} [meta]    Contains kind information.
 * @property {GCKind}         [subtype] Optional subtype if it exists.
 */

/**
 * @typedef {GCLinkSearchResult & GCLinkSearchResultAugments} GCLinkSearchResultAugmented
 */
...
const fetchLinkSuggestions = async (search, searchOptions = {}, settings = {}) => {
  ...
  /** @type {Promise<GCLinkSearchResult>[]} */

  const queries = [];

  if (!type || type === 'post') {
    queries.push(external_gc_apiFetch_default()({
      path: (0,external_gc_url_namespaceObject.addQueryArgs)('/gc/v2/search', {
        search,
        page,
        per_page: perPage,
        type: 'post',
  ...
  if (!type || type === 'attachment') {
    queries.push(external_gc_apiFetch_default()({
      path: (0,external_gc_url_namespaceObject.addQueryArgs)('/gc/v2/media', {
        search,
        page,
        per_page: perPage
      })
  ...
  return Promise.all(queries).then(results => {
    ...
    /** @type {GCLinkSearchResultAugmented} */
    result) => {
      ...
      return {
        ...
        title: (0,external_gc_htmlEntities_namespaceObject.decodeEntities)(isMedia ? // @ts-ignore fix when we make this a TS file
        result.title.rendered : result.title || '') || (0,external_gc_i18n_namespaceObject.__)('（无标题）'),
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/fetch/__experimental-fetch-url-data.js
/**
 * GeChiUI dependencies
 */
...
const fetchUrlData = async (url, options = {}) => {
  ...
  const args = {
    url: (0,external_gc_url_namespaceObject.prependHTTP)(url)
  };

  if (!(0,external_gc_url_namespaceObject.isURL)(url)) {
    return Promise.reject(`${url} is not a valid URL.`);
  } // Test for "http" based URL as it is possible for valid
  // yet unusable URLs such as `tel:123456` to be passed.


  const protocol = (0,external_gc_url_namespaceObject.getProtocol)(url);

  if (!protocol || !(0,external_gc_url_namespaceObject.isValidProtocol)(protocol) || !protocol.startsWith('http') || !/^https?:\/\/[^\/\s]/i.test(url)) {
  ...
  return external_gc_apiFetch_default()({
    path: (0,external_gc_url_namespaceObject.addQueryArgs)(endpoint, args),
    ...options
  }).then(res => {
    CACHE.set(url, res);
    return res;
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/fetch/index.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/hooks/memoize.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/hooks/constants.js
let Status;
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/hooks/use-query-select.js
/**
 * GeChiUI dependencies
 */
 ...
 *
 * @since 6.1.0 Introduced in GeChiUI core.
 * @private
 *
 ...
 * @example
 * ```js
 * import { useQuerySelect } from '@gechiui/data';
 * import { store as coreDataStore } from '@gechiui/core-data';
 *
...
function useQuerySelect(mapQuerySelect, deps) {
  return (0,external_gc_data_namespaceObject.useSelect)((select, registry) => {
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/hooks/use-entity-record.js
/**
 * GeChiUI dependencies
 */
 ...
 * @example
 * ```js
 * import { useEntityRecord } from '@gechiui/core-data';
 *
 * function PageTitleDisplay( { id } ) {
 ...
 * import { store as noticeStore } from '@gechiui/notices';
 * import { useEntityRecord } from '@gechiui/core-data';
 *
...
function useEntityRecord(kind, name, recordId, options = {
  ...
  const mutations = (0,external_gc_element_namespaceObject.useMemo)(() => ({
...
function __experimentalUseEntityRecord(kind, name, recordId, options) {
  external_gc_deprecated_default()(`gc.data.__experimentalUseEntityRecord`, {
    alternative: 'gc.data.useEntityRecord',
    since: '6.1'
  });
  return useEntityRecord(kind, name, recordId, options);
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/hooks/use-entity-records.js
/**
 * GeChiUI dependencies
 */
 ...
 * @example
 * ```js
 * import { useEntityRecords } from '@gechiui/core-data';
 *
...
function useEntityRecords(kind, name, queryArgs = {}, options = {
  ...
  const queryAsString = (0,external_gc_url_namespaceObject.addQueryArgs)('', queryArgs);
  const {
    data: records,
    ...rest
  } = useQuerySelect(query => {
...
function __experimentalUseEntityRecords(kind, name, queryArgs, options) {
  external_gc_deprecated_default()(`gc.data.__experimentalUseEntityRecords`, {
    alternative: 'gc.data.useEntityRecords',
    since: '6.1'
  });
  return useEntityRecords(kind, name, queryArgs, options);
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/hooks/use-resource-permissions.js
/**
 * GeChiUI dependencies
 */
 ...
 * @example
 * ```js
 * import { useResourcePermissions } from '@gechiui/core-data';
 *
 * function PagesList() {
...
function __experimentalUseResourcePermissions(resource, id) {
  external_gc_deprecated_default()(`gc.data.__experimentalUseResourcePermissions`, {
    alternative: 'gc.data.useResourcePermissions',
    since: '6.1'
  });
  return useResourcePermissions(resource, id);
}

;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/hooks/index.js




;// CONCATENATED MODULE: ./node_modules/@gechiui/core-data/build-module/index.js
/**
 * GeChiUI dependencies
 */
...
(0,external_gc_data_namespaceObject.register)(store); // Register store after unlocking private selectors to allow resolvers to use them.
...
(window.gc = window.gc || {}).coreData = __webpack_exports__;
/******/ })()
;