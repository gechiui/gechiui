...
function rendererPath(block, attributes = null, urlQueryArgs = {}) {
  return (0,external_gc_url_namespaceObject.addQueryArgs)(`/gc/v2/block-renderer/${block}`, {
    context: 'edit',
    ...(null !== attributes ? {
      attributes
    } : {}),
...
function DefaultEmptyResponsePlaceholder({
  ...
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Placeholder, {
    className: className
  }, (0,external_gc_i18n_namespaceObject.__)('区块渲染为空。'));
}
...
function DefaultErrorResponsePlaceholder({
  ...
  const errorMessage = (0,external_gc_i18n_namespaceObject.sprintf)( // translators: %s: error message describing the problem
  (0,external_gc_i18n_namespaceObject.__)('载入区块时发生错误：%s'), response.errorMsg);
  return (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Placeholder, {
    className: className
  }, errorMessage);
}
...
function DefaultLoadingResponsePlaceholder({
  ...
  }, showLoader && (0,external_gc_element_namespaceObject.createElement)("div", {
    style: {
      position: 'absolute',
      top: '50%',
      left: '50%',
  ...
  }, (0,external_gc_element_namespaceObject.createElement)(external_gc_components_namespaceObject.Spinner, null)), (0,external_gc_element_namespaceObject.createElement)("div", {
    style: {
...
function ServerSideRender(props) {
  ...
  const isMountedRef = (0,external_gc_element_namespaceObject.useRef)(true);
  const [showLoader, setShowLoader] = (0,external_gc_element_namespaceObject.useState)(false);
  const fetchRequestRef = (0,external_gc_element_namespaceObject.useRef)();
  const [response, setResponse] = (0,external_gc_element_namespaceObject.useState)(null);
  const prevProps = (0,external_gc_compose_namespaceObject.usePrevious)(props);
  ...
  function fetchData() {
    ...
    let sanitizedAttributes = attributes && (0,external_gc_blocks_namespaceObject.__experimentalSanitizeBlockAttributes)(block, attributes);
  ...
  const debouncedFetchData = (0,external_gc_compose_namespaceObject.useDebounce)(fetchData, 500); // When the component unmounts, set isMountedRef to false. This will
  ...
  if (isLoading) {
    return (0,external_gc_element_namespaceObject.createElement)(LoadingResponsePlaceholder, { ...props,
      showLoader: showLoader
    }, hasResponse && (0,external_gc_element_namespaceObject.createElement)(external_gc_element_namespaceObject.RawHTML, {
      className: className
    }, response));
  }

  if (hasEmptyResponse || !hasResponse) {
    return (0,external_gc_element_namespaceObject.createElement)(EmptyResponsePlaceholder, { ...props
    });
  }

  if (hasError) {
    return (0,external_gc_element_namespaceObject.createElement)(ErrorResponsePlaceholder, {
      response: response,
      ...props
    });
  }

  return (0,external_gc_element_namespaceObject.createElement)(external_gc_element_namespaceObject.RawHTML, {
    className: className
  }, response);
}
...
const ExportedServerSideRender = (0,external_gc_data_namespaceObject.withSelect)(select => {
  ...
  const newUrlQueryArgs = (0,external_gc_element_namespaceObject.useMemo)(() => {
    if (!currentPostId) {
      return urlQueryArgs;
    }
  ...
  return (0,external_gc_element_namespaceObject.createElement)(ServerSideRender, {
...
(window.gc = window.gc || {}).serverSideRender = __webpack_exports__["default"];
/******/ })()
;