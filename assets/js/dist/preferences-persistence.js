...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/create/debounce-async.js
/**
 ...
 *
 * This is distinct from `{ debounce } from @gechiui/compose` in that it
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/create/index.js
/**
...
/**
 * Creates a persistence layer that stores data in GeChiUI user meta via the
 * REST API.
 *
 ...
 *
 * @return {Object} A persistence layer for GeChiUI user meta.
 */

function create({
  preloadedData,
  localStorageRestoreKey = 'GC_PREFERENCES_RESTORE_DATA',
  requestDebounceMS = 2500
} = {}) {
  let cache = preloadedData;
  const debouncedApiFetch = debounceAsync((external_gc_apiFetch_default()), requestDebounceMS);
  ...
  async function get() {
    ...
    const user = await external_gc_apiFetch_default()({
      path: '/gc/v2/users/me?context=edit'
    });
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/migrations/legacy-local-storage-data/move-feature-preferences.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/migrations/legacy-local-storage-data/move-third-party-feature-preferences.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/migrations/legacy-local-storage-data/move-individual-preference.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/migrations/legacy-local-storage-data/move-interface-enable-items.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/migrations/legacy-local-storage-data/convert-edit-post-panels.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/migrations/legacy-local-storage-data/index.js
/**
 * Internal dependencies
 */
...
function getLegacyData(userId) {
  const key = `GC_DATA_USER_${userId}`;
  const unparsedData = window.localStorage.getItem(key);
  return JSON.parse(unparsedData);
}
/**
 * Converts data from the old `@gechiui/data` package format.
 *
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/migrations/preferences-package-data/convert-complementary-areas.js
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/migrations/preferences-package-data/index.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@gechiui/preferences-persistence/build-module/index.js
/**
 * Internal dependencies
 */
 ...
 *
 * This function is used internally by GeChiUI in an inline script, so
...
function __unstableCreatePersistenceLayer(serverData, userId) {
  const localStorageRestoreKey = `GC_PREFERENCES_USER_${userId}`;
...
(window.gc = window.gc || {}).preferencesPersistence = __webpack_exports__;
/******/ })()
;