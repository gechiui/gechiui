...
CollectionEdit = Library.extend(/** @lends gc.media.controller.CollectionEdit.prototype */{
	...
	renderSettings: function( attachmentsBrowserView ) {
		...
		// Add the '反转顺序' button to the toolbar.
...
Details = Attachment.extend(/** @lends gc.media.view.Attachment.Details.prototype */{
	...
	moveFocus: function() {
		...
		// Fallback: move focus to the "选择文件" button in the media modal.
...
/**
 * gc.media.view.Attachment.EditLibrary
 *
 * @memberOf gc.media.view.Attachment
 *
 * @class
 ...
 * @augments Backbone.View
 */
var EditLibrary = gc.media.view.Attachment.extend(/** @lends gc.media.view.Attachment.EditLibrary.prototype */{
	buttons: {
		close: true
	}
});
...
/**
 * gc.media.view.Attachment.Library
 *
 * @memberOf gc.media.view.Attachment
 *
 * @class
 ...
 * @augments Backbone.View
 */
var Library = gc.media.view.Attachment.extend(/** @lends gc.media.view.Attachment.Library.prototype */{
	buttons: {
		check: true
	}
});
...
AttachmentsBrowser = View.extend(/** @lends gc.media.view.AttachmentsBrowser.prototype */{
	...
	announceSearchResults: _.debounce( function() {
		var count,
			...
			mediaFoundHasMoreResultsMessage = __( '显示的媒体数目：%d。单击“加载更多”以获取更多结果。' );

		if ( infiniteScrolling ) {
			/* translators: Accessibility text. %d: Number of attachments found in a search. */
			mediaFoundHasMoreResultsMessage = __( '显示的媒体数目：%d。滚动页面查看更多结果。' );
		}
...
EmbedLink = gc.media.view.Settings.extend(/** @lends gc.media.view.EmbedLink.prototype */{
	...
	fetch: function() {
		...
		// Support YouKu embed urls, since they work once in the editor.
		re = /https?:\/\/www\.youku\.com\/embed\/([^/]+)/;
 ...
 * @augments Backbone.View
 */
var Sidebar = gc.media.view.PriorityList.extend(/** @lends gc.media.view.Sidebar.prototype */{
...
!function() {
/**
 * @output assets/js/media-views.js
 */
