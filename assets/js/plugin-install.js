...
jQuery( function( $ ) {
	 ...
	 * @todo Consider to implement a GeChiUI general utility for this and don't use jQuery UI.
	 */
	function handleTabbables() {
		...
		$firstAndLast.off( 'keydown.gc-plugin-details' );
		// Attach again the keydown event on the first and last focusable elements.
		$firstAndLast.on( 'keydown.gc-plugin-details', function( event ) {
