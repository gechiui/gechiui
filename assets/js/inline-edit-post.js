 ...
 *
 * @since 2.7.0
 * @output assets/js/inline-edit-post.js
 */
...
( function( $, gc ) {
	...
	setBulk : function(){
		...
		$( 'tbody th.check-column input[type="checkbox"]' ).each( function() {
			...
			if ( $(this).prop('checked') ) {
				...
				var id = $( this ).val(),
					...
					buttonVisuallyHiddenText = gc.i18n.sprintf(
						/* translators: %s: Post title. */
						gc.i18n.__( 'Remove &#8220;%s&#8221; from Bulk Edit' ),
						theTitle
					);
		...
		$( '#bulk-titles .ntdelbutton' ).click( function() {
			...
			$( '#_' + id ).parent().remove();
			gc.a11y.speak( gc.i18n.__( '条目已删除。' ), 'assertive' );
			...
			if ( $next.length ) {
				...
				gc.a11y.speak( gc.i18n.__( '所有选定的项都已删除。选择要使用批量操作的新项。' ) );
			}
		});
